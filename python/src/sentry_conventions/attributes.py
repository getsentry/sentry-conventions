...
class ATTRIBUTE_NAMES(metaclass=_AttributeNamesMeta):
    ...
    """The name of the device, typically a hostname.
...
ATTRIBUTE_METADATA: Dict[str, AttributeMetadata] = {
    ...
    "app.build": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", prs=[296], description="Added app.build attribute"),
        ],
    ),
    "app.identifier": AttributeMetadata(
        ...
        sdks=["sentry.cocoa","sentry.java.android","sentry.javascript.react-native","sentry.dart.flutter"],
        changelog=[
            ChangelogEntry(version="next", prs=[296], description="Added app.identifier attribute"),
        ],
    ),
    "app.in_foreground": AttributeMetadata(
        ...
        sdks=["sentry.cocoa","sentry.java.android","sentry.javascript.react-native","sentry.dart.flutter"],
        changelog=[
            ChangelogEntry(version="next", prs=[296], description="Added app.in_foreground attribute"),
        ],
    ),
    "app.name": AttributeMetadata(
        ...
        sdks=["sentry.cocoa","sentry.java.android","sentry.javascript.react-native","sentry.dart.flutter"],
        changelog=[
            ChangelogEntry(version="next", prs=[296], description="Added app.name attribute"),
        ],
    ),
    "app.start_time": AttributeMetadata(
        ...
        sdks=["sentry.cocoa","sentry.java.android","sentry.javascript.react-native","sentry.dart.flutter"],
        changelog=[
            ChangelogEntry(version="next", prs=[296], description="Added app.start_time attribute"),
        ],
    ),
    "app.version": AttributeMetadata(
        ...
        sdks=["sentry.cocoa","sentry.java.android","sentry.javascript.react-native","sentry.dart.flutter"],
        changelog=[
            ChangelogEntry(version="next", prs=[296], description="Added app.version attribute"),
        ],
    ),
    ...
    "browser.web_vital.cls.value": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[229], description="Added browser.web_vital.cls.value attribute"),
        ],
    ),
    ...
    "browser.web_vital.inp.value": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[229], description="Added browser.web_vital.inp.value attribute"),
        ],
    ),
    ...
    "browser.web_vital.lcp.value": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[229], description="Added browser.web_vital.lcp.value attribute"),
        ],
    ),
    ...
    "cls": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[229], description="Added and deprecated attribute to document JS SDK's current behaviour"),
        ],
    ),
    ...
    "device.battery_level": AttributeMetadata(
        ...
        example=100,
        changelog=[
            ChangelogEntry(version="next", description="Added device.battery_level attribute"),
        ],
    ),
    "device.battery_temperature": AttributeMetadata(
        ...
        example=25,
        changelog=[
            ChangelogEntry(version="next", description="Added device.battery_temperature attribute"),
        ],
    ),
    "device.boot_time": AttributeMetadata(
        ...
        example="2018-02-08T12:52:12Z",
        changelog=[
            ChangelogEntry(version="next", description="Added device.boot_time attribute"),
        ],
    ),
    ...
    "device.charging": AttributeMetadata(
        ...
        example=False,
        changelog=[
            ChangelogEntry(version="next", description="Added device.charging attribute"),
        ],
    ),
    "device.class": AttributeMetadata(
        ...
        example="medium",
        changelog=[
            ChangelogEntry(version="next", prs=[300], description="Added device.class attribute"),
        ],
    ),
    ...
    "device.free_memory": AttributeMetadata(
        ...
        example=2147483648,
        changelog=[
            ChangelogEntry(version="next", prs=[300], description="Added device.free_memory attribute"),
        ],
    ),
    "device.free_storage": AttributeMetadata(
        ...
        example=107374182400,
        changelog=[
            ChangelogEntry(version="next", description="Added device.free_storage attribute"),
        ],
    ),
    "device.id": AttributeMetadata(
        ...
        example="a1b2c3d4-e5f6-7890-abcd-ef1234567890",
        changelog=[
            ChangelogEntry(version="next", description="Added device.id attribute"),
        ],
    ),
    "device.low_memory": AttributeMetadata(
        ...
        example=False,
        changelog=[
            ChangelogEntry(version="next", description="Added device.low_memory attribute"),
        ],
    ),
    "device.manufacturer": AttributeMetadata(
        ...
        example="Google",
        changelog=[
            ChangelogEntry(version="next", description="Added device.manufacturer attribute"),
        ],
    ),
    "device.memory.estimated_capacity": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[281], description="Added attribute device.memory.estimated_capacity to be used instead of deviceMemory"),
        ],
    ),
    "device.memory_size": AttributeMetadata(
        ...
        example=17179869184,
        changelog=[
            ChangelogEntry(version="next", prs=[300], description="Added device.memory_size attribute"),
        ],
    ),
    ...
    "device.model_id": AttributeMetadata(
        ...
        example="N861AP",
        changelog=[
            ChangelogEntry(version="next", prs=[300], description="Added device.model_id attribute"),
        ],
    ),
    "device.name": AttributeMetadata(
        ...
        example="localhost",
        changelog=[
            ChangelogEntry(version="next", description="Added device.name attribute"),
        ],
    ),
    "device.online": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="next", description="Added device.online attribute"),
        ],
    ),
    "device.orientation": AttributeMetadata(
        ...
        example="portrait",
        changelog=[
            ChangelogEntry(version="next", description="Added device.orientation attribute"),
        ],
    ),
    "device.processor_count": AttributeMetadata(
        ...
        aliases=["hardwareConcurrency"],
        changelog=[
            ChangelogEntry(version="next", prs=[300], description="Removed deprecation, device.processor_count is now the canonical attribute"),
            ChangelogEntry(version="next", prs=[300], description="Added and deprecated attribute device.processor_count in favor of device.cpu.logical_core_count"),
        ],
    ),
    "device.processor_frequency": AttributeMetadata(
        ...
        example=2400,
        changelog=[
            ChangelogEntry(version="next", description="Added device.processor_frequency attribute"),
        ],
    ),
    "device.screen_density": AttributeMetadata(
        ...
        example=2.625,
        changelog=[
            ChangelogEntry(version="next", description="Added device.screen_density attribute"),
        ],
    ),
    "device.screen_dpi": AttributeMetadata(
        ...
        example=420,
        changelog=[
            ChangelogEntry(version="next", description="Added device.screen_dpi attribute"),
        ],
    ),
    "device.screen_height_pixels": AttributeMetadata(
        ...
        example=2400,
        changelog=[
            ChangelogEntry(version="next", description="Added device.screen_height_pixels attribute"),
        ],
    ),
    "device.screen_width_pixels": AttributeMetadata(
        ...
        example=1080,
        changelog=[
            ChangelogEntry(version="next", description="Added device.screen_width_pixels attribute"),
        ],
    ),
    "device.simulator": AttributeMetadata(
        ...
        example=False,
        changelog=[
            ChangelogEntry(version="next", prs=[300], description="Added device.simulator attribute"),
        ],
    ),
    "device.storage_size": AttributeMetadata(
        ...
        example=274877906944,
        changelog=[
            ChangelogEntry(version="next", description="Added device.storage_size attribute"),
        ],
    ),
    "device.usable_memory": AttributeMetadata(
        ...
        example=2147483648,
        changelog=[
            ChangelogEntry(version="next", description="Added device.usable_memory attribute"),
        ],
    ),
    "deviceMemory": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[281], description="Added and deprecated attribute to document JS SDK's current behaviour"),
        ],
    ),
    ...
    "hardwareConcurrency": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[300], description="Updated deprecation replacement from device.cpu.logical_core_count to device.processor_count"),
            ChangelogEntry(version="next", prs=[281], description="Added and deprecated attribute to document JS SDK's current behaviour"),
        ],
    ),
    ...
    "sentry.trace.parent_span_id": AttributeMetadata(
        ...
        deprecation=DeprecationInfo(),
        changelog=[
            ChangelogEntry(version="next", prs=[287], description="Deprecate `sentry.trace.parent_span_id`"),
            ChangelogEntry(version="0.1.0", prs=[116]),
        ],
    ),
    ...
    "ui.element.height": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.height attribute"),
        ],
    ),
    "ui.element.id": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.id attribute"),
        ],
    ),
    "ui.element.identifier": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.identifier attribute"),
        ],
    ),
    "ui.element.load_time": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.load_time attribute"),
        ],
    ),
    "ui.element.paint_type": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.paint_type attribute"),
        ],
    ),
    "ui.element.render_time": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.render_time attribute"),
        ],
    ),
    "ui.element.type": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.type attribute"),
        ],
    ),
    ...
    "ui.element.width": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", prs=[284], description="Added ui.element.width attribute"),
        ],
    ),

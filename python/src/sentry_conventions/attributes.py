...
ATTRIBUTE_METADATA: Dict[str, AttributeMetadata] = {
    "address": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[534], description="Added address attribute"
            ),
        ],
    ),
    ...
    "aws_region": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[537], description="Added aws_region attribute"
            ),
        ],
    ),
    ...
    "code": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[533], description="Added code attribute"
            ),
        ],
    ),
    ...
    "db.params": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[529], description="Added db.params attribute"
            ),
        ],
    ),
    ...
    "gcp_region": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[535], description="Added gcp_region attribute"
            ),
        ],
    ),
    ...
    "port": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[532], description="Added port attribute"
            ),
        ],
    ),
    ...
    "profile_id": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[497], description="Added profile_id attribute"
            ),
        ],
    ),
    ...
    "query": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[530], description="Added query attribute"
            ),
        ],
    ),
    ...
    "redis.command": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.18.0", prs=[531], description="Added redis.command attribute"
            ),
        ],
    ),
    ...
    "sentry.event.serialized_breadcrumbs": AttributeMetadata(
        ...
        visibility=Visibility.INTERNAL,
        changelog=[
            ChangelogEntry(version="0.18.0", prs=[556]),
        ],
    ),

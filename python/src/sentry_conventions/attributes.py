...
class ATTRIBUTE_NAMES(metaclass=_AttributeNamesMeta):
    ...
    Defined in OTEL: Yes
    Visibility: public
    DEPRECATED: Use url.path instead - This attribute is being deprecated in favor of url.path, url.query and url.fragment. The value has to be split, so it is transformed rather than renamed.
    ...
    DEPRECATED: Use network.transport instead - This attribute is being deprecated in favor of network.transport. The values change from ip_tcp and ip_udp to tcp and udp, so it is transformed rather than renamed.
    Example: "tcp"
    """
...
ATTRIBUTE_METADATA: Dict[str, AttributeMetadata] = {
    ...
    "aws_region": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[537], description="Added aws_region attribute"
            ),
        ],
    ),
    ...
    "code.function": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0",
                prs=[538],
                description="Added django.function_name as an alias",
            ),
    ...
    "code": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[533], description="Added code attribute"
            ),
        ],
    ),
    ...
    "db.params": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[529], description="Added db.params attribute"
            ),
        ],
    ),
    ...
    "gcp_region": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[535], description="Added gcp_region attribute"
            ),
        ],
    ),
    ...
    "http.target": AttributeMetadata(
        ...
        deprecation=DeprecationInfo(
            ...
            reason="This attribute is being deprecated in favor of url.path, url.query and url.fragment. The value has to be split, so it is transformed rather than renamed.",
            status=DeprecationStatus.TRANSFORM,
    ...
    "net.transport": AttributeMetadata(
        ...
        deprecation=DeprecationInfo(
            replacement="network.transport",
            reason="This attribute is being deprecated in favor of network.transport. The values change from ip_tcp and ip_udp to tcp and udp, so it is transformed rather than renamed.",
            status=DeprecationStatus.TRANSFORM,
    ...
    "port": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[532], description="Added port attribute"
            ),
        ],
    ),
    ...
    "profile_id": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[497], description="Added profile_id attribute"
            ),
        ],
    ),
    ...
    "query": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[530], description="Added query attribute"
            ),
        ],
    ),
    ...
    "redis.command": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(
                version="0.19.0", prs=[531], description="Added redis.command attribute"
            ),
        ],
    ),

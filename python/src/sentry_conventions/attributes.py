...
class DeprecationInfo:
    """Deprecation information structure."""
...
class AttributeMetadata:
    """Structured metadata for an attribute."""
...
BROWSER_SCRIPT_SOURCE_CHAR_POSITION: Literal["browser.script.source_char_position"] = (
...
GEN_AI_COST_OUTPUT_TOKENS_REASONING: Literal["gen_ai.cost.output_tokens.reasoning"] = (
...
GEN_AI_USAGE_TOTAL_COST: Literal["gen_ai.usage.total_cost"] = "gen_ai.usage.total_cost"
"""The total cost for the tokens used.
...
HTTP_RESPONSE_HEADER_CONTENT_LENGTH: Literal["http.response.header.content-length"] = (
...
# Literal type for all possible attribute names
AttributeName = Literal[
    ...
    "GEN_AI_COST_INPUT_TOKENS_CACHED",
    "GEN_AI_COST_OUTPUT_TOKENS",
    "GEN_AI_COST_OUTPUT_TOKENS_REASONING",
...
class Attributes(TypedDict, total=False):
    """Typed dictionary for non-deprecated attributes."""

    AI_CITATIONS: List[str]
    AI_DOCUMENTS: List[str]
    AI_IS_SEARCH_REQUIRED: bool
    AI_METADATA: str
    AI_PREAMBLE: str
    AI_RAW_PROMPTING: bool
    AI_RESPONSE_FORMAT: str
    AI_SEARCH_QUERIES: List[str]
    AI_SEARCH_RESULTS: List[str]
    AI_TAGS: str
    AI_TEXTS: List[str]
    AI_TOTAL_COST: float
    ...
    BROWSER_NAME: str
    BROWSER_REPORT_TYPE: str
    BROWSER_SCRIPT_INVOKER: str
    BROWSER_SCRIPT_INVOKER_TYPE: str
    BROWSER_SCRIPT_SOURCE_CHAR_POSITION: int
    BROWSER_VERSION: str
    CACHE_HIT: bool
    CACHE_ITEM_SIZE: int
    CACHE_KEY: List[str]
    ...
    CLIENT_ADDRESS: str
    CLIENT_PORT: int
    CLOUDFLARE_D1_DURATION: int
    CLOUDFLARE_D1_ROWS_READ: int
    CLOUDFLARE_D1_ROWS_WRITTEN: int
    CODE_FILE_PATH: str
    CODE_FUNCTION_NAME: str
    CODE_LINE_NUMBER: int
    DB_COLLECTION_NAME: str
    DB_NAMESPACE: str
    DB_OPERATION_NAME: str
    DB_QUERY_PARAMETER_KEY: str
    DB_QUERY_SUMMARY: str
    DB_QUERY_TEXT: str
    DB_REDIS_CONNECTION: str
    DB_REDIS_PARAMETERS: List[str]
    DB_SYSTEM_NAME: str
    DB_USER: str
    DEVICE_BRAND: str
    DEVICE_FAMILY: str
    ...
    FAAS_TIME: str
    FAAS_TRIGGER: str
    FLAG_EVALUATION_KEY: bool
    FRAMES_DELAY: int
    FRAMES_FROZEN: int
    FRAMES_SLOW: int
    FRAMES_TOTAL: int
    GEN_AI_AGENT_NAME: str
    GEN_AI_ASSISTANT_MESSAGE: str
    GEN_AI_CHOICE: str
    GEN_AI_COST_INPUT_TOKENS: float
    GEN_AI_COST_INPUT_TOKENS_CACHED: float
    GEN_AI_COST_OUTPUT_TOKENS: float
    GEN_AI_COST_OUTPUT_TOKENS_REASONING: float
    GEN_AI_OPERATION_NAME: str
    GEN_AI_OPERATION_TYPE: str
    GEN_AI_PIPELINE_NAME: str
    GEN_AI_PROMPT: str
    GEN_AI_REQUEST_AVAILABLE_TOOLS: str
    GEN_AI_REQUEST_FREQUENCY_PENALTY: float
    GEN_AI_REQUEST_MAX_TOKENS: int
    GEN_AI_REQUEST_MESSAGES: str
    GEN_AI_REQUEST_MODEL: str
    GEN_AI_REQUEST_PRESENCE_PENALTY: float
    GEN_AI_REQUEST_SEED: str
    ...
    GEN_AI_RESPONSE_STREAMING: bool
    GEN_AI_RESPONSE_TEXT: str
    GEN_AI_RESPONSE_TOKENS_PER_SECOND: float
    GEN_AI_RESPONSE_TOOL_CALLS: str
    GEN_AI_SYSTEM: str
    GEN_AI_SYSTEM_MESSAGE: str
    GEN_AI_TOOL_DESCRIPTION: str
    GEN_AI_TOOL_INPUT: str
    GEN_AI_TOOL_MESSAGE: str
    GEN_AI_TOOL_NAME: str
    GEN_AI_TOOL_OUTPUT: str
    GEN_AI_TOOL_TYPE: str
    GEN_AI_USAGE_INPUT_TOKENS: int
    GEN_AI_USAGE_INPUT_TOKENS_CACHED: int
    GEN_AI_USAGE_OUTPUT_TOKENS: int
    GEN_AI_USAGE_OUTPUT_TOKENS_REASONING: int
    GEN_AI_USAGE_TOTAL_COST: float
    GEN_AI_USAGE_TOTAL_TOKENS: int
    GEN_AI_USER_MESSAGE: str
    GRAPHQL_OPERATION_NAME: str
    GRAPHQL_OPERATION_TYPE: str
    HTTP_DECODED_RESPONSE_CONTENT_LENGTH: int
    HTTP_FRAGMENT: str
    HTTP_QUERY: str
    HTTP_REQUEST_CONNECT_START: int
    HTTP_REQUEST_CONNECTION_END: int
    HTTP_REQUEST_DOMAIN_LOOKUP_END: int
    HTTP_REQUEST_DOMAIN_LOOKUP_START: int
    HTTP_REQUEST_FETCH_START: int
    HTTP_REQUEST_HEADER_KEY: List[str]
    HTTP_REQUEST_METHOD: str
    HTTP_REQUEST_REDIRECT_START: int
    HTTP_REQUEST_REQUEST_START: int
    HTTP_REQUEST_RESEND_COUNT: int
    HTTP_REQUEST_RESPONSE_END: int
    HTTP_REQUEST_RESPONSE_START: int
    HTTP_REQUEST_SECURE_CONNECTION_START: int
    HTTP_RESPONSE_BODY_SIZE: int
    HTTP_RESPONSE_HEADER_KEY: List[str]
    HTTP_RESPONSE_HEADER_CONTENT_LENGTH: str
    ...
    JVM_GC_ACTION: str
    JVM_GC_NAME: str
    JVM_MEMORY_POOL_NAME: str
    JVM_MEMORY_TYPE: str
    JVM_THREAD_DAEMON: bool
    JVM_THREAD_STATE: str
    LCP_ELEMENT: str
    LCP_ID: str
    LCP_SIZE: int
    LCP_URL: str
    LOGGER_NAME: str
    MESSAGING_DESTINATION_CONNECTION: str
    MESSAGING_DESTINATION_NAME: str
    MESSAGING_MESSAGE_BODY_SIZE: int
    MESSAGING_MESSAGE_ENVELOPE_SIZE: int
    MESSAGING_MESSAGE_ID: str
    MESSAGING_MESSAGE_RECEIVE_LATENCY: int
    MESSAGING_MESSAGE_RETRY_COUNT: int
    MESSAGING_OPERATION_TYPE: str
    MESSAGING_SYSTEM: str
    NAVIGATION_TYPE: str
    NEL_ELAPSED_TIME: int
    NEL_PHASE: str
    NEL_REFERRER: str
    NEL_SAMPLING_FUNCTION: float
    NEL_TYPE: str
    NETWORK_LOCAL_ADDRESS: str
    NETWORK_LOCAL_PORT: int
    NETWORK_PEER_ADDRESS: str
    NETWORK_PEER_PORT: int
    NETWORK_PROTOCOL_NAME: str
    ...
    OS_VERSION: str
    OTEL_SCOPE_NAME: str
    OTEL_SCOPE_VERSION: str
    OTEL_STATUS_CODE: str
    OTEL_STATUS_DESCRIPTION: str
    PARAMS_KEY: str
    PREVIOUS_ROUTE: str
    ...
    REMIX_ACTION_FORM_DATA_KEY: str
    RESOURCE_RENDER_BLOCKING_STATUS: str
    RPC_GRPC_STATUS_CODE: int
    RPC_SERVICE: str
    SENTRY_CANCELLATION_REASON: str
    SENTRY_CLIENT_SAMPLE_RATE: float
    SENTRY_DIST: str
    SENTRY_ENVIRONMENT: str
    SENTRY_EXCLUSIVE_TIME: int
    SENTRY_HTTP_PREFETCH: bool
    SENTRY_IDLE_SPAN_FINISH_REASON: str
    SENTRY_MESSAGE_PARAMETER_KEY: str
    SENTRY_MESSAGE_TEMPLATE: str
    SENTRY_MODULE_KEY: str
    SENTRY_NEXTJS_SSR_FUNCTION_ROUTE: str
    SENTRY_NEXTJS_SSR_FUNCTION_TYPE: str
    SENTRY_OP: str
    SENTRY_ORIGIN: str
    SENTRY_PLATFORM: str
    SENTRY_PROFILE_ID: str
    SENTRY_RELEASE: str
    SENTRY_REPLAY_ID: str
    SENTRY_SDK_INTEGRATIONS: List[str]
    SENTRY_SDK_NAME: str
    SENTRY_SDK_VERSION: str
    SENTRY_SEGMENT_ID: str
    SENTRY_SEGMENT_NAME: str
    SENTRY_SERVER_SAMPLE_RATE: float
    SENTRY_SPAN_SOURCE: str
    SENTRY_TRACE_PARENT_SPAN_ID: str
    SENTRY_TRANSACTION: str
    SERVER_ADDRESS: str
    SERVER_PORT: int
    SERVICE_NAME: str
    SERVICE_VERSION: str
    ...
    UI_CONTRIBUTES_TO_TTFD: bool
    UI_CONTRIBUTES_TO_TTID: bool
    URL_DOMAIN: str
    URL_FRAGMENT: str
    URL_FULL: str
    URL_PATH: str
    URL_PATH_PARAMETER_KEY: str
    URL_PORT: int
    URL_QUERY: str
    URL_SCHEME: str
    URL_TEMPLATE: str
    ...
    USER_FULL_NAME: str
    USER_GEO_CITY: str
    USER_GEO_COUNTRY_CODE: str
    USER_GEO_REGION: str
    USER_GEO_SUBDIVISION: str
    USER_HASH: str
    USER_ID: str
    USER_IP_ADDRESS: str
    USER_NAME: str
...
class DeprecatedAttributes(TypedDict, total=False):
    """Typed dictionary for deprecated attributes."""

    AI_COMPLETION_TOKENS_USED: int
    AI_FINISH_REASON: str
    AI_FREQUENCY_PENALTY: float
    AI_FUNCTION_CALL: str
    AI_GENERATION_ID: str
    AI_INPUT_MESSAGES: str
    AI_MODEL_PROVIDER: str
    AI_MODEL_ID: str
    AI_PIPELINE_NAME: str
    AI_PRESENCE_PENALTY: float
    AI_PROMPT_TOKENS_USED: int
    ...
    DB_NAME: str
    DB_OPERATION: str
    DB_SQL_BINDINGS: List[str]
    DB_STATEMENT: str
    DB_SYSTEM: str
    ENVIRONMENT: str
    FS_ERROR: str
    GEN_AI_USAGE_COMPLETION_TOKENS: int
    GEN_AI_USAGE_PROMPT_TOKENS: int
    HTTP_CLIENT_IP: str
    HTTP_FLAVOR: str
    HTTP_HOST: str
    HTTP_METHOD: str
    HTTP_RESPONSE_CONTENT_LENGTH: int
    HTTP_RESPONSE_TRANSFER_SIZE: int
    HTTP_SCHEME: str
    ...
    NET_PEER_NAME: str
    NET_PEER_PORT: int
    NET_PROTOCOL_NAME: str
    NET_PROTOCOL_VERSION: str
    NET_SOCK_FAMILY: str
    NET_SOCK_HOST_ADDR: str
    NET_SOCK_HOST_PORT: int
    NET_SOCK_PEER_ADDR: str
    NET_SOCK_PEER_NAME: str
    NET_SOCK_PEER_PORT: int
    NET_TRANSPORT: str
    PROFILE_ID: str
    QUERY_KEY: str
    RELEASE: str
...
class FullAttributes(TypedDict, total=False):
    """Typed dictionary for all attributes (including deprecated)."""
...
# Create union type of all attribute names for type safety
...
# Metadata dictionary - keys are constrained to valid attribute names
_ATTRIBUTE_METADATA: Dict[str, AttributeMetadata] = {
    AI_CITATIONS: AttributeMetadata(
    ...
    AI_COMPLETION_TOKENS_USED: AttributeMetadata(
    ...
    AI_DOCUMENTS: AttributeMetadata(
    ...
    AI_FINISH_REASON: AttributeMetadata(
    ...
    AI_FREQUENCY_PENALTY: AttributeMetadata(
    ...
    AI_FUNCTION_CALL: AttributeMetadata(
    ...
    AI_GENERATION_ID: AttributeMetadata(
    ...
    AI_INPUT_MESSAGES: AttributeMetadata(
    ...
    AI_IS_SEARCH_REQUIRED: AttributeMetadata(
    ...
    AI_MODEL_PROVIDER: AttributeMetadata(
    ...
    AI_PIPELINE_NAME: AttributeMetadata(
    ...
    AI_PRESENCE_PENALTY: AttributeMetadata(
    ...
    AI_PROMPT_TOKENS_USED: AttributeMetadata(
    ...
    AI_RAW_PROMPTING: AttributeMetadata(
    ...
    AI_RESPONSE_FORMAT: AttributeMetadata(
    ...
    AI_RESPONSES: AttributeMetadata(
    ...
    AI_SEARCH_QUERIES: AttributeMetadata(
    ...
    AI_SEARCH_RESULTS: AttributeMetadata(
    ...
    AI_STREAMING: AttributeMetadata(
    ...
    AI_TEMPERATURE: AttributeMetadata(
    ...
    AI_TOOL_CALLS: AttributeMetadata(
    ...
    AI_TOTAL_COST: AttributeMetadata(
    ...
    AI_TOTAL_TOKENS_USED: AttributeMetadata(
    ...
    BROWSER_NAME: AttributeMetadata(
    ...
    BROWSER_REPORT_TYPE: AttributeMetadata(
    ...
    BROWSER_SCRIPT_INVOKER: AttributeMetadata(
    ...
    BROWSER_SCRIPT_INVOKER_TYPE: AttributeMetadata(
    ...
    BROWSER_SCRIPT_SOURCE_CHAR_POSITION: AttributeMetadata(
    ...
    BROWSER_VERSION: AttributeMetadata(
    ...
    CACHE_ITEM_SIZE: AttributeMetadata(
    ...
    CACHE_OPERATION: AttributeMetadata(
    ...
    CLIENT_ADDRESS: AttributeMetadata(
    ...
    CLOUDFLARE_D1_DURATION: AttributeMetadata(
    ...
    CLOUDFLARE_D1_ROWS_READ: AttributeMetadata(
    ...
    CLOUDFLARE_D1_ROWS_WRITTEN: AttributeMetadata(
    ...
    CODE_FILE_PATH: AttributeMetadata(
    ...
    CODE_FILEPATH: AttributeMetadata(
        brief="The source code file name that identifies the code unit as uniquely as possible (preferably an absolute file path).",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.MAYBE),
        is_in_otel=True,
    ...
    CODE_FUNCTION: AttributeMetadata(
    ...
    CODE_FUNCTION_NAME: AttributeMetadata(
        brief="The method or function name, or equivalent (usually rightmost part of the code unit's name).",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    CODE_LINE_NUMBER: AttributeMetadata(
    ...
    CODE_NAMESPACE: AttributeMetadata(
    ...
    DB_COLLECTION_NAME: AttributeMetadata(
    ...
    DB_NAMESPACE: AttributeMetadata(
        brief="The name of the database being accessed.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    DB_OPERATION: AttributeMetadata(
    ...
    DB_OPERATION_NAME: AttributeMetadata(
        brief="The name of the operation being executed.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    DB_QUERY_PARAMETER_KEY: AttributeMetadata(
    ...
    DB_QUERY_SUMMARY: AttributeMetadata(
    ...
    DB_QUERY_TEXT: AttributeMetadata(
    ...
    DB_REDIS_CONNECTION: AttributeMetadata(
    ...
    DB_REDIS_PARAMETERS: AttributeMetadata(
    ...
    DB_SQL_BINDINGS: AttributeMetadata(
    ...
    DB_STATEMENT: AttributeMetadata(
    ...
    DB_SYSTEM_NAME: AttributeMetadata(
        brief="An identifier for the database management system (DBMS) product being used. See [OpenTelemetry docs](https://github.com/open-telemetry/semantic-conventions/blob/main/docs/database/database-spans.md#notes-and-well-known-identifiers-for-dbsystem) for a list of well-known identifiers.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    DEVICE_BRAND: AttributeMetadata(
    ...
    DEVICE_FAMILY: AttributeMetadata(
    ...
    DEVICE_MODEL: AttributeMetadata(
    ...
    EXCEPTION_ESCAPED: AttributeMetadata(
    ...
    EXCEPTION_MESSAGE: AttributeMetadata(
    ...
    EXCEPTION_STACKTRACE: AttributeMetadata(
    ...
    EXCEPTION_TYPE: AttributeMetadata(
    ...
    FAAS_COLDSTART: AttributeMetadata(
    ...
    FAAS_TRIGGER: AttributeMetadata(
    ...
    FLAG_EVALUATION_KEY: AttributeMetadata(
    ...
    FRAMES_DELAY: AttributeMetadata(
    ...
    GEN_AI_AGENT_NAME: AttributeMetadata(
    ...
    GEN_AI_ASSISTANT_MESSAGE: AttributeMetadata(
    ...
    GEN_AI_CHOICE: AttributeMetadata(
    ...
    GEN_AI_COST_INPUT_TOKENS: AttributeMetadata(
    ...
    GEN_AI_COST_INPUT_TOKENS_CACHED: AttributeMetadata(
    ...
    GEN_AI_COST_OUTPUT_TOKENS: AttributeMetadata(
    ...
    GEN_AI_COST_OUTPUT_TOKENS_REASONING: AttributeMetadata(
    ...
    GEN_AI_OPERATION_NAME: AttributeMetadata(
    ...
    GEN_AI_OPERATION_TYPE: AttributeMetadata(
    ...
    GEN_AI_PIPELINE_NAME: AttributeMetadata(
    ...
    GEN_AI_PROMPT: AttributeMetadata(
        brief="The input messages sent to the model",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.MAYBE),
        is_in_otel=True,
    ...
    GEN_AI_REQUEST_AVAILABLE_TOOLS: AttributeMetadata(
    ...
    GEN_AI_REQUEST_FREQUENCY_PENALTY: AttributeMetadata(
        brief="Used to reduce repetitiveness of generated tokens. The higher the value, the stronger a penalty is applied to previously present tokens, proportional to how many times they have already appeared in the prompt or prior generation.",
        type=AttributeType.DOUBLE,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_REQUEST_MAX_TOKENS: AttributeMetadata(
    ...
    GEN_AI_REQUEST_MESSAGES: AttributeMetadata(
    ...
    GEN_AI_REQUEST_MODEL: AttributeMetadata(
    ...
    GEN_AI_REQUEST_PRESENCE_PENALTY: AttributeMetadata(
        brief="Used to reduce repetitiveness of generated tokens. Similar to frequency_penalty, except that this penalty is applied equally to all tokens that have already appeared, regardless of their exact frequencies.",
        type=AttributeType.DOUBLE,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_REQUEST_SEED: AttributeMetadata(
        brief="The seed, ideally models given the same seed and same other parameters will produce the exact same output.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_REQUEST_TEMPERATURE: AttributeMetadata(
        brief="For an AI model call, the temperature parameter. Temperature essentially means how random the output will be.",
        type=AttributeType.DOUBLE,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_REQUEST_TOP_K: AttributeMetadata(
        brief="Limits the model to only consider the K most likely next tokens, where K is an integer (e.g., top_k=20 means only the 20 highest probability tokens are considered).",
        type=AttributeType.INTEGER,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_REQUEST_TOP_P: AttributeMetadata(
        brief="Limits the model to only consider tokens whose cumulative probability mass adds up to p, where p is a float between 0 and 1 (e.g., top_p=0.7 means only tokens that sum up to 70% of the probability mass are considered).",
        type=AttributeType.DOUBLE,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_RESPONSE_FINISH_REASONS: AttributeMetadata(
        brief="The reason why the model stopped generating.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_RESPONSE_ID: AttributeMetadata(
        brief="Unique identifier for the completion.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_RESPONSE_MODEL: AttributeMetadata(
        brief="The vendor-specific ID of the model used.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_RESPONSE_STREAMING: AttributeMetadata(
    ...
    GEN_AI_RESPONSE_TEXT: AttributeMetadata(
    ...
    GEN_AI_RESPONSE_TOKENS_PER_SECOND: AttributeMetadata(
    ...
    GEN_AI_RESPONSE_TOOL_CALLS: AttributeMetadata(
    ...
    GEN_AI_SYSTEM: AttributeMetadata(
        brief="The provider of the model.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GEN_AI_SYSTEM_MESSAGE: AttributeMetadata(
    ...
    GEN_AI_TOOL_DESCRIPTION: AttributeMetadata(
    ...
    GEN_AI_TOOL_INPUT: AttributeMetadata(
    ...
    GEN_AI_TOOL_MESSAGE: AttributeMetadata(
    ...
    GEN_AI_TOOL_NAME: AttributeMetadata(
    ...
    GEN_AI_TOOL_OUTPUT: AttributeMetadata(
    ...
    GEN_AI_TOOL_TYPE: AttributeMetadata(
    ...
    GEN_AI_USAGE_COMPLETION_TOKENS: AttributeMetadata(
    ...
    GEN_AI_USAGE_INPUT_TOKENS: AttributeMetadata(
    ...
    GEN_AI_USAGE_INPUT_TOKENS_CACHED: AttributeMetadata(
    ...
    GEN_AI_USAGE_OUTPUT_TOKENS: AttributeMetadata(
    ...
    GEN_AI_USAGE_OUTPUT_TOKENS_REASONING: AttributeMetadata(
    ...
    GEN_AI_USAGE_PROMPT_TOKENS: AttributeMetadata(
    ...
    GEN_AI_USAGE_TOTAL_COST: AttributeMetadata(
        brief="The total cost for the tokens used.",
        type=AttributeType.DOUBLE,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=False,
    ...
    GEN_AI_USAGE_TOTAL_TOKENS: AttributeMetadata(
    ...
    GEN_AI_USER_MESSAGE: AttributeMetadata(
    ...
    GRAPHQL_OPERATION_NAME: AttributeMetadata(
        brief="The name of the operation being executed.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    GRAPHQL_OPERATION_TYPE: AttributeMetadata(
    ...
    HTTP_CLIENT_IP: AttributeMetadata(
        brief="Client address - domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    HTTP_DECODED_RESPONSE_CONTENT_LENGTH: AttributeMetadata(
    ...
    HTTP_FRAGMENT: AttributeMetadata(
    ...
    HTTP_REQUEST_CONNECT_START: AttributeMetadata(
    ...
    HTTP_REQUEST_CONNECTION_END: AttributeMetadata(
    ...
    HTTP_REQUEST_DOMAIN_LOOKUP_END: AttributeMetadata(
    ...
    HTTP_REQUEST_DOMAIN_LOOKUP_START: AttributeMetadata(
    ...
    HTTP_REQUEST_FETCH_START: AttributeMetadata(
    ...
    HTTP_REQUEST_HEADER_KEY: AttributeMetadata(
    ...
    HTTP_REQUEST_METHOD: AttributeMetadata(
        brief="The HTTP method used.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    HTTP_REQUEST_REDIRECT_START: AttributeMetadata(
    ...
    HTTP_REQUEST_REQUEST_START: AttributeMetadata(
    ...
    HTTP_REQUEST_RESEND_COUNT: AttributeMetadata(
    ...
    HTTP_REQUEST_RESPONSE_END: AttributeMetadata(
    ...
    HTTP_REQUEST_RESPONSE_START: AttributeMetadata(
        brief="The UNIX timestamp representing the time immediately before the browser starts requesting the resource from the server, cache, or local resource. If the transport connection fails and the browser retires the request, the value returned will be the start of the retry request.",
        type=AttributeType.INTEGER,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=False,
    ...
    HTTP_REQUEST_SECURE_CONNECTION_START: AttributeMetadata(
    ...
    HTTP_RESPONSE_BODY_SIZE: AttributeMetadata(
    ...
    HTTP_RESPONSE_HEADER_KEY: AttributeMetadata(
    ...
    HTTP_RESPONSE_HEADER_CONTENT_LENGTH: AttributeMetadata(
    ...
    HTTP_RESPONSE_SIZE: AttributeMetadata(
    ...
    HTTP_RESPONSE_STATUS_CODE: AttributeMetadata(
    ...
    HTTP_RESPONSE_CONTENT_LENGTH: AttributeMetadata(
        brief="The encoded body size of the response (in bytes).",
        type=AttributeType.INTEGER,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    HTTP_RESPONSE_TRANSFER_SIZE: AttributeMetadata(
        brief="The transfer size of the response (in bytes).",
        type=AttributeType.INTEGER,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=False,
    ...
    HTTP_SERVER_NAME: AttributeMetadata(
    ...
    HTTP_STATUS_CODE: AttributeMetadata(
        brief="The status code of the HTTP response.",
        type=AttributeType.INTEGER,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    HTTP_USER_AGENT: AttributeMetadata(
    ...
    JVM_GC_ACTION: AttributeMetadata(
    ...
    JVM_MEMORY_POOL_NAME: AttributeMetadata(
    ...
    JVM_MEMORY_TYPE: AttributeMetadata(
        brief="Name of the memory pool.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    JVM_THREAD_DAEMON: AttributeMetadata(
    ...
    JVM_THREAD_STATE: AttributeMetadata(
    ...
    MESSAGING_DESTINATION_CONNECTION: AttributeMetadata(
    ...
    MESSAGING_DESTINATION_NAME: AttributeMetadata(
    ...
    MESSAGING_MESSAGE_BODY_SIZE: AttributeMetadata(
    ...
    MESSAGING_MESSAGE_ENVELOPE_SIZE: AttributeMetadata(
    ...
    MESSAGING_MESSAGE_ID: AttributeMetadata(
    ...
    MESSAGING_MESSAGE_RECEIVE_LATENCY: AttributeMetadata(
    ...
    MESSAGING_MESSAGE_RETRY_COUNT: AttributeMetadata(
    ...
    MESSAGING_OPERATION_TYPE: AttributeMetadata(
    ...
    MESSAGING_SYSTEM: AttributeMetadata(
    ...
    NAVIGATION_TYPE: AttributeMetadata(
    ...
    NEL_ELAPSED_TIME: AttributeMetadata(
    ...
    NEL_REFERRER: AttributeMetadata(
    ...
    NEL_SAMPLING_FUNCTION: AttributeMetadata(
    ...
    NET_HOST_NAME: AttributeMetadata(
    ...
    NET_HOST_PORT: AttributeMetadata(
    ...
    NET_PEER_NAME: AttributeMetadata(
        brief="Server domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NET_PEER_PORT: AttributeMetadata(
    ...
    NET_PROTOCOL_NAME: AttributeMetadata(
    ...
    NET_PROTOCOL_VERSION: AttributeMetadata(
        brief="The actual version of the protocol used for network communication.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NET_SOCK_FAMILY: AttributeMetadata(
    ...
    NET_SOCK_HOST_ADDR: AttributeMetadata(
    ...
    NET_SOCK_HOST_PORT: AttributeMetadata(
    ...
    NET_SOCK_PEER_ADDR: AttributeMetadata(
    ...
    NET_SOCK_PEER_NAME: AttributeMetadata(
    ...
    NET_SOCK_PEER_PORT: AttributeMetadata(
    ...
    NET_TRANSPORT: AttributeMetadata(
    ...
    NETWORK_LOCAL_ADDRESS: AttributeMetadata(
        brief="Local address of the network connection - IP address or Unix domain socket name.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NETWORK_LOCAL_PORT: AttributeMetadata(
        brief="Local port number of the network connection.",
        type=AttributeType.INTEGER,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NETWORK_PEER_ADDRESS: AttributeMetadata(
        brief="Peer address of the network connection - IP address or Unix domain socket name.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NETWORK_PEER_PORT: AttributeMetadata(
        brief="Peer port number of the network connection.",
        type=AttributeType.INTEGER,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NETWORK_PROTOCOL_NAME: AttributeMetadata(
        brief="OSI application layer or non-OSI equivalent.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NETWORK_PROTOCOL_VERSION: AttributeMetadata(
        brief="The actual version of the protocol used for network communication.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NETWORK_TRANSPORT: AttributeMetadata(
        brief="OSI transport layer or inter-process communication method.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,
    ...
    NETWORK_TYPE: AttributeMetadata(
    ...
    OS_DESCRIPTION: AttributeMetadata(
    ...
    OTEL_SCOPE_NAME: AttributeMetadata(
    ...
    OTEL_SCOPE_VERSION: AttributeMetadata(
    ...
    OTEL_STATUS_CODE: AttributeMetadata(
    ...
    OTEL_STATUS_DESCRIPTION: AttributeMetadata(
    ...
    PROCESS_EXECUTABLE_NAME: AttributeMetadata(
    ...
    PROCESS_RUNTIME_DESCRIPTION: AttributeMetadata(
    ...
    PROCESS_RUNTIME_NAME: AttributeMetadata(
    ...
    PROCESS_RUNTIME_VERSION: AttributeMetadata(
    ...
    REMIX_ACTION_FORM_DATA_KEY: AttributeMetadata(
    ...
    RESOURCE_RENDER_BLOCKING_STATUS: AttributeMetadata(
    ...
    RPC_GRPC_STATUS_CODE: AttributeMetadata(
    ...
    SENTRY_CANCELLATION_REASON: AttributeMetadata(
    ...
    SENTRY_CLIENT_SAMPLE_RATE: AttributeMetadata(
    ...
    SENTRY_ENVIRONMENT: AttributeMetadata(
        brief="The sentry environment.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=False,
    ...
    SENTRY_EXCLUSIVE_TIME: AttributeMetadata(
    ...
    SENTRY_HTTP_PREFETCH: AttributeMetadata(
    ...
    SENTRY_IDLE_SPAN_FINISH_REASON: AttributeMetadata(
    ...
    SENTRY_MESSAGE_PARAMETER_KEY: AttributeMetadata(
    ...
    SENTRY_MESSAGE_TEMPLATE: AttributeMetadata(
    ...
    SENTRY_MODULE_KEY: AttributeMetadata(
    ...
    SENTRY_NEXTJS_SSR_FUNCTION_ROUTE: AttributeMetadata(
    ...
    SENTRY_NEXTJS_SSR_FUNCTION_TYPE: AttributeMetadata(
    ...
    SENTRY_ORIGIN: AttributeMetadata(
    ...
    SENTRY_PLATFORM: AttributeMetadata(
    ...
    SENTRY_PROFILE_ID: AttributeMetadata(
        brief="The id of the sentry profile.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=False,
    ...
    SENTRY_RELEASE: AttributeMetadata(
        brief="The sentry release.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=False,
    ...
    SENTRY_REPLAY_ID: AttributeMetadata(
        brief="The id of the sentry replay.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=False,
    ...
    SENTRY_SDK_INTEGRATIONS: AttributeMetadata(
    ...
    SENTRY_SDK_NAME: AttributeMetadata(
    ...
    SENTRY_SDK_VERSION: AttributeMetadata(
    ...
    SENTRY_SEGMENT_ID: AttributeMetadata(
    ...
    SENTRY_SEGMENT_NAME: AttributeMetadata(
    ...
    SENTRY_SERVER_SAMPLE_RATE: AttributeMetadata(
    ...
    SENTRY_SPAN_SOURCE: AttributeMetadata(
    ...
    SENTRY_TRACE_PARENT_SPAN_ID: AttributeMetadata(
    ...
    SENTRY_TRANSACTION: AttributeMetadata(
    ...
    SERVICE_NAME: AttributeMetadata(
    ...
    SERVICE_VERSION: AttributeMetadata(
    ...
    UI_COMPONENT_NAME: AttributeMetadata(
    ...
    UI_CONTRIBUTES_TO_TTFD: AttributeMetadata(
    ...
    UI_CONTRIBUTES_TO_TTID: AttributeMetadata(
    ...
    URL_FRAGMENT: AttributeMetadata(
    ...
    URL_PATH_PARAMETER_KEY: AttributeMetadata(
        brief="Decoded parameters extracted from a URL path. Usually added by client-side routing frameworks like vue-router.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.MAYBE),
        is_in_otel=False,
    ...
    URL_TEMPLATE: AttributeMetadata(
    ...
    USER_FULL_NAME: AttributeMetadata(
    ...
    USER_GEO_CITY: AttributeMetadata(
    ...
    USER_GEO_COUNTRY_CODE: AttributeMetadata(
    ...
    USER_GEO_REGION: AttributeMetadata(
    ...
    USER_GEO_SUBDIVISION: AttributeMetadata(
    ...
    USER_IP_ADDRESS: AttributeMetadata(
    ...
    USER_AGENT_ORIGINAL: AttributeMetadata(
        brief="Value of the HTTP User-Agent header sent by the client.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.FALSE),
        is_in_otel=True,

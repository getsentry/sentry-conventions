...
ATTRIBUTE_METADATA: Dict[str, AttributeMetadata] = {
    ...
    "host.id": AttributeMetadata(
        brief="Unique host ID. In cloud environments, this must be the ID of the compute instance assigned by the provider.",
        type=AttributeType.STRING,
        pii=PiiInfo(isPii=IsPii.MAYBE),
        is_in_otel=True,
        visibility=Visibility.PUBLIC,
        ...
        changelog=[
            ChangelogEntry(
                version="next", prs=[416], description="Added host.id attribute"
            ),
        ],
    ),

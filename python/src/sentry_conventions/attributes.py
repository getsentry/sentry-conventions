...
class ATTRIBUTE_NAMES(metaclass=_AttributeNamesMeta):
    ...
    DEVICE_CPU_LOGICAL_CORE_COUNT: Literal["device.cpu.logical_core_count"] = "device.cpu.logical_core_count"
...
ATTRIBUTE_METADATA: Dict[str, AttributeMetadata] = {
    ...
    "device.cpu.logical_core_count": AttributeMetadata(
        ...
        sdks=["javascript-browser"],
        changelog=[
            ChangelogEntry(version="next", description="Added device.processor_count as alias"),
            ChangelogEntry(version="next", prs=[281], description="Added attribute device.cpu.logical_core_count to be used instead of hardwareConcurrency"),
        ],
    ),
    ...
    "device.free_memory": AttributeMetadata(
        ...
        example=2147483648,
        changelog=[
            ChangelogEntry(version="next", description="Added device.free_memory attribute"),
        ],
    ),
    ...
    "device.memory_size": AttributeMetadata(
        ...
        example=17179869184,
        changelog=[
            ChangelogEntry(version="next", description="Added device.memory_size attribute"),
        ],
    ),
    ...
    "device.model_id": AttributeMetadata(
        ...
        example="N861AP",
        changelog=[
            ChangelogEntry(version="next", description="Added device.model_id attribute"),
        ],
    ),
    "device.processor_count": AttributeMetadata(
        ...
        aliases=["device.cpu.logical_core_count","hardwareConcurrency"],
        changelog=[
            ChangelogEntry(version="next", description="Added and deprecated attribute device.processor_count in favor of device.cpu.logical_core_count"),
        ],
    ),
    "device.simulator": AttributeMetadata(
        ...
        example=False,
        changelog=[
            ChangelogEntry(version="next", description="Added device.simulator attribute"),
        ],
    ),

...
class ATTRIBUTE_NAMES(metaclass=_AttributeNamesMeta):
    ...
    ADDRESS_KEYS: Tuple[str, ...] = ("server.address", "address", "http.host", "http.server_name", "net.host.name", "net.peer.name", "server_name",)
    ...
    AI_COMPLETION_TOKENS_USED_KEYS: Tuple[str, ...] = ("gen_ai.usage.output_tokens", "ai.completion_tokens.used", "gen_ai.usage.completion_tokens",)
    ...
    AI_FINISH_REASON_KEYS: Tuple[str, ...] = ("gen_ai.response.finish_reasons", "ai.finish_reason", "gen_ai.response.finish_reason",)
    ...
    AI_FREQUENCY_PENALTY_KEYS: Tuple[str, ...] = ("gen_ai.request.frequency_penalty", "ai.frequency_penalty",)
    ...
    AI_FUNCTION_CALL_KEYS: Tuple[str, ...] = ("gen_ai.tool.name", "ai.function_call", "mcp.tool.name",)
    ...
    AI_GENERATION_ID_KEYS: Tuple[str, ...] = ("gen_ai.response.id", "ai.generation_id",)
    ...
    AI_INPUT_MESSAGES_KEYS: Tuple[str, ...] = ("gen_ai.input.messages", "ai.input_messages", "ai.prompt.messages", "ai.texts", "gen_ai.prompt", "gen_ai.request.messages",)
    ...
    AI_MODEL_PROVIDER_KEYS: Tuple[str, ...] = ("gen_ai.provider.name", "ai.model.provider", "gen_ai.system",)
    ...
    AI_MODEL_ID_KEYS: Tuple[str, ...] = ("gen_ai.request.model", "ai.model_id",)
    ...
    AI_PIPELINE_NAME_KEYS: Tuple[str, ...] = ("gen_ai.pipeline.name", "ai.pipeline.name",)
    ...
    AI_PREAMBLE_KEYS: Tuple[str, ...] = ("gen_ai.system_instructions", "ai.preamble", "gen_ai.system.message",)
    ...
    AI_PRESENCE_PENALTY_KEYS: Tuple[str, ...] = ("gen_ai.request.presence_penalty", "ai.presence_penalty",)
    ...
    AI_PROMPT_MESSAGES_KEYS: Tuple[str, ...] = ("gen_ai.input.messages", "ai.input_messages", "ai.prompt.messages", "ai.texts", "gen_ai.prompt", "gen_ai.request.messages",)
    ...
    AI_PROMPT_TOKENS_USED_KEYS: Tuple[str, ...] = ("gen_ai.usage.input_tokens", "ai.prompt_tokens.used", "gen_ai.usage.prompt_tokens",)
    ...
    AI_RESPONSE_TEXT_KEYS: Tuple[str, ...] = ("gen_ai.output.messages", "ai.response.text", "ai.response.toolCalls", "ai.responses", "ai.tool_calls", "gen_ai.response.text", "gen_ai.response.tool_calls",)
    ...
    AI_RESPONSE_TOOLCALLS_KEYS: Tuple[str, ...] = ("gen_ai.output.messages", "ai.response.text", "ai.response.toolCalls", "ai.responses", "ai.tool_calls", "gen_ai.response.text", "gen_ai.response.tool_calls",)
    ...
    AI_RESPONSES_KEYS: Tuple[str, ...] = ("gen_ai.output.messages", "ai.response.text", "ai.response.toolCalls", "ai.responses", "ai.tool_calls", "gen_ai.response.text", "gen_ai.response.tool_calls",)
    ...
    AI_SEED_KEYS: Tuple[str, ...] = ("gen_ai.request.seed", "ai.seed",)
    ...
    AI_STREAMING_KEYS: Tuple[str, ...] = ("gen_ai.response.streaming", "ai.streaming",)
    ...
    AI_TEMPERATURE_KEYS: Tuple[str, ...] = ("gen_ai.request.temperature", "ai.temperature",)
    ...
    AI_TEXTS_KEYS: Tuple[str, ...] = ("gen_ai.input.messages", "ai.input_messages", "ai.prompt.messages", "ai.texts", "gen_ai.prompt", "gen_ai.request.messages",)
    ...
    AI_TOOLCALL_ARGS_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.arguments", "ai.toolCall.args", "gen_ai.tool.input",)
    ...
    AI_TOOLCALL_RESULT_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.result", "ai.toolCall.result", "gen_ai.tool.message", "gen_ai.tool.output", "mcp.tool.result.content",)
    ...
    AI_TOOL_CALLS_KEYS: Tuple[str, ...] = ("gen_ai.output.messages", "ai.response.text", "ai.response.toolCalls", "ai.responses", "ai.tool_calls", "gen_ai.response.text", "gen_ai.response.tool_calls",)
    ...
    AI_TOOLS_KEYS: Tuple[str, ...] = ("gen_ai.tool.definitions", "ai.tools", "gen_ai.request.available_tools",)
    ...
    AI_TOP_K_KEYS: Tuple[str, ...] = ("gen_ai.request.top_k", "ai.top_k",)
    ...
    AI_TOP_P_KEYS: Tuple[str, ...] = ("gen_ai.request.top_p", "ai.top_p",)
    ...
    AI_TOTAL_COST_KEYS: Tuple[str, ...] = ("gen_ai.cost.total_tokens", "ai.total_cost",)
    ...
    AI_TOTAL_TOKENS_USED_KEYS: Tuple[str, ...] = ("gen_ai.usage.total_tokens", "ai.total_tokens.used",)
    ...
    APP_APP_BUILD_KEYS: Tuple[str, ...] = ("app.build", "app.app_build",)
    ...
    APP_APP_IDENTIFIER_KEYS: Tuple[str, ...] = ("app.identifier", "app.app_identifier",)
    ...
    APP_APP_NAME_KEYS: Tuple[str, ...] = ("app.name", "app.app_name",)
    ...
    APP_APP_START_TIME_KEYS: Tuple[str, ...] = ("app.start_time", "app.app_start_time",)
    ...
    APP_APP_VERSION_KEYS: Tuple[str, ...] = ("app.version", "app.app_version",)
    ...
    APP_BUILD_KEYS: Tuple[str, ...] = ("app.build", "app.app_build",)
    ...
    APP_IDENTIFIER_KEYS: Tuple[str, ...] = ("app.identifier", "app.app_identifier",)
    ...
    APP_NAME_KEYS: Tuple[str, ...] = ("app.name", "app.app_name",)
    ...
    APP_START_TIME_KEYS: Tuple[str, ...] = ("app.start_time", "app.app_start_time",)
    ...
    APP_VERSION_KEYS: Tuple[str, ...] = ("app.version", "app.app_version",)

    # Path: model/attributes/app/app__vitals__frames__delay__value.json
    APP_VITALS_FRAMES_DELAY_VALUE: Literal["app.vitals.frames.delay.value"] = "app.vitals.frames.delay.value"
    ...
    APP_VITALS_FRAMES_DELAY_VALUE_KEYS: Tuple[str, ...] = ("app.vitals.frames.delay.value", "frames.delay",)

    # Path: model/attributes/app/app__vitals__frames__frozen__count.json
    APP_VITALS_FRAMES_FROZEN_COUNT: Literal["app.vitals.frames.frozen.count"] = "app.vitals.frames.frozen.count"
    ...
    APP_VITALS_FRAMES_FROZEN_COUNT_KEYS: Tuple[str, ...] = ("app.vitals.frames.frozen.count", "frames.frozen", "sentry.frames.frozen",)

    # Path: model/attributes/app/app__vitals__frames__frozen__rate.json
    APP_VITALS_FRAMES_FROZEN_RATE: Literal["app.vitals.frames.frozen.rate"] = "app.vitals.frames.frozen.rate"
    ...
    APP_VITALS_FRAMES_FROZEN_RATE_KEYS: Tuple[str, ...] = ("app.vitals.frames.frozen.rate", "frames_frozen_rate",)

    # Path: model/attributes/app/app__vitals__frames__slow__count.json
    APP_VITALS_FRAMES_SLOW_COUNT: Literal["app.vitals.frames.slow.count"] = "app.vitals.frames.slow.count"
    ...
    APP_VITALS_FRAMES_SLOW_COUNT_KEYS: Tuple[str, ...] = ("app.vitals.frames.slow.count", "frames.slow", "sentry.frames.slow",)

    # Path: model/attributes/app/app__vitals__frames__slow__rate.json
    APP_VITALS_FRAMES_SLOW_RATE: Literal["app.vitals.frames.slow.rate"] = "app.vitals.frames.slow.rate"
    ...
    APP_VITALS_FRAMES_SLOW_RATE_KEYS: Tuple[str, ...] = ("app.vitals.frames.slow.rate", "frames_slow_rate",)

    # Path: model/attributes/app/app__vitals__frames__total__count.json
    APP_VITALS_FRAMES_TOTAL_COUNT: Literal["app.vitals.frames.total.count"] = "app.vitals.frames.total.count"
    ...
    APP_VITALS_FRAMES_TOTAL_COUNT_KEYS: Tuple[str, ...] = ("app.vitals.frames.total.count", "frames.total", "sentry.frames.total",)

    # Path: model/attributes/app/app__vitals__stall__duration.json
    APP_VITALS_STALL_DURATION: Literal["app.vitals.stall.duration"] = "app.vitals.stall.duration"
    ...
    APP_VITALS_STALL_DURATION_KEYS: Tuple[str, ...] = ("app.vitals.stall.duration", "stall_total_time",)

    # Path: model/attributes/app/app__vitals__stall__percentage.json
    APP_VITALS_STALL_PERCENTAGE: Literal["app.vitals.stall.percentage"] = "app.vitals.stall.percentage"
    ...
    APP_VITALS_STALL_PERCENTAGE_KEYS: Tuple[str, ...] = ("app.vitals.stall.percentage", "stall_percentage",)

    # Path: model/attributes/app/app__vitals__start__cold__value.json
    APP_VITALS_START_COLD_VALUE: Literal["app.vitals.start.cold.value"] = "app.vitals.start.cold.value"
    ...
    APP_VITALS_START_COLD_VALUE_KEYS: Tuple[str, ...] = ("app.vitals.start.cold.value", "app_start_cold",)

    # Path: model/attributes/app/app__vitals__start__prewarmed.json
    APP_VITALS_START_PREWARMED: Literal["app.vitals.start.prewarmed"] = "app.vitals.start.prewarmed"
    ...
    APP_VITALS_START_REASON: Literal["app.vitals.start.reason"] = "app.vitals.start.reason"
    ...
    APP_VITALS_START_SCREEN: Literal["app.vitals.start.screen"] = "app.vitals.start.screen"
    ...
    APP_VITALS_START_TYPE_KEYS: Tuple[str, ...] = ("app.vitals.start.type", "app_start_type",)

    # Path: model/attributes/app/app__vitals__start__warm__value.json
    APP_VITALS_START_WARM_VALUE: Literal["app.vitals.start.warm.value"] = "app.vitals.start.warm.value"
    ...
    APP_VITALS_START_WARM_VALUE_KEYS: Tuple[str, ...] = ("app.vitals.start.warm.value", "app_start_warm",)
    ...
    APP_VITALS_TTFD_VALUE_KEYS: Tuple[str, ...] = ("app.vitals.ttfd.value", "time_to_full_display",)
    ...
    APP_VITALS_TTID_VALUE_KEYS: Tuple[str, ...] = ("app.vitals.ttid.value", "time_to_initial_display",)
    ...
    APP_START_COLD_KEYS: Tuple[str, ...] = ("app.vitals.start.cold.value", "app_start_cold",)
    ...
    APP_START_TYPE_KEYS: Tuple[str, ...] = ("app.vitals.start.type", "app_start_type",)
    ...
    APP_START_WARM_KEYS: Tuple[str, ...] = ("app.vitals.start.warm.value", "app_start_warm",)
    ...
    ART_MEMORY_FREE_UNTIL_GC: Literal["art.memory.free_until_gc"] = "art.memory.free_until_gc"
    ...
    ART_MEMORY_FREE_UNTIL_OOME: Literal["art.memory.free_until_oome"] = "art.memory.free_until_oome"
    ...
    AWS_CLOUDWATCH_LOGS_LOG_GROUP: Literal["aws.cloudwatch.logs.log_group"] = "aws.cloudwatch.logs.log_group"
    ...
    AWS_CLOUDWATCH_LOGS_LOG_GROUP_KEYS: Tuple[str, ...] = ("aws.cloudwatch.logs.log_group",)

    # Path: model/attributes/aws/aws__cloudwatch__logs__log_stream.json
    AWS_CLOUDWATCH_LOGS_LOG_STREAM: Literal["aws.cloudwatch.logs.log_stream"] = "aws.cloudwatch.logs.log_stream"
    ...
    AWS_CLOUDWATCH_LOGS_LOG_STREAM_KEYS: Tuple[str, ...] = ("aws.cloudwatch.logs.log_stream",)

    # Path: model/attributes/aws/aws__cloudwatch__logs__url.json
    AWS_CLOUDWATCH_LOGS_URL: Literal["aws.cloudwatch.logs.url"] = "aws.cloudwatch.logs.url"
    ...
    AWS_DYNAMODB_ATTRIBUTE_DEFINITIONS: Literal["aws.dynamodb.attribute_definitions"] = "aws.dynamodb.attribute_definitions"
    ...
    AWS_DYNAMODB_ATTRIBUTE_DEFINITIONS_KEYS: Tuple[str, ...] = ("aws.dynamodb.attribute_definitions",)

    # Path: model/attributes/aws/aws__dynamodb__consistent_read.json
    AWS_DYNAMODB_CONSISTENT_READ: Literal["aws.dynamodb.consistent_read"] = "aws.dynamodb.consistent_read"
    ...
    AWS_DYNAMODB_CONSISTENT_READ_KEYS: Tuple[str, ...] = ("aws.dynamodb.consistent_read",)

    # Path: model/attributes/aws/aws__dynamodb__consumed_capacity.json
    AWS_DYNAMODB_CONSUMED_CAPACITY: Literal["aws.dynamodb.consumed_capacity"] = "aws.dynamodb.consumed_capacity"
    ...
    AWS_DYNAMODB_CONSUMED_CAPACITY_KEYS: Tuple[str, ...] = ("aws.dynamodb.consumed_capacity",)
    ...
    AWS_DYNAMODB_EXCLUSIVE_START_TABLE: Literal["aws.dynamodb.exclusive_start_table"] = "aws.dynamodb.exclusive_start_table"
    ...
    AWS_DYNAMODB_EXCLUSIVE_START_TABLE_KEYS: Tuple[str, ...] = ("aws.dynamodb.exclusive_start_table",)

    # Path: model/attributes/aws/aws__dynamodb__global_secondary_index_updates.json
    AWS_DYNAMODB_GLOBAL_SECONDARY_INDEX_UPDATES: Literal["aws.dynamodb.global_secondary_index_updates"] = "aws.dynamodb.global_secondary_index_updates"
    ...
    AWS_DYNAMODB_GLOBAL_SECONDARY_INDEX_UPDATES_KEYS: Tuple[str, ...] = ("aws.dynamodb.global_secondary_index_updates",)

    # Path: model/attributes/aws/aws__dynamodb__global_secondary_indexes.json
    AWS_DYNAMODB_GLOBAL_SECONDARY_INDEXES: Literal["aws.dynamodb.global_secondary_indexes"] = "aws.dynamodb.global_secondary_indexes"
    ...
    AWS_DYNAMODB_GLOBAL_SECONDARY_INDEXES_KEYS: Tuple[str, ...] = ("aws.dynamodb.global_secondary_indexes",)

    # Path: model/attributes/aws/aws__dynamodb__index_name.json
    AWS_DYNAMODB_INDEX_NAME: Literal["aws.dynamodb.index_name"] = "aws.dynamodb.index_name"
    ...
    AWS_DYNAMODB_ITEM_COLLECTION_METRICS: Literal["aws.dynamodb.item_collection_metrics"] = "aws.dynamodb.item_collection_metrics"
    ...
    AWS_DYNAMODB_ITEM_COLLECTION_METRICS_KEYS: Tuple[str, ...] = ("aws.dynamodb.item_collection_metrics",)
    ...
    AWS_DYNAMODB_LOCAL_SECONDARY_INDEXES: Literal["aws.dynamodb.local_secondary_indexes"] = "aws.dynamodb.local_secondary_indexes"
    ...
    AWS_DYNAMODB_LOCAL_SECONDARY_INDEXES_KEYS: Tuple[str, ...] = ("aws.dynamodb.local_secondary_indexes",)

    # Path: model/attributes/aws/aws__dynamodb__projection.json
    AWS_DYNAMODB_PROJECTION: Literal["aws.dynamodb.projection"] = "aws.dynamodb.projection"
    ...
    AWS_DYNAMODB_PROVISIONED_READ_CAPACITY: Literal["aws.dynamodb.provisioned_read_capacity"] = "aws.dynamodb.provisioned_read_capacity"
    ...
    AWS_DYNAMODB_PROVISIONED_READ_CAPACITY_KEYS: Tuple[str, ...] = ("aws.dynamodb.provisioned_read_capacity",)

    # Path: model/attributes/aws/aws__dynamodb__provisioned_write_capacity.json
    AWS_DYNAMODB_PROVISIONED_WRITE_CAPACITY: Literal["aws.dynamodb.provisioned_write_capacity"] = "aws.dynamodb.provisioned_write_capacity"
    ...
    AWS_DYNAMODB_PROVISIONED_WRITE_CAPACITY_KEYS: Tuple[str, ...] = ("aws.dynamodb.provisioned_write_capacity",)

    # Path: model/attributes/aws/aws__dynamodb__scan_forward.json
    AWS_DYNAMODB_SCAN_FORWARD: Literal["aws.dynamodb.scan_forward"] = "aws.dynamodb.scan_forward"
    ...
    AWS_DYNAMODB_SCANNED_COUNT: Literal["aws.dynamodb.scanned_count"] = "aws.dynamodb.scanned_count"
    ...
    AWS_DYNAMODB_TABLE_COUNT: Literal["aws.dynamodb.table_count"] = "aws.dynamodb.table_count"
    ...
    AWS_DYNAMODB_TABLE_NAMES: Literal["aws.dynamodb.table_names"] = "aws.dynamodb.table_names"
    ...
    AWS_DYNAMODB_TOTAL_SEGMENTS: Literal["aws.dynamodb.total_segments"] = "aws.dynamodb.total_segments"
    ...
    AWS_EXTENDED_REQUEST_ID: Literal["aws.extended_request_id"] = "aws.extended_request_id"
    ...
    AWS_EXTENDED_REQUEST_ID_KEYS: Tuple[str, ...] = ("aws.extended_request_id", "aws.request.extended_id",)

    # Path: model/attributes/aws/aws__kinesis__stream__name.json
    _AWS_KINESIS_STREAM_NAME: Literal["aws.kinesis.stream.name"] = "aws.kinesis.stream.name"
    ...
    _AWS_KINESIS_STREAM_NAME_KEYS: Tuple[str, ...] = ("aws.kinesis.stream_name", "aws.kinesis.stream.name",)

    # Path: model/attributes/aws/aws__kinesis__stream_name.json
    AWS_KINESIS_STREAM_NAME: Literal["aws.kinesis.stream_name"] = "aws.kinesis.stream_name"
    """The name of the AWS Kinesis stream the request refers to.
    ...
    AWS_KINESIS_STREAM_NAME_KEYS: Tuple[str, ...] = ("aws.kinesis.stream_name", "aws.kinesis.stream.name",)

    # Path: model/attributes/aws/aws__lambda__aws_request_id.json
    AWS_LAMBDA_AWS_REQUEST_ID: Literal["aws.lambda.aws_request_id"] = "aws.lambda.aws_request_id"
    ...
    AWS_LAMBDA_AWS_REQUEST_ID_KEYS: Tuple[str, ...] = ("faas.invocation_id", "aws.lambda.aws_request_id", "faas.execution",)

    # Path: model/attributes/aws/aws__lambda__execution_duration_in_millis.json
    AWS_LAMBDA_EXECUTION_DURATION_IN_MILLIS: Literal["aws.lambda.execution_duration_in_millis"] = "aws.lambda.execution_duration_in_millis"
    ...
    AWS_LAMBDA_EXECUTION_DURATION_IN_MILLIS_KEYS: Tuple[str, ...] = ("aws.lambda.execution_duration_in_millis",)

    # Path: model/attributes/aws/aws__lambda__function_name.json
    AWS_LAMBDA_FUNCTION_NAME: Literal["aws.lambda.function_name"] = "aws.lambda.function_name"
    ...
    AWS_LAMBDA_FUNCTION_NAME_KEYS: Tuple[str, ...] = ("faas.name", "aws.lambda.function_name",)

    # Path: model/attributes/aws/aws__lambda__function_version.json
    AWS_LAMBDA_FUNCTION_VERSION: Literal["aws.lambda.function_version"] = "aws.lambda.function_version"
    ...
    AWS_LAMBDA_FUNCTION_VERSION_KEYS: Tuple[str, ...] = ("faas.version", "aws.lambda.function_version",)
    ...
    AWS_LAMBDA_INVOKED_ARN_KEYS: Tuple[str, ...] = ("aws.lambda.invoked_arn", "aws.lambda.invoked_function_arn",)

    # Path: model/attributes/aws/aws__lambda__invoked_function_arn.json
    AWS_LAMBDA_INVOKED_FUNCTION_ARN: Literal["aws.lambda.invoked_function_arn"] = "aws.lambda.invoked_function_arn"
    """The full ARN of the Lambda function that was invoked
    ...
    AWS_LAMBDA_INVOKED_FUNCTION_ARN_KEYS: Tuple[str, ...] = ("aws.lambda.invoked_arn", "aws.lambda.invoked_function_arn",)

    # Path: model/attributes/aws/aws__lambda__remaining_time_in_millis.json
    AWS_LAMBDA_REMAINING_TIME_IN_MILLIS: Literal["aws.lambda.remaining_time_in_millis"] = "aws.lambda.remaining_time_in_millis"
    ...
    AWS_LAMBDA_REMAINING_TIME_IN_MILLIS_KEYS: Tuple[str, ...] = ("aws.lambda.remaining_time_in_millis",)
    ...
    AWS_OPERATION_NAME_KEYS: Tuple[str, ...] = ("rpc.method", "aws.operation_name",)

    # Path: model/attributes/aws/aws__request__extended_id.json
    AWS_REQUEST_EXTENDED_ID: Literal["aws.request.extended_id"] = "aws.request.extended_id"
    """The AWS extended request ID as returned in the response headers.
    ...
    AWS_REQUEST_EXTENDED_ID_KEYS: Tuple[str, ...] = ("aws.extended_request_id", "aws.request.extended_id",)
    ...
    _AWS_REQUEST_ID_KEYS: Tuple[str, ...] = ("aws.request_id", "aws.request.id",)
    ...
    AWS_REQUEST_URL_KEYS: Tuple[str, ...] = ("url.full", "aws.request.url", "http.url", "url",)
    ...
    AWS_REQUEST_ID_KEYS: Tuple[str, ...] = ("aws.request_id", "aws.request.id",)
    ...
    AWS_SECRETSMANAGER_SECRET_ARN: Literal["aws.secretsmanager.secret.arn"] = "aws.secretsmanager.secret.arn"
    ...
    AWS_SECRETSMANAGER_SECRET_ARN_KEYS: Tuple[str, ...] = ("aws.secretsmanager.secret.arn",)
    ...
    AWS_STEP_FUNCTIONS_ACTIVITY_ARN: Literal["aws.step_functions.activity.arn"] = "aws.step_functions.activity.arn"
    ...
    AWS_STEP_FUNCTIONS_ACTIVITY_ARN_KEYS: Tuple[str, ...] = ("aws.step_functions.activity.arn",)

    # Path: model/attributes/aws/aws__step_functions__state_machine__arn.json
    AWS_STEP_FUNCTIONS_STATE_MACHINE_ARN: Literal["aws.step_functions.state_machine.arn"] = "aws.step_functions.state_machine.arn"
    ...
    AWS_STEP_FUNCTIONS_STATE_MACHINE_ARN_KEYS: Tuple[str, ...] = ("aws.step_functions.state_machine.arn",)
    ...
    AWS_REGION_KEYS: Tuple[str, ...] = ("cloud.region", "aws_region", "gcp_region",)
    ...
    BROWSER_BFCACHE_NOT_RESTORED_REASON_COUNT: Literal["browser.bfcache.not_restored_reason_count"] = "browser.bfcache.not_restored_reason_count"
    ...
    BROWSER_BFCACHE_NOT_RESTORED_REASON_COUNT_KEYS: Tuple[str, ...] = ("browser.bfcache.not_restored_reason_count",)

    # Path: model/attributes/browser/browser__bfcache__outcome.json
    BROWSER_BFCACHE_OUTCOME: Literal["browser.bfcache.outcome"] = "browser.bfcache.outcome"
    ...
    BROWSER_NAME_KEYS: Tuple[str, ...] = ("browser.name", "sentry.browser.name",)

    # Path: model/attributes/browser/browser__performance__navigation__activation_start.json
    BROWSER_PERFORMANCE_NAVIGATION_ACTIVATION_START: Literal["browser.performance.navigation.activation_start"] = "browser.performance.navigation.activation_start"
    ...
    BROWSER_PERFORMANCE_NAVIGATION_ACTIVATION_START_KEYS: Tuple[str, ...] = ("browser.performance.navigation.activation_start", "performance.activationStart",)

    # Path: model/attributes/browser/browser__performance__time_origin.json
    BROWSER_PERFORMANCE_TIME_ORIGIN: Literal["browser.performance.time_origin"] = "browser.performance.time_origin"
    ...
    BROWSER_PERFORMANCE_TIME_ORIGIN_KEYS: Tuple[str, ...] = ("browser.performance.time_origin", "performance.timeOrigin",)
    ...
    BROWSER_SCRIPT_SOURCE_CHAR_POSITION_KEYS: Tuple[str, ...] = ("browser.script.source_char_position",)
    ...
    BROWSER_VERSION_KEYS: Tuple[str, ...] = ("browser.version", "sentry.browser.version",)

    # Path: model/attributes/browser/browser__web_vital__cls__report_event.json
    BROWSER_WEB_VITAL_CLS_REPORT_EVENT: Literal["browser.web_vital.cls.report_event"] = "browser.web_vital.cls.report_event"
    ...
    BROWSER_WEB_VITAL_CLS_REPORT_EVENT_KEYS: Tuple[str, ...] = ("browser.web_vital.cls.report_event",)
    ...
    BROWSER_WEB_VITAL_CLS_SOURCE_KEY_KEYS: Tuple[str, ...] = ("browser.web_vital.cls.source.<key>", "cls.source.<key>",)
    ...
    BROWSER_WEB_VITAL_CLS_VALUE_KEYS: Tuple[str, ...] = ("browser.web_vital.cls.value", "cls",)
    ...
    BROWSER_WEB_VITAL_FCP_VALUE_KEYS: Tuple[str, ...] = ("browser.web_vital.fcp.value", "fcp",)
    ...
    BROWSER_WEB_VITAL_FP_VALUE_KEYS: Tuple[str, ...] = ("browser.web_vital.fp.value", "fp",)
    ...
    BROWSER_WEB_VITAL_INP_VALUE_KEYS: Tuple[str, ...] = ("browser.web_vital.inp.value", "inp",)
    ...
    BROWSER_WEB_VITAL_LCP_ELEMENT_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.element", "lcp.element",)
    ...
    BROWSER_WEB_VITAL_LCP_ID_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.id", "lcp.id",)
    ...
    BROWSER_WEB_VITAL_LCP_LOAD_TIME_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.load_time", "lcp.loadTime",)
    ...
    BROWSER_WEB_VITAL_LCP_RENDER_TIME_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.render_time", "lcp.renderTime",)

    # Path: model/attributes/browser/browser__web_vital__lcp__report_event.json
    BROWSER_WEB_VITAL_LCP_REPORT_EVENT: Literal["browser.web_vital.lcp.report_event"] = "browser.web_vital.lcp.report_event"
    ...
    BROWSER_WEB_VITAL_LCP_REPORT_EVENT_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.report_event",)
    ...
    BROWSER_WEB_VITAL_LCP_SIZE_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.size", "lcp.size",)
    ...
    BROWSER_WEB_VITAL_LCP_URL_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.url", "lcp.url",)
    ...
    BROWSER_WEB_VITAL_LCP_VALUE_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.value", "lcp",)
    ...
    BROWSER_WEB_VITAL_TTFB_REQUEST_TIME_KEYS: Tuple[str, ...] = ("browser.web_vital.ttfb.request_time", "ttfb.requestTime",)
    ...
    BROWSER_WEB_VITAL_TTFB_VALUE_KEYS: Tuple[str, ...] = ("browser.web_vital.ttfb.value", "ttfb",)
    ...
    CLIENT_ADDRESS_KEYS: Tuple[str, ...] = ("client.address", "http.client_ip",)
    ...
    CLOUD_AVAILABILITY_ZONE: Literal["cloud.availability_zone"] = "cloud.availability_zone"
    ...
    CLOUD_REGION_KEYS: Tuple[str, ...] = ("cloud.region", "aws_region", "gcp_region",)
    ...
    CLOUD_RESOURCE_ID_KEYS: Tuple[str, ...] = ("cloud.resource_id", "faas.id",)
    ...
    CLOUDFLARE_D1_QUERY_TYPE: Literal["cloudflare.d1.query_type"] = "cloudflare.d1.query_type"
    ...
    CLOUDFLARE_D1_QUERY_TYPE_KEYS: Tuple[str, ...] = ("db.operation.name", "cloudflare.d1.query_type", "db.operation", "redis.command",)
    ...
    CLOUDFLARE_DURABLE_OBJECT_QUERY_BINDINGS: Literal["cloudflare.durable_object.query.bindings"] = "cloudflare.durable_object.query.bindings"
    ...
    CLOUDFLARE_DURABLE_OBJECT_QUERY_BINDINGS_KEYS: Tuple[str, ...] = ("cloudflare.durable_object.query.bindings",)

    # Path: model/attributes/cloudflare/cloudflare__durable_object__response__rows_read.json
    CLOUDFLARE_DURABLE_OBJECT_RESPONSE_ROWS_READ: Literal["cloudflare.durable_object.response.rows_read"] = "cloudflare.durable_object.response.rows_read"
    ...
    CLOUDFLARE_DURABLE_OBJECT_RESPONSE_ROWS_READ_KEYS: Tuple[str, ...] = ("cloudflare.durable_object.response.rows_read",)

    # Path: model/attributes/cloudflare/cloudflare__durable_object__response__rows_written.json
    CLOUDFLARE_DURABLE_OBJECT_RESPONSE_ROWS_WRITTEN: Literal["cloudflare.durable_object.response.rows_written"] = "cloudflare.durable_object.response.rows_written"
    ...
    CLOUDFLARE_DURABLE_OBJECT_RESPONSE_ROWS_WRITTEN_KEYS: Tuple[str, ...] = ("cloudflare.durable_object.response.rows_written",)
    ...
    CLOUDFLARE_R2_OPERATION: Literal["cloudflare.r2.operation"] = "cloudflare.r2.operation"
    ...
    CLOUDFLARE_R2_REQUEST_DELIMITER: Literal["cloudflare.r2.request.delimiter"] = "cloudflare.r2.request.delimiter"
    ...
    CLOUDFLARE_R2_REQUEST_DELIMITER_KEYS: Tuple[str, ...] = ("cloudflare.r2.request.delimiter",)

    # Path: model/attributes/cloudflare/cloudflare__r2__request__key.json
    CLOUDFLARE_R2_REQUEST_KEY: Literal["cloudflare.r2.request.key"] = "cloudflare.r2.request.key"
    ...
    CLOUDFLARE_R2_REQUEST_PART_NUMBER: Literal["cloudflare.r2.request.part_number"] = "cloudflare.r2.request.part_number"
    ...
    CLOUDFLARE_R2_REQUEST_PART_NUMBER_KEYS: Tuple[str, ...] = ("cloudflare.r2.request.part_number",)

    # Path: model/attributes/cloudflare/cloudflare__r2__request__prefix.json
    CLOUDFLARE_R2_REQUEST_PREFIX: Literal["cloudflare.r2.request.prefix"] = "cloudflare.r2.request.prefix"
    ...
    CLOUDFLARE_R2_REQUEST_PREFIX_KEYS: Tuple[str, ...] = ("cloudflare.r2.request.prefix",)

    # Path: model/attributes/cloudflare/cloudflare__workflow__attempt.json
    CLOUDFLARE_WORKFLOW_ATTEMPT: Literal["cloudflare.workflow.attempt"] = "cloudflare.workflow.attempt"
    ...
    CLOUDFLARE_WORKFLOW_RETRIES_BACKOFF: Literal["cloudflare.workflow.retries.backoff"] = "cloudflare.workflow.retries.backoff"
    ...
    CLOUDFLARE_WORKFLOW_RETRIES_BACKOFF_KEYS: Tuple[str, ...] = ("cloudflare.workflow.retries.backoff",)

    # Path: model/attributes/cloudflare/cloudflare__workflow__retries__delay.json
    CLOUDFLARE_WORKFLOW_RETRIES_DELAY: Literal["cloudflare.workflow.retries.delay"] = "cloudflare.workflow.retries.delay"
    ...
    CLOUDFLARE_WORKFLOW_RETRIES_DELAY_KEYS: Tuple[str, ...] = ("cloudflare.workflow.retries.delay",)

    # Path: model/attributes/cloudflare/cloudflare__workflow__retries__limit.json
    CLOUDFLARE_WORKFLOW_RETRIES_LIMIT: Literal["cloudflare.workflow.retries.limit"] = "cloudflare.workflow.retries.limit"
    ...
    CLOUDFLARE_WORKFLOW_RETRIES_LIMIT_KEYS: Tuple[str, ...] = ("cloudflare.workflow.retries.limit",)

    # Path: model/attributes/cloudflare/cloudflare__workflow__timeout.json
    CLOUDFLARE_WORKFLOW_TIMEOUT: Literal["cloudflare.workflow.timeout"] = "cloudflare.workflow.timeout"
    ...
    CLS_SOURCE_KEY_KEYS: Tuple[str, ...] = ("browser.web_vital.cls.source.<key>", "cls.source.<key>",)
    ...
    CLS_KEYS: Tuple[str, ...] = ("browser.web_vital.cls.value", "cls",)
    ...
    CODE_FILE_PATH_KEYS: Tuple[str, ...] = ("code.file.path", "code.filepath",)
    ...
    CODE_FILEPATH_KEYS: Tuple[str, ...] = ("code.file.path", "code.filepath",)
    ...
    CODE_FUNCTION_NAME_KEYS: Tuple[str, ...] = ("code.function.name", "django.function_name",)
    ...
    CODE_LINE_NUMBER_KEYS: Tuple[str, ...] = ("code.line.number", "code.lineno",)
    ...
    CODE_LINENO_KEYS: Tuple[str, ...] = ("code.line.number", "code.lineno",)
    ...
    CODE_KEYS: Tuple[str, ...] = ("rpc.response.status_code", "code", "rpc.grpc.status_code",)
    ...
    CONNECTION_RTT_KEYS: Tuple[str, ...] = ("network.connection.rtt", "connection.rtt",)
    ...
    CONNECTIONTYPE_KEYS: Tuple[str, ...] = ("network.connection.type", "connectionType", "device.connection_type",)
    ...
    DB_COLLECTION_NAME_KEYS: Tuple[str, ...] = ("db.collection.name", "db.mongodb.collection",)
    ...
    DB_MONGODB_COLLECTION_KEYS: Tuple[str, ...] = ("db.collection.name", "db.mongodb.collection",)
    ...
    DB_NAME_KEYS: Tuple[str, ...] = ("db.namespace", "db.name",)
    ...
    DB_NAMESPACE_KEYS: Tuple[str, ...] = ("db.namespace", "db.name",)
    ...
    DB_OPERATION_KEYS: Tuple[str, ...] = ("db.operation.name", "cloudflare.d1.query_type", "db.operation", "redis.command",)
    ...
    DB_OPERATION_NAME_KEYS: Tuple[str, ...] = ("db.operation.name", "cloudflare.d1.query_type", "db.operation", "redis.command",)
    ...
    DB_PARAMS_KEYS: Tuple[str, ...] = ("db.query.parameter.<key>", "db.params", "db.sql.bindings",)
    ...
    DB_QUERY_PARAMETER_KEY_KEYS: Tuple[str, ...] = ("db.query.parameter.<key>", "db.params", "db.sql.bindings",)
    ...
    DB_QUERY_TEXT_KEYS: Tuple[str, ...] = ("db.query.text", "db.statement", "query",)
    ...
    DB_REDIS_KEY_KEYS: Tuple[str, ...] = ("db.redis.key", "redis.key",)
    ...
    DB_SQL_BINDINGS_KEYS: Tuple[str, ...] = ("db.query.parameter.<key>", "db.params", "db.sql.bindings",)
    ...
    DB_STATEMENT_KEYS: Tuple[str, ...] = ("db.query.text", "db.statement", "query",)
    ...
    DB_SYSTEM_KEYS: Tuple[str, ...] = ("db.system.name", "db.system",)
    ...
    DB_SYSTEM_NAME_KEYS: Tuple[str, ...] = ("db.system.name", "db.system",)
    ...
    DEVICE_BATTERY_TEMPERATURE: Literal["device.battery_temperature"] = "device.battery_temperature"
    ...
    DEVICE_CONNECTION_TYPE_KEYS: Tuple[str, ...] = ("network.connection.type", "connectionType", "device.connection_type",)
    ...
    DEVICE_EXTERNAL_FREE_STORAGE: Literal["device.external_free_storage"] = "device.external_free_storage"
    ...
    DEVICE_EXTERNAL_FREE_STORAGE_KEYS: Tuple[str, ...] = ("device.external_free_storage",)

    # Path: model/attributes/device/device__external_storage_size.json
    DEVICE_EXTERNAL_STORAGE_SIZE: Literal["device.external_storage_size"] = "device.external_storage_size"
    ...
    DEVICE_EXTERNAL_STORAGE_SIZE_KEYS: Tuple[str, ...] = ("device.external_storage_size",)
    ...
    DEVICE_MEMORY_ESTIMATED_CAPACITY_KEYS: Tuple[str, ...] = ("device.memory.estimated_capacity", "deviceMemory",)
    ...
    DEVICE_PROCESSOR_COUNT_KEYS: Tuple[str, ...] = ("device.processor_count", "hardwareConcurrency",)

    # Path: model/attributes/device/device__processor_frequency.json
    DEVICE_PROCESSOR_FREQUENCY: Literal["device.processor_frequency"] = "device.processor_frequency"
    ...
    DEVICE_SCREEN_HEIGHT_PIXELS: Literal["device.screen_height_pixels"] = "device.screen_height_pixels"
    ...
    DEVICE_SCREEN_WIDTH_PIXELS: Literal["device.screen_width_pixels"] = "device.screen_width_pixels"
    ...
    DEVICEMEMORY_KEYS: Tuple[str, ...] = ("device.memory.estimated_capacity", "deviceMemory",)
    ...
    DIST_KEYS: Tuple[str, ...] = ("sentry.dist", "dist",)
    ...
    DJANGO_FUNCTION_NAME_KEYS: Tuple[str, ...] = ("code.function.name", "django.function_name",)
    ...
    DJANGO_MIDDLEWARE_NAME_KEYS: Tuple[str, ...] = ("middleware.name", "django.middleware_name", "litestar.middleware_name", "starlette.middleware_name", "starlite.middleware_name",)
    ...
    EFFECTIVECONNECTIONTYPE_KEYS: Tuple[str, ...] = ("network.connection.effective_type", "effectiveConnectionType",)
    ...
    ENVIRONMENT_KEYS: Tuple[str, ...] = ("sentry.environment", "environment", "resource.deployment.environment", "resource.deployment.environment.name",)
    ...
    ERROR_TYPE_KEYS: Tuple[str, ...] = ("error.type", "fs_error", "mcp.tool.result.is_error",)
    ...
    FAAS_EXECUTION_KEYS: Tuple[str, ...] = ("faas.invocation_id", "aws.lambda.aws_request_id", "faas.execution",)
    ...
    FAAS_ID_KEYS: Tuple[str, ...] = ("cloud.resource_id", "faas.id",)
    ...
    FAAS_INVOCATION_ID_KEYS: Tuple[str, ...] = ("faas.invocation_id", "aws.lambda.aws_request_id", "faas.execution",)
    ...
    FAAS_NAME_KEYS: Tuple[str, ...] = ("faas.name", "aws.lambda.function_name",)
    ...
    FAAS_VERSION_KEYS: Tuple[str, ...] = ("faas.version", "aws.lambda.function_version",)
    ...
    FCP_KEYS: Tuple[str, ...] = ("browser.web_vital.fcp.value", "fcp",)
    ...
    FP_KEYS: Tuple[str, ...] = ("browser.web_vital.fp.value", "fp",)
    ...
    FRAMES_DELAY_KEYS: Tuple[str, ...] = ("app.vitals.frames.delay.value", "frames.delay",)
    ...
    FRAMES_FROZEN_KEYS: Tuple[str, ...] = ("app.vitals.frames.frozen.count", "frames.frozen", "sentry.frames.frozen",)
    ...
    FRAMES_SLOW_KEYS: Tuple[str, ...] = ("app.vitals.frames.slow.count", "frames.slow", "sentry.frames.slow",)
    ...
    FRAMES_TOTAL_KEYS: Tuple[str, ...] = ("app.vitals.frames.total.count", "frames.total", "sentry.frames.total",)
    ...
    FRAMES_FROZEN_RATE_KEYS: Tuple[str, ...] = ("app.vitals.frames.frozen.rate", "frames_frozen_rate",)
    ...
    FRAMES_SLOW_RATE_KEYS: Tuple[str, ...] = ("app.vitals.frames.slow.rate", "frames_slow_rate",)
    ...
    FS_ERROR_KEYS: Tuple[str, ...] = ("error.type", "fs_error", "mcp.tool.result.is_error",)

    # Path: model/attributes/gcp/gcp__function__context__event_id.json
    GCP_FUNCTION_CONTEXT_EVENT_ID: Literal["gcp.function.context.event_id"] = "gcp.function.context.event_id"
    ...
    GCP_FUNCTION_CONTEXT_EVENT_ID_KEYS: Tuple[str, ...] = ("gcp.function.context.event_id",)

    # Path: model/attributes/gcp/gcp__function__context__event_type.json
    GCP_FUNCTION_CONTEXT_EVENT_TYPE: Literal["gcp.function.context.event_type"] = "gcp.function.context.event_type"
    ...
    GCP_FUNCTION_CONTEXT_EVENT_TYPE_KEYS: Tuple[str, ...] = ("gcp.function.context.event_type",)

    # Path: model/attributes/gcp/gcp__function__context__id.json
    GCP_FUNCTION_CONTEXT_ID: Literal["gcp.function.context.id"] = "gcp.function.context.id"
    ...
    GCP_FUNCTION_CONTEXT_RESOURCE: Literal["gcp.function.context.resource"] = "gcp.function.context.resource"
    ...
    GCP_FUNCTION_CONTEXT_RESOURCE_KEYS: Tuple[str, ...] = ("gcp.function.context.resource",)

    # Path: model/attributes/gcp/gcp__function__context__source.json
    GCP_FUNCTION_CONTEXT_SOURCE: Literal["gcp.function.context.source"] = "gcp.function.context.source"
    ...
    GCP_FUNCTION_CONTEXT_SPECVERSION: Literal["gcp.function.context.specversion"] = "gcp.function.context.specversion"
    ...
    GCP_FUNCTION_CONTEXT_SPECVERSION_KEYS: Tuple[str, ...] = ("gcp.function.context.specversion",)

    # Path: model/attributes/gcp/gcp__function__context__time.json
    GCP_FUNCTION_CONTEXT_TIME: Literal["gcp.function.context.time"] = "gcp.function.context.time"
    ...
    GCP_FUNCTION_CONTEXT_TIMESTAMP: Literal["gcp.function.context.timestamp"] = "gcp.function.context.timestamp"
    ...
    GCP_FUNCTION_CONTEXT_TIMESTAMP_KEYS: Tuple[str, ...] = ("gcp.function.context.timestamp",)

    # Path: model/attributes/gcp/gcp__function__context__type.json
    GCP_FUNCTION_CONTEXT_TYPE: Literal["gcp.function.context.type"] = "gcp.function.context.type"
    ...
    GCP_REGION_KEYS: Tuple[str, ...] = ("cloud.region", "aws_region", "gcp_region",)
    ...
    GEN_AI_CONTEXT_UTILIZATION: Literal["gen_ai.context.utilization"] = "gen_ai.context.utilization"
    ...
    GEN_AI_CONTEXT_WINDOW_SIZE: Literal["gen_ai.context.window_size"] = "gen_ai.context.window_size"
    ...
    GEN_AI_COST_CACHE_CREATION_INPUT_TOKENS: Literal["gen_ai.cost.cache_creation.input_tokens"] = "gen_ai.cost.cache_creation.input_tokens"
    ...
    GEN_AI_COST_CACHE_CREATION_INPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.cost.cache_creation.input_tokens",)

    # Path: model/attributes/gen_ai/gen_ai__cost__cache_read__input_tokens.json
    GEN_AI_COST_CACHE_READ_INPUT_TOKENS: Literal["gen_ai.cost.cache_read.input_tokens"] = "gen_ai.cost.cache_read.input_tokens"
    ...
    GEN_AI_COST_CACHE_READ_INPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.cost.cache_read.input_tokens",)
    ...
    GEN_AI_COST_REASONING_OUTPUT_TOKENS: Literal["gen_ai.cost.reasoning.output_tokens"] = "gen_ai.cost.reasoning.output_tokens"
    ...
    GEN_AI_COST_REASONING_OUTPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.cost.reasoning.output_tokens",)
    ...
    GEN_AI_COST_TOTAL_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.cost.total_tokens", "ai.total_cost",)
    ...
    GEN_AI_INPUT_MESSAGES_KEYS: Tuple[str, ...] = ("gen_ai.input.messages", "ai.input_messages", "ai.prompt.messages", "ai.texts", "gen_ai.prompt", "gen_ai.request.messages",)
    ...
    GEN_AI_OUTPUT_MESSAGES_KEYS: Tuple[str, ...] = ("gen_ai.output.messages", "ai.response.text", "ai.response.toolCalls", "ai.responses", "ai.tool_calls", "gen_ai.response.text", "gen_ai.response.tool_calls",)
    ...
    GEN_AI_PIPELINE_NAME_KEYS: Tuple[str, ...] = ("gen_ai.pipeline.name", "ai.pipeline.name",)
    ...
    GEN_AI_PROMPT_KEYS: Tuple[str, ...] = ("gen_ai.input.messages", "ai.input_messages", "ai.prompt.messages", "ai.texts", "gen_ai.prompt", "gen_ai.request.messages",)
    ...
    GEN_AI_PROMPT_NAME_KEYS: Tuple[str, ...] = ("gen_ai.prompt.name", "mcp.prompt.name",)
    ...
    GEN_AI_PROVIDER_NAME_KEYS: Tuple[str, ...] = ("gen_ai.provider.name", "ai.model.provider", "gen_ai.system",)
    ...
    GEN_AI_REQUEST_AVAILABLE_TOOLS_KEYS: Tuple[str, ...] = ("gen_ai.tool.definitions", "ai.tools", "gen_ai.request.available_tools",)
    ...
    GEN_AI_REQUEST_FREQUENCY_PENALTY_KEYS: Tuple[str, ...] = ("gen_ai.request.frequency_penalty", "ai.frequency_penalty",)
    ...
    GEN_AI_REQUEST_MESSAGES_KEYS: Tuple[str, ...] = ("gen_ai.input.messages", "ai.input_messages", "ai.prompt.messages", "ai.texts", "gen_ai.prompt", "gen_ai.request.messages",)
    ...
    GEN_AI_REQUEST_MODEL_KEYS: Tuple[str, ...] = ("gen_ai.request.model", "ai.model_id",)
    ...
    GEN_AI_REQUEST_PRESENCE_PENALTY_KEYS: Tuple[str, ...] = ("gen_ai.request.presence_penalty", "ai.presence_penalty",)

    # Path: model/attributes/gen_ai/gen_ai__request__reasoning__level.json
    GEN_AI_REQUEST_REASONING_LEVEL: Literal["gen_ai.request.reasoning.level"] = "gen_ai.request.reasoning.level"
    ...
    GEN_AI_REQUEST_REASONING_LEVEL_KEYS: Tuple[str, ...] = ("gen_ai.request.reasoning.level",)
    ...
    GEN_AI_REQUEST_SEED_KEYS: Tuple[str, ...] = ("gen_ai.request.seed", "ai.seed",)

    # Path: model/attributes/gen_ai/gen_ai__request__stop_sequences.json
    GEN_AI_REQUEST_STOP_SEQUENCES: Literal["gen_ai.request.stop_sequences"] = "gen_ai.request.stop_sequences"
    ...
    GEN_AI_REQUEST_STOP_SEQUENCES_KEYS: Tuple[str, ...] = ("gen_ai.request.stop_sequences",)
    ...
    GEN_AI_REQUEST_TEMPERATURE_KEYS: Tuple[str, ...] = ("gen_ai.request.temperature", "ai.temperature",)
    ...
    GEN_AI_REQUEST_TOP_K_KEYS: Tuple[str, ...] = ("gen_ai.request.top_k", "ai.top_k",)
    ...
    GEN_AI_REQUEST_TOP_P_KEYS: Tuple[str, ...] = ("gen_ai.request.top_p", "ai.top_p",)

    # Path: model/attributes/gen_ai/gen_ai__response__finish_reason.json
    GEN_AI_RESPONSE_FINISH_REASON: Literal["gen_ai.response.finish_reason"] = "gen_ai.response.finish_reason"
    ...
    GEN_AI_RESPONSE_FINISH_REASON_KEYS: Tuple[str, ...] = ("gen_ai.response.finish_reasons", "ai.finish_reason", "gen_ai.response.finish_reason",)
    ...
    GEN_AI_RESPONSE_FINISH_REASONS_KEYS: Tuple[str, ...] = ("gen_ai.response.finish_reasons", "ai.finish_reason", "gen_ai.response.finish_reason",)
    ...
    GEN_AI_RESPONSE_ID_KEYS: Tuple[str, ...] = ("gen_ai.response.id", "ai.generation_id",)
    ...
    GEN_AI_RESPONSE_STREAMING_KEYS: Tuple[str, ...] = ("gen_ai.response.streaming", "ai.streaming",)
    ...
    GEN_AI_RESPONSE_TEXT_KEYS: Tuple[str, ...] = ("gen_ai.output.messages", "ai.response.text", "ai.response.toolCalls", "ai.responses", "ai.tool_calls", "gen_ai.response.text", "gen_ai.response.tool_calls",)

    # Path: model/attributes/gen_ai/gen_ai__response__time_to_first_chunk.json
    GEN_AI_RESPONSE_TIME_TO_FIRST_CHUNK: Literal["gen_ai.response.time_to_first_chunk"] = "gen_ai.response.time_to_first_chunk"
    ...
    GEN_AI_RESPONSE_TIME_TO_FIRST_CHUNK_KEYS: Tuple[str, ...] = ("gen_ai.response.time_to_first_chunk", "gen_ai.response.time_to_first_token",)
    ...
    GEN_AI_RESPONSE_TIME_TO_FIRST_TOKEN_KEYS: Tuple[str, ...] = ("gen_ai.response.time_to_first_chunk", "gen_ai.response.time_to_first_token",)
    ...
    GEN_AI_RESPONSE_TOKENS_PER_SECOND_KEYS: Tuple[str, ...] = ("gen_ai.response.tokens_per_second",)
    ...
    GEN_AI_RESPONSE_TOOL_CALLS_KEYS: Tuple[str, ...] = ("gen_ai.output.messages", "ai.response.text", "ai.response.toolCalls", "ai.responses", "ai.tool_calls", "gen_ai.response.text", "gen_ai.response.tool_calls",)
    ...
    GEN_AI_SYSTEM_KEYS: Tuple[str, ...] = ("gen_ai.provider.name", "ai.model.provider", "gen_ai.system",)
    ...
    GEN_AI_SYSTEM_MESSAGE_KEYS: Tuple[str, ...] = ("gen_ai.system_instructions", "ai.preamble", "gen_ai.system.message",)
    ...
    GEN_AI_SYSTEM_INSTRUCTIONS_KEYS: Tuple[str, ...] = ("gen_ai.system_instructions", "ai.preamble", "gen_ai.system.message",)
    ...
    GEN_AI_TOOL_CALL_ARGUMENTS_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.arguments", "ai.toolCall.args", "gen_ai.tool.input",)
    ...
    GEN_AI_TOOL_CALL_RESULT_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.result", "ai.toolCall.result", "gen_ai.tool.message", "gen_ai.tool.output", "mcp.tool.result.content",)
    ...
    GEN_AI_TOOL_DEFINITIONS_KEYS: Tuple[str, ...] = ("gen_ai.tool.definitions", "ai.tools", "gen_ai.request.available_tools",)
    ...
    GEN_AI_TOOL_INPUT_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.arguments", "ai.toolCall.args", "gen_ai.tool.input",)
    ...
    GEN_AI_TOOL_MESSAGE_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.result", "ai.toolCall.result", "gen_ai.tool.message", "gen_ai.tool.output", "mcp.tool.result.content",)
    ...
    GEN_AI_TOOL_NAME_KEYS: Tuple[str, ...] = ("gen_ai.tool.name", "ai.function_call", "mcp.tool.name",)
    ...
    GEN_AI_TOOL_OUTPUT_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.result", "ai.toolCall.result", "gen_ai.tool.message", "gen_ai.tool.output", "mcp.tool.result.content",)
    ...
    GEN_AI_USAGE_CACHE_CREATION_INPUT_TOKENS: Literal["gen_ai.usage.cache_creation.input_tokens"] = "gen_ai.usage.cache_creation.input_tokens"
    ...
    GEN_AI_USAGE_CACHE_CREATION_INPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.cache_creation.input_tokens", "gen_ai.usage.input_tokens.cache_write",)

    # Path: model/attributes/gen_ai/gen_ai__usage__cache_read__input_tokens.json
    GEN_AI_USAGE_CACHE_READ_INPUT_TOKENS: Literal["gen_ai.usage.cache_read.input_tokens"] = "gen_ai.usage.cache_read.input_tokens"
    ...
    GEN_AI_USAGE_CACHE_READ_INPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.cache_read.input_tokens", "gen_ai.usage.input_tokens.cached",)
    ...
    GEN_AI_USAGE_COMPLETION_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.output_tokens", "ai.completion_tokens.used", "gen_ai.usage.completion_tokens",)
    ...
    GEN_AI_USAGE_INPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.input_tokens", "ai.prompt_tokens.used", "gen_ai.usage.prompt_tokens",)
    ...
    GEN_AI_USAGE_INPUT_TOKENS_CACHE_WRITE_KEYS: Tuple[str, ...] = ("gen_ai.usage.cache_creation.input_tokens", "gen_ai.usage.input_tokens.cache_write",)
    ...
    GEN_AI_USAGE_INPUT_TOKENS_CACHED_KEYS: Tuple[str, ...] = ("gen_ai.usage.cache_read.input_tokens", "gen_ai.usage.input_tokens.cached",)
    ...
    GEN_AI_USAGE_OUTPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.output_tokens", "ai.completion_tokens.used", "gen_ai.usage.completion_tokens",)
    ...
    GEN_AI_USAGE_OUTPUT_TOKENS_REASONING_KEYS: Tuple[str, ...] = ("gen_ai.usage.reasoning.output_tokens", "gen_ai.usage.output_tokens.reasoning",)
    ...
    GEN_AI_USAGE_PROMPT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.input_tokens", "ai.prompt_tokens.used", "gen_ai.usage.prompt_tokens",)

    # Path: model/attributes/gen_ai/gen_ai__usage__reasoning__output_tokens.json
    GEN_AI_USAGE_REASONING_OUTPUT_TOKENS: Literal["gen_ai.usage.reasoning.output_tokens"] = "gen_ai.usage.reasoning.output_tokens"
    """The number of tokens used for reasoning to create the AI output.
    ...
    GEN_AI_USAGE_REASONING_OUTPUT_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.reasoning.output_tokens", "gen_ai.usage.output_tokens.reasoning",)
    ...
    GEN_AI_USAGE_TOTAL_TOKENS_KEYS: Tuple[str, ...] = ("gen_ai.usage.total_tokens", "ai.total_tokens.used",)
    ...
    GRPC_ERROR_BAD_REQUEST_FIELD_VIOLATIONS: Literal["grpc.error.bad_request.field_violations"] = "grpc.error.bad_request.field_violations"
    ...
    GRPC_ERROR_BAD_REQUEST_FIELD_VIOLATIONS_KEYS: Tuple[str, ...] = ("grpc.error.bad_request.field_violations",)

    # Path: model/attributes/grpc/grpc__error__debug_info__detail.json
    GRPC_ERROR_DEBUG_INFO_DETAIL: Literal["grpc.error.debug_info.detail"] = "grpc.error.debug_info.detail"
    ...
    GRPC_ERROR_DEBUG_INFO_DETAIL_KEYS: Tuple[str, ...] = ("grpc.error.debug_info.detail",)

    # Path: model/attributes/grpc/grpc__error__debug_info__stack_entries.json
    GRPC_ERROR_DEBUG_INFO_STACK_ENTRIES: Literal["grpc.error.debug_info.stack_entries"] = "grpc.error.debug_info.stack_entries"
    ...
    GRPC_ERROR_DEBUG_INFO_STACK_ENTRIES_KEYS: Tuple[str, ...] = ("grpc.error.debug_info.stack_entries",)

    # Path: model/attributes/grpc/grpc__error__error_info__domain.json
    GRPC_ERROR_ERROR_INFO_DOMAIN: Literal["grpc.error.error_info.domain"] = "grpc.error.error_info.domain"
    ...
    GRPC_ERROR_ERROR_INFO_DOMAIN_KEYS: Tuple[str, ...] = ("grpc.error.error_info.domain",)

    # Path: model/attributes/grpc/grpc__error__error_info__metadata__[key].json
    GRPC_ERROR_ERROR_INFO_METADATA_KEY: Literal["grpc.error.error_info.metadata.<key>"] = "grpc.error.error_info.metadata.<key>"
    ...
    GRPC_ERROR_ERROR_INFO_METADATA_KEY_KEYS: Tuple[str, ...] = ("grpc.error.error_info.metadata.<key>",)

    # Path: model/attributes/grpc/grpc__error__error_info__reason.json
    GRPC_ERROR_ERROR_INFO_REASON: Literal["grpc.error.error_info.reason"] = "grpc.error.error_info.reason"
    ...
    GRPC_ERROR_ERROR_INFO_REASON_KEYS: Tuple[str, ...] = ("grpc.error.error_info.reason",)

    # Path: model/attributes/grpc/grpc__error__precondition_failure__violations.json
    GRPC_ERROR_PRECONDITION_FAILURE_VIOLATIONS: Literal["grpc.error.precondition_failure.violations"] = "grpc.error.precondition_failure.violations"
    ...
    GRPC_ERROR_PRECONDITION_FAILURE_VIOLATIONS_KEYS: Tuple[str, ...] = ("grpc.error.precondition_failure.violations",)

    # Path: model/attributes/grpc/grpc__error__quota_failure__violations.json
    GRPC_ERROR_QUOTA_FAILURE_VIOLATIONS: Literal["grpc.error.quota_failure.violations"] = "grpc.error.quota_failure.violations"
    ...
    GRPC_ERROR_QUOTA_FAILURE_VIOLATIONS_KEYS: Tuple[str, ...] = ("grpc.error.quota_failure.violations",)

    # Path: model/attributes/grpc/grpc__error__resource_info__description.json
    GRPC_ERROR_RESOURCE_INFO_DESCRIPTION: Literal["grpc.error.resource_info.description"] = "grpc.error.resource_info.description"
    ...
    GRPC_ERROR_RESOURCE_INFO_DESCRIPTION_KEYS: Tuple[str, ...] = ("grpc.error.resource_info.description",)

    # Path: model/attributes/grpc/grpc__error__resource_info__owner.json
    GRPC_ERROR_RESOURCE_INFO_OWNER: Literal["grpc.error.resource_info.owner"] = "grpc.error.resource_info.owner"
    ...
    GRPC_ERROR_RESOURCE_INFO_OWNER_KEYS: Tuple[str, ...] = ("grpc.error.resource_info.owner",)

    # Path: model/attributes/grpc/grpc__error__resource_info__resource_name.json
    GRPC_ERROR_RESOURCE_INFO_RESOURCE_NAME: Literal["grpc.error.resource_info.resource_name"] = "grpc.error.resource_info.resource_name"
    ...
    GRPC_ERROR_RESOURCE_INFO_RESOURCE_NAME_KEYS: Tuple[str, ...] = ("grpc.error.resource_info.resource_name",)

    # Path: model/attributes/grpc/grpc__error__resource_info__resource_type.json
    GRPC_ERROR_RESOURCE_INFO_RESOURCE_TYPE: Literal["grpc.error.resource_info.resource_type"] = "grpc.error.resource_info.resource_type"
    ...
    GRPC_ERROR_RESOURCE_INFO_RESOURCE_TYPE_KEYS: Tuple[str, ...] = ("grpc.error.resource_info.resource_type",)

    # Path: model/attributes/grpc/grpc__error__retry_info__retry_delay_ms.json
    GRPC_ERROR_RETRY_INFO_RETRY_DELAY_MS: Literal["grpc.error.retry_info.retry_delay_ms"] = "grpc.error.retry_info.retry_delay_ms"
    ...
    GRPC_ERROR_RETRY_INFO_RETRY_DELAY_MS_KEYS: Tuple[str, ...] = ("grpc.error.retry_info.retry_delay_ms",)
    ...
    HARDWARECONCURRENCY_KEYS: Tuple[str, ...] = ("device.processor_count", "hardwareConcurrency",)
    ...
    HTTP_CLIENT_IP_KEYS: Tuple[str, ...] = ("client.address", "http.client_ip",)
    ...
    HTTP_DECODED_RESPONSE_CONTENT_LENGTH_KEYS: Tuple[str, ...] = ("http.decoded_response_content_length",)
    ...
    HTTP_FLAVOR_KEYS: Tuple[str, ...] = ("network.protocol.version", "http.flavor", "net.protocol.version",)
    ...
    HTTP_HOST_KEYS: Tuple[str, ...] = ("server.address", "address", "http.host", "http.server_name", "net.host.name", "net.peer.name", "server_name",)
    ...
    HTTP_METHOD_KEYS: Tuple[str, ...] = ("http.request.method", "http.method", "http.request_method", "method",)
    ...
    HTTP_REQUEST_DOMAIN_LOOKUP_END_KEYS: Tuple[str, ...] = ("http.request.domain_lookup_end",)
    ...
    HTTP_REQUEST_DOMAIN_LOOKUP_START_KEYS: Tuple[str, ...] = ("http.request.domain_lookup_start",)
    ...
    HTTP_REQUEST_METHOD_KEYS: Tuple[str, ...] = ("http.request.method", "http.method", "http.request_method", "method",)
    ...
    HTTP_REQUEST_SAME_ORIGIN: Literal["http.request.same_origin"] = "http.request.same_origin"
    ...
    HTTP_REQUEST_SAME_ORIGIN_KEYS: Tuple[str, ...] = ("http.request.same_origin", "url.same_origin",)
    ...
    HTTP_REQUEST_SECURE_CONNECTION_START_KEYS: Tuple[str, ...] = ("http.request.secure_connection_start",)
    ...
    HTTP_REQUEST_TIME_TO_FIRST_BYTE_KEYS: Tuple[str, ...] = ("http.request.time_to_first_byte",)
    ...
    _HTTP_REQUEST_METHOD_KEYS: Tuple[str, ...] = ("http.request.method", "http.method", "http.request_method", "method",)
    ...
    HTTP_RESPONSE_BODY_SIZE_KEYS: Tuple[str, ...] = ("http.response.body.size", "http.response_content_length",)
    ...
    HTTP_RESPONSE_HEADER_CONTENT_LENGTH_KEYS: Tuple[str, ...] = ("http.response.header.content-length",)
    ...
    HTTP_RESPONSE_SIZE_KEYS: Tuple[str, ...] = ("http.response.size", "http.response_transfer_size",)
    ...
    HTTP_RESPONSE_STATUS_CODE_KEYS: Tuple[str, ...] = ("http.response.status_code", "http.status_code",)
    ...
    HTTP_RESPONSE_CONTENT_LENGTH_KEYS: Tuple[str, ...] = ("http.response.body.size", "http.response_content_length",)
    ...
    HTTP_RESPONSE_TRANSFER_SIZE_KEYS: Tuple[str, ...] = ("http.response.size", "http.response_transfer_size",)
    ...
    HTTP_ROUTE_KEYS: Tuple[str, ...] = ("http.route", "route",)
    ...
    HTTP_SCHEME_KEYS: Tuple[str, ...] = ("url.scheme", "http.scheme",)
    ...
    HTTP_SERVER_REQUEST_TIME_IN_QUEUE_KEYS: Tuple[str, ...] = ("http.server.request.time_in_queue",)
    ...
    HTTP_SERVER_NAME_KEYS: Tuple[str, ...] = ("server.address", "address", "http.host", "http.server_name", "net.host.name", "net.peer.name", "server_name",)
    ...
    HTTP_STATUS_CODE_KEYS: Tuple[str, ...] = ("http.response.status_code", "http.status_code",)
    ...
    HTTP_TARGET_KEYS: Tuple[str, ...] = ("url.path", "http.target",)
    ...
    HTTP_URL_KEYS: Tuple[str, ...] = ("url.full", "aws.request.url", "http.url", "url",)
    ...
    HTTP_USER_AGENT_KEYS: Tuple[str, ...] = ("user_agent.original", "http.user_agent",)
    ...
    INP_KEYS: Tuple[str, ...] = ("browser.web_vital.inp.value", "inp",)

    # Path: model/attributes/jsonrpc/jsonrpc__protocol__version.json
    JSONRPC_PROTOCOL_VERSION: Literal["jsonrpc.protocol.version"] = "jsonrpc.protocol.version"
    ...
    JSONRPC_REQUEST_ID_KEYS: Tuple[str, ...] = ("jsonrpc.request.id", "mcp.request.id",)
    ...
    LCP_ELEMENT_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.element", "lcp.element",)
    ...
    LCP_ID_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.id", "lcp.id",)
    ...
    LCP_LOADTIME_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.load_time", "lcp.loadTime",)
    ...
    LCP_RENDERTIME_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.render_time", "lcp.renderTime",)
    ...
    LCP_SIZE_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.size", "lcp.size",)
    ...
    LCP_URL_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.url", "lcp.url",)
    ...
    LCP_KEYS: Tuple[str, ...] = ("browser.web_vital.lcp.value", "lcp",)

    # Path: model/attributes/litestar/litestar__middleware_name.json
    LITESTAR_MIDDLEWARE_NAME: Literal["litestar.middleware_name"] = "litestar.middleware_name"
    ...
    LITESTAR_MIDDLEWARE_NAME_KEYS: Tuple[str, ...] = ("middleware.name", "django.middleware_name", "litestar.middleware_name", "starlette.middleware_name", "starlite.middleware_name",)
    ...
    MCP_PROMPT_NAME_KEYS: Tuple[str, ...] = ("gen_ai.prompt.name", "mcp.prompt.name",)
    ...
    MCP_PROMPT_RESULT_DESCRIPTION_KEYS: Tuple[str, ...] = ("mcp.prompt.result.description",)
    ...
    MCP_PROMPT_RESULT_MESSAGE_CONTENT_KEYS: Tuple[str, ...] = ("mcp.prompt.result.message_content",)
    ...
    MCP_PROMPT_RESULT_MESSAGE_COUNT_KEYS: Tuple[str, ...] = ("mcp.prompt.result.message_count",)
    ...
    MCP_PROMPT_RESULT_MESSAGE_ROLE_KEYS: Tuple[str, ...] = ("mcp.prompt.result.message_role",)
    ...
    MCP_REQUEST_ID_KEYS: Tuple[str, ...] = ("jsonrpc.request.id", "mcp.request.id",)
    ...
    MCP_RESOURCE_PROTOCOL_KEYS: Tuple[str, ...] = ("network.protocol.name", "mcp.resource.protocol", "net.protocol.name",)
    ...
    MCP_TOOL_NAME_KEYS: Tuple[str, ...] = ("gen_ai.tool.name", "ai.function_call", "mcp.tool.name",)
    ...
    MCP_TOOL_RESULT_CONTENT_KEYS: Tuple[str, ...] = ("gen_ai.tool.call.result", "ai.toolCall.result", "gen_ai.tool.message", "gen_ai.tool.output", "mcp.tool.result.content",)
    ...
    MCP_TOOL_RESULT_CONTENT_COUNT_KEYS: Tuple[str, ...] = ("mcp.tool.result.content_count",)
    ...
    MCP_TOOL_RESULT_IS_ERROR_KEYS: Tuple[str, ...] = ("error.type", "fs_error", "mcp.tool.result.is_error",)
    ...
    MCP_TRANSPORT_KEYS: Tuple[str, ...] = ("network.transport", "mcp.transport", "net.sock.family", "net.transport",)
    ...
    MESSAGING_BATCH_MESSAGE_COUNT: Literal["messaging.batch.message_count"] = "messaging.batch.message_count"
    ...
    MESSAGING_BATCH_MESSAGE_COUNT_KEYS: Tuple[str, ...] = ("messaging.batch.message_count",)
    ...
    MESSAGING_DESTINATION_KEYS: Tuple[str, ...] = ("messaging.destination.name", "messaging.destination",)
    ...
    MESSAGING_DESTINATION_CONNECTION_KEYS: Tuple[str, ...] = ("messaging.destination.connection",)
    ...
    MESSAGING_DESTINATION_NAME_KEYS: Tuple[str, ...] = ("messaging.destination.name", "messaging.destination",)

    # Path: model/attributes/messaging/messaging__destination__partition__id.json
    MESSAGING_DESTINATION_PARTITION_ID: Literal["messaging.destination.partition.id"] = "messaging.destination.partition.id"
    ...
    MESSAGING_DESTINATION_PARTITION_ID_KEYS: Tuple[str, ...] = ("messaging.destination.partition.id",)

    # Path: model/attributes/messaging/messaging__destination_kind.json
    MESSAGING_DESTINATION_KIND: Literal["messaging.destination_kind"] = "messaging.destination_kind"
    ...
    MESSAGING_KAFKA_MESSAGE_KEY: Literal["messaging.kafka.message.key"] = "messaging.kafka.message.key"
    ...
    MESSAGING_KAFKA_MESSAGE_TOMBSTONE: Literal["messaging.kafka.message.tombstone"] = "messaging.kafka.message.tombstone"
    ...
    MESSAGING_KAFKA_MESSAGE_TOMBSTONE_KEYS: Tuple[str, ...] = ("messaging.kafka.message.tombstone",)
    ...
    MESSAGING_MESSAGE_CONVERSATION_ID: Literal["messaging.message.conversation_id"] = "messaging.message.conversation_id"
    ...
    MESSAGING_MESSAGE_CONVERSATION_ID_KEYS: Tuple[str, ...] = ("messaging.message.conversation_id",)
    ...
    MESSAGING_MESSAGE_ENVELOPE_SIZE_KEYS: Tuple[str, ...] = ("messaging.message.envelope.size",)
    ...
    MESSAGING_MESSAGE_RECEIVE_LATENCY_KEYS: Tuple[str, ...] = ("messaging.message.receive.latency",)
    ...
    MESSAGING_MESSAGE_RETRY_COUNT_KEYS: Tuple[str, ...] = ("messaging.message.retry.count",)

    # Path: model/attributes/messaging/messaging__operation__name.json
    MESSAGING_OPERATION_NAME: Literal["messaging.operation.name"] = "messaging.operation.name"
    ...
    MESSAGING_RABBITMQ_DESTINATION_ROUTING_KEY: Literal["messaging.rabbitmq.destination.routing_key"] = "messaging.rabbitmq.destination.routing_key"
    ...
    MESSAGING_RABBITMQ_DESTINATION_ROUTING_KEY_KEYS: Tuple[str, ...] = ("messaging.rabbitmq.destination.routing_key",)
    ...
    METHOD_KEYS: Tuple[str, ...] = ("http.request.method", "http.method", "http.request_method", "method",)
    ...
    MIDDLEWARE_NAME_KEYS: Tuple[str, ...] = ("middleware.name", "django.middleware_name", "litestar.middleware_name", "starlette.middleware_name", "starlite.middleware_name",)
    ...
    NAVIGATION_ORIGIN_KEYS: Tuple[str, ...] = ("navigation.origin", "sentry.sveltekit.navigation.from",)
    ...
    NAVIGATION_TYPE_KEYS: Tuple[str, ...] = ("navigation.type", "sentry.sveltekit.navigation.type",)
    ...
    NET_HOST_IP_KEYS: Tuple[str, ...] = ("network.local.address", "net.host.ip", "net.sock.host.addr",)
    ...
    NET_HOST_NAME_KEYS: Tuple[str, ...] = ("server.address", "address", "http.host", "http.server_name", "net.host.name", "net.peer.name", "server_name",)
    ...
    NET_HOST_PORT_KEYS: Tuple[str, ...] = ("server.port", "net.host.port", "net.peer.port", "port",)
    ...
    NET_PEER_IP_KEYS: Tuple[str, ...] = ("network.peer.address", "net.peer.ip", "net.sock.peer.addr",)
    ...
    NET_PEER_NAME_KEYS: Tuple[str, ...] = ("server.address", "address", "http.host", "http.server_name", "net.host.name", "net.peer.name", "server_name",)
    ...
    NET_PEER_PORT_KEYS: Tuple[str, ...] = ("server.port", "net.host.port", "net.peer.port", "port",)
    ...
    NET_PROTOCOL_NAME_KEYS: Tuple[str, ...] = ("network.protocol.name", "mcp.resource.protocol", "net.protocol.name",)
    ...
    NET_PROTOCOL_VERSION_KEYS: Tuple[str, ...] = ("network.protocol.version", "http.flavor", "net.protocol.version",)
    ...
    NET_SOCK_FAMILY_KEYS: Tuple[str, ...] = ("network.transport", "mcp.transport", "net.sock.family", "net.transport",)
    ...
    NET_SOCK_HOST_ADDR_KEYS: Tuple[str, ...] = ("network.local.address", "net.host.ip", "net.sock.host.addr",)
    ...
    NET_SOCK_HOST_PORT_KEYS: Tuple[str, ...] = ("network.local.port", "net.sock.host.port",)
    ...
    NET_SOCK_PEER_ADDR_KEYS: Tuple[str, ...] = ("network.peer.address", "net.peer.ip", "net.sock.peer.addr",)
    ...
    NET_SOCK_PEER_PORT_KEYS: Tuple[str, ...] = ("network.peer.port", "net.sock.peer.port",)
    ...
    NET_TRANSPORT_KEYS: Tuple[str, ...] = ("network.transport", "mcp.transport", "net.sock.family", "net.transport",)

    # Path: model/attributes/network/network__connection__effective_type.json
    NETWORK_CONNECTION_EFFECTIVE_TYPE: Literal["network.connection.effective_type"] = "network.connection.effective_type"
    ...
    NETWORK_CONNECTION_EFFECTIVE_TYPE_KEYS: Tuple[str, ...] = ("network.connection.effective_type", "effectiveConnectionType",)
    ...
    NETWORK_CONNECTION_RTT_KEYS: Tuple[str, ...] = ("network.connection.rtt", "connection.rtt",)

    # Path: model/attributes/network/network__connection__type.json
    NETWORK_CONNECTION_TYPE: Literal["network.connection.type"] = "network.connection.type"
    """Specifies the type of the current connection (e.g. wifi, ethernet, cellular , etc).
    ...
    NETWORK_CONNECTION_TYPE_KEYS: Tuple[str, ...] = ("network.connection.type", "connectionType", "device.connection_type",)
    ...
    NETWORK_LOCAL_ADDRESS_KEYS: Tuple[str, ...] = ("network.local.address", "net.host.ip", "net.sock.host.addr",)
    ...
    NETWORK_LOCAL_PORT_KEYS: Tuple[str, ...] = ("network.local.port", "net.sock.host.port",)
    ...
    NETWORK_PEER_ADDRESS_KEYS: Tuple[str, ...] = ("network.peer.address", "net.peer.ip", "net.sock.peer.addr",)
    ...
    NETWORK_PEER_PORT_KEYS: Tuple[str, ...] = ("network.peer.port", "net.sock.peer.port",)
    ...
    NETWORK_PROTOCOL_NAME_KEYS: Tuple[str, ...] = ("network.protocol.name", "mcp.resource.protocol", "net.protocol.name",)
    ...
    NETWORK_PROTOCOL_VERSION_KEYS: Tuple[str, ...] = ("network.protocol.version", "http.flavor", "net.protocol.version",)
    ...
    NETWORK_TRANSPORT_KEYS: Tuple[str, ...] = ("network.transport", "mcp.transport", "net.sock.family", "net.transport",)
    ...
    OS_BUILD_KEYS: Tuple[str, ...] = ("os.build_id", "os.build",)
    ...
    OS_BUILD_ID_KEYS: Tuple[str, ...] = ("os.build_id", "os.build",)
    ...
    OTEL_KIND_KEYS: Tuple[str, ...] = ("sentry.kind", "otel.kind",)
    ...
    PERFORMANCE_ACTIVATIONSTART: Literal["performance.activationStart"] = "performance.activationStart"
    """The time between initiating a navigation to a page and the browser activating the page
    ...
    PERFORMANCE_ACTIVATIONSTART_KEYS: Tuple[str, ...] = ("browser.performance.navigation.activation_start", "performance.activationStart",)
    ...
    PERFORMANCE_TIMEORIGIN_KEYS: Tuple[str, ...] = ("browser.performance.time_origin", "performance.timeOrigin",)
    ...
    PORT_KEYS: Tuple[str, ...] = ("server.port", "net.host.port", "net.peer.port", "port",)
    ...
    PROCESS_PID_KEYS: Tuple[str, ...] = ("process.pid", "subprocess.pid",)
    ...
    PROCESS_RUNTIME_DESCRIPTION_KEYS: Tuple[str, ...] = ("process.runtime.description", "runtime.raw_description",)

    # Path: model/attributes/process/process__runtime__engine__name.json
    PROCESS_RUNTIME_ENGINE_NAME: Literal["process.runtime.engine.name"] = "process.runtime.engine.name"
    ...
    PROCESS_RUNTIME_ENGINE_VERSION: Literal["process.runtime.engine.version"] = "process.runtime.engine.version"
    ...
    PROCESS_RUNTIME_ENGINE_VERSION_KEYS: Tuple[str, ...] = ("process.runtime.engine.version",)
    ...
    PROCESS_RUNTIME_NAME_KEYS: Tuple[str, ...] = ("process.runtime.name", "runtime.name",)
    ...
    PROCESS_RUNTIME_VERSION_KEYS: Tuple[str, ...] = ("process.runtime.version", "runtime.version",)
    ...
    PROFILE_ID_KEYS: Tuple[str, ...] = ("sentry.profile_id", "profile_id",)
    ...
    QUERY_KEY_KEYS: Tuple[str, ...] = ("url.query", "query.<key>",)
    ...
    QUERY_KEYS: Tuple[str, ...] = ("db.query.text", "db.statement", "query",)
    ...
    REDIS_COMMAND_KEYS: Tuple[str, ...] = ("db.operation.name", "cloudflare.d1.query_type", "db.operation", "redis.command",)
    ...
    REDIS_KEY_KEYS: Tuple[str, ...] = ("db.redis.key", "redis.key",)
    ...
    RELEASE_KEYS: Tuple[str, ...] = ("sentry.release", "release",)
    ...
    REPLAY_ID_KEYS: Tuple[str, ...] = ("sentry.replay_id", "replay_id",)
    ...
    RESOURCE_DEPLOYMENT_ENVIRONMENT_KEYS: Tuple[str, ...] = ("sentry.environment", "environment", "resource.deployment.environment", "resource.deployment.environment.name",)
    ...
    RESOURCE_DEPLOYMENT_ENVIRONMENT_NAME_KEYS: Tuple[str, ...] = ("sentry.environment", "environment", "resource.deployment.environment", "resource.deployment.environment.name",)
    ...
    RESOURCE_RENDER_BLOCKING_STATUS_KEYS: Tuple[str, ...] = ("resource.render_blocking_status",)
    ...
    ROUTE_KEYS: Tuple[str, ...] = ("http.route", "route",)
    ...
    RPC_GRPC_STATUS_CODE_KEYS: Tuple[str, ...] = ("rpc.response.status_code", "code", "rpc.grpc.status_code",)
    ...
    RPC_METHOD_KEYS: Tuple[str, ...] = ("rpc.method", "aws.operation_name",)

    # Path: model/attributes/rpc/rpc__response__status_code.json
    RPC_RESPONSE_STATUS_CODE: Literal["rpc.response.status_code"] = "rpc.response.status_code"
    """Status code of the RPC returned by the RPC server or generated by the client.
    ...
    RPC_RESPONSE_STATUS_CODE_KEYS: Tuple[str, ...] = ("rpc.response.status_code", "code", "rpc.grpc.status_code",)
    ...
    RPC_SYSTEM_KEYS: Tuple[str, ...] = ("rpc.system.name", "rpc.system",)
    ...
    RPC_SYSTEM_NAME_KEYS: Tuple[str, ...] = ("rpc.system.name", "rpc.system",)
    ...
    RUNTIME_NAME_KEYS: Tuple[str, ...] = ("process.runtime.name", "runtime.name",)

    # Path: model/attributes/runtime/runtime__raw_description.json
    RUNTIME_RAW_DESCRIPTION: Literal["runtime.raw_description"] = "runtime.raw_description"
    ...
    RUNTIME_RAW_DESCRIPTION_KEYS: Tuple[str, ...] = ("process.runtime.description", "runtime.raw_description",)
    ...
    RUNTIME_VERSION_KEYS: Tuple[str, ...] = ("process.runtime.version", "runtime.version",)
    ...
    SENTRY_BROWSER_NAME_KEYS: Tuple[str, ...] = ("browser.name", "sentry.browser.name",)
    ...
    SENTRY_BROWSER_VERSION_KEYS: Tuple[str, ...] = ("browser.version", "sentry.browser.version",)
    ...
    SENTRY_DIST_KEYS: Tuple[str, ...] = ("sentry.dist", "dist",)
    ...
    SENTRY_ENVIRONMENT_KEYS: Tuple[str, ...] = ("sentry.environment", "environment", "resource.deployment.environment", "resource.deployment.environment.name",)

    # Path: model/attributes/sentry/sentry__event__serialized_breadcrumbs.json
    SENTRY_EVENT_SERIALIZED_BREADCRUMBS: Literal["sentry.event.serialized_breadcrumbs"] = "sentry.event.serialized_breadcrumbs"
    ...
    SENTRY_EVENT_SERIALIZED_BREADCRUMBS_KEYS: Tuple[str, ...] = ("sentry.event.serialized_breadcrumbs",)

    # Path: model/attributes/sentry/sentry__event__serialized_contexts.json
    SENTRY_EVENT_SERIALIZED_CONTEXTS: Literal["sentry.event.serialized_contexts"] = "sentry.event.serialized_contexts"
    ...
    SENTRY_EVENT_SERIALIZED_CONTEXTS_KEYS: Tuple[str, ...] = ("sentry.event.serialized_contexts",)

    # Path: model/attributes/sentry/sentry__event__serialized_extra.json
    SENTRY_EVENT_SERIALIZED_EXTRA: Literal["sentry.event.serialized_extra"] = "sentry.event.serialized_extra"
    ...
    SENTRY_EVENT_SERIALIZED_EXTRA_KEYS: Tuple[str, ...] = ("sentry.event.serialized_extra",)
    ...
    SENTRY_FRAMES_FROZEN_KEYS: Tuple[str, ...] = ("app.vitals.frames.frozen.count", "frames.frozen", "sentry.frames.frozen",)
    ...
    SENTRY_FRAMES_SLOW_KEYS: Tuple[str, ...] = ("app.vitals.frames.slow.count", "frames.slow", "sentry.frames.slow",)
    ...
    SENTRY_FRAMES_TOTAL_KEYS: Tuple[str, ...] = ("app.vitals.frames.total.count", "frames.total", "sentry.frames.total",)
    ...
    SENTRY_IDLE_SPAN_FINISH_REASON_KEYS: Tuple[str, ...] = ("sentry.idle_span_finish_reason",)
    ...
    SENTRY_KIND_KEYS: Tuple[str, ...] = ("sentry.kind", "otel.kind",)
    ...
    SENTRY_MESSAGE_PARAMETER_KEY_KEYS: Tuple[str, ...] = ("sentry.message.parameter.<key>",)
    ...
    SENTRY_NEXTJS_SSR_FUNCTION_ROUTE_KEYS: Tuple[str, ...] = ("sentry.nextjs.ssr.function.route",)
    ...
    SENTRY_NEXTJS_SSR_FUNCTION_TYPE_KEYS: Tuple[str, ...] = ("sentry.nextjs.ssr.function.type",)
    ...
    SENTRY_NORMALIZED_DB_QUERY_HASH_KEYS: Tuple[str, ...] = ("sentry.normalized_db_query.hash",)
    ...
    SENTRY_NORMALIZED_DESCRIPTION_KEYS: Tuple[str, ...] = ("sentry.normalized_description",)
    ...
    SENTRY_OBSERVED_TIMESTAMP_NANOS_KEYS: Tuple[str, ...] = ("sentry.observed_timestamp_nanos",)
    ...
    SENTRY_PAGELOAD_SPAN_ID: Literal["sentry.pageload.span_id"] = "sentry.pageload.span_id"
    ...
    SENTRY_PROFILE_ID_KEYS: Tuple[str, ...] = ("sentry.profile_id", "profile_id",)
    ...
    SENTRY_RELEASE_KEYS: Tuple[str, ...] = ("sentry.release", "release",)
    ...
    SENTRY_REPLAY_ID_KEYS: Tuple[str, ...] = ("sentry.replay_id", "replay_id",)
    ...
    SENTRY_SEGMENT_ID_KEYS: Tuple[str, ...] = ("sentry.segment.id", "sentry.segment_id",)
    ...
    SENTRY_SEGMENT_NAME_KEYS: Tuple[str, ...] = ("sentry.segment.name", "sentry.transaction", "transaction",)

    # Path: model/attributes/sentry/sentry__segment__name__source.json
    SENTRY_SEGMENT_NAME_SOURCE: Literal["sentry.segment.name.source"] = "sentry.segment.name.source"
    ...
    _SENTRY_SEGMENT_ID_KEYS: Tuple[str, ...] = ("sentry.segment.id", "sentry.segment_id",)
    ...
    SENTRY_SVELTEKIT_NAVIGATION_FROM: Literal["sentry.sveltekit.navigation.from"] = "sentry.sveltekit.navigation.from"
    ...
    SENTRY_SVELTEKIT_NAVIGATION_FROM_KEYS: Tuple[str, ...] = ("navigation.origin", "sentry.sveltekit.navigation.from",)

    # Path: model/attributes/sentry/sentry__sveltekit__navigation__to.json
    SENTRY_SVELTEKIT_NAVIGATION_TO: Literal["sentry.sveltekit.navigation.to"] = "sentry.sveltekit.navigation.to"
    ...
    SENTRY_SVELTEKIT_NAVIGATION_TO_KEYS: Tuple[str, ...] = ("sentry.sveltekit.navigation.to",)

    # Path: model/attributes/sentry/sentry__sveltekit__navigation__type.json
    SENTRY_SVELTEKIT_NAVIGATION_TYPE: Literal["sentry.sveltekit.navigation.type"] = "sentry.sveltekit.navigation.type"
    ...
    SENTRY_SVELTEKIT_NAVIGATION_TYPE_KEYS: Tuple[str, ...] = ("navigation.type", "sentry.sveltekit.navigation.type",)
    ...
    SENTRY_THREAD_ID_KEYS: Tuple[str, ...] = ("thread.id", "sentry.thread.id",)
    ...
    SENTRY_TRANSACTION_KEYS: Tuple[str, ...] = ("sentry.segment.name", "sentry.transaction", "transaction",)
    ...
    SENTRY_USER_EMAIL_KEYS: Tuple[str, ...] = ("user.email", "sentry.user.email",)
    ...
    SENTRY_USER_GEO_CITY_KEYS: Tuple[str, ...] = ("user.geo.city", "sentry.user.geo.city",)

    # Path: model/attributes/sentry/sentry__user__geo__country_code.json
    SENTRY_USER_GEO_COUNTRY_CODE: Literal["sentry.user.geo.country_code"] = "sentry.user.geo.country_code"
    ...
    SENTRY_USER_GEO_COUNTRY_CODE_KEYS: Tuple[str, ...] = ("user.geo.country_code", "sentry.user.geo.country_code",)
    ...
    SENTRY_USER_GEO_REGION_KEYS: Tuple[str, ...] = ("user.geo.region", "sentry.user.geo.region",)

    # Path: model/attributes/sentry/sentry__user__geo__subdivision.json
    SENTRY_USER_GEO_SUBDIVISION: Literal["sentry.user.geo.subdivision"] = "sentry.user.geo.subdivision"
    ...
    SENTRY_USER_GEO_SUBDIVISION_KEYS: Tuple[str, ...] = ("user.geo.subdivision", "sentry.user.geo.subdivision",)
    ...
    SENTRY_USER_ID_KEYS: Tuple[str, ...] = ("user.id", "sentry.user.id",)
    ...
    SENTRY_USER_IP_KEYS: Tuple[str, ...] = ("user.ip_address", "sentry.user.ip",)
    ...
    SENTRY_USER_USERNAME_KEYS: Tuple[str, ...] = ("user.name", "sentry.user.username",)
    ...
    SERVER_ADDRESS_KEYS: Tuple[str, ...] = ("server.address", "address", "http.host", "http.server_name", "net.host.name", "net.peer.name", "server_name",)
    ...
    SERVER_PORT_KEYS: Tuple[str, ...] = ("server.port", "net.host.port", "net.peer.port", "port",)
    ...
    SERVER_NAME_KEYS: Tuple[str, ...] = ("server.address", "address", "http.host", "http.server_name", "net.host.name", "net.peer.name", "server_name",)
    ...
    STALL_PERCENTAGE_KEYS: Tuple[str, ...] = ("app.vitals.stall.percentage", "stall_percentage",)
    ...
    STALL_TOTAL_TIME_KEYS: Tuple[str, ...] = ("app.vitals.stall.duration", "stall_total_time",)

    # Path: model/attributes/starlette/starlette__middleware_name.json
    STARLETTE_MIDDLEWARE_NAME: Literal["starlette.middleware_name"] = "starlette.middleware_name"
    ...
    STARLETTE_MIDDLEWARE_NAME_KEYS: Tuple[str, ...] = ("middleware.name", "django.middleware_name", "litestar.middleware_name", "starlette.middleware_name", "starlite.middleware_name",)

    # Path: model/attributes/starlite/starlite__middleware_name.json
    STARLITE_MIDDLEWARE_NAME: Literal["starlite.middleware_name"] = "starlite.middleware_name"
    ...
    STARLITE_MIDDLEWARE_NAME_KEYS: Tuple[str, ...] = ("middleware.name", "django.middleware_name", "litestar.middleware_name", "starlette.middleware_name", "starlite.middleware_name",)
    ...
    SUBPROCESS_PID_KEYS: Tuple[str, ...] = ("process.pid", "subprocess.pid",)
    ...
    THREAD_ID_KEYS: Tuple[str, ...] = ("thread.id", "sentry.thread.id",)
    ...
    TIME_TO_FULL_DISPLAY_KEYS: Tuple[str, ...] = ("app.vitals.ttfd.value", "time_to_full_display",)

    # Path: model/attributes/time_to_initial_display.json
    TIME_TO_INITIAL_DISPLAY: Literal["time_to_initial_display"] = "time_to_initial_display"
    """The duration of time to initial display in milliseconds
    ...
    TIME_TO_INITIAL_DISPLAY_KEYS: Tuple[str, ...] = ("app.vitals.ttid.value", "time_to_initial_display",)
    ...
    TRANSACTION_KEYS: Tuple[str, ...] = ("sentry.segment.name", "sentry.transaction", "transaction",)
    ...
    TTFB_REQUESTTIME_KEYS: Tuple[str, ...] = ("browser.web_vital.ttfb.request_time", "ttfb.requestTime",)
    ...
    TTFB_KEYS: Tuple[str, ...] = ("browser.web_vital.ttfb.value", "ttfb",)
    ...
    URL_FULL_KEYS: Tuple[str, ...] = ("url.full", "aws.request.url", "http.url", "url",)
    ...
    URL_PATH_KEYS: Tuple[str, ...] = ("url.path", "http.target",)
    ...
    URL_QUERY_KEYS: Tuple[str, ...] = ("url.query", "query.<key>",)
    ...
    URL_SAME_ORIGIN_KEYS: Tuple[str, ...] = ("http.request.same_origin", "url.same_origin",)
    ...
    URL_SCHEME_KEYS: Tuple[str, ...] = ("url.scheme", "http.scheme",)
    ...
    URL_KEYS: Tuple[str, ...] = ("url.full", "aws.request.url", "http.url", "url",)
    ...
    USER_EMAIL_KEYS: Tuple[str, ...] = ("user.email", "sentry.user.email",)
    ...
    USER_GEO_CITY_KEYS: Tuple[str, ...] = ("user.geo.city", "sentry.user.geo.city",)
    ...
    USER_GEO_COUNTRY_CODE_KEYS: Tuple[str, ...] = ("user.geo.country_code", "sentry.user.geo.country_code",)
    ...
    USER_GEO_REGION_KEYS: Tuple[str, ...] = ("user.geo.region", "sentry.user.geo.region",)
    ...
    USER_GEO_SUBDIVISION_KEYS: Tuple[str, ...] = ("user.geo.subdivision", "sentry.user.geo.subdivision",)
    ...
    USER_ID_KEYS: Tuple[str, ...] = ("user.id", "sentry.user.id",)
    ...
    USER_IP_ADDRESS_KEYS: Tuple[str, ...] = ("user.ip_address", "sentry.user.ip",)
    ...
    USER_NAME_KEYS: Tuple[str, ...] = ("user.name", "sentry.user.username",)
    ...
    USER_AGENT_ORIGINAL_KEYS: Tuple[str, ...] = ("user_agent.original", "http.user_agent",)
    ...
    VERCEL_PROXY_PATH_TYPE_VARIANT_KEYS: Tuple[str, ...] = ("vercel.proxy.path_type_variant",)
    ...
    VERCEL_PROXY_RESPONSE_BYTE_SIZE_KEYS: Tuple[str, ...] = ("vercel.proxy.response_byte_size",)
...
ATTRIBUTE_METADATA: Dict[str, AttributeMetadata] = {
    "address": AttributeMetadata(
        ...
        aliases=["server.address","http.server_name","net.host.name","http.host","server_name"],
        changelog=[
            ChangelogEntry(version="next", prs=[534], description="Added address attribute"),
        ],
    ),
    ...
    "ai.prompt.messages": AttributeMetadata(
        ...
        aliases=["gen_ai.input.messages","ai.texts","gen_ai.prompt"],
        changelog=[
            ChangelogEntry(version="next", prs=[498], description="Added ai.prompt.messages attribute"),
        ],
    ),
    ...
    "ai.response.text": AttributeMetadata(
        ...
        aliases=["gen_ai.output.messages","ai.response.toolCalls"],
        changelog=[
            ChangelogEntry(version="next", prs=[498], description="Added ai.response.text attribute"),
        ],
    ),
    "ai.response.toolCalls": AttributeMetadata(
        ...
        aliases=["gen_ai.output.messages","ai.response.text"],
        changelog=[
            ChangelogEntry(version="next", prs=[498], description="Added ai.response.toolCalls attribute"),
        ],
    ),
    ...
    "ai.toolCall.args": AttributeMetadata(
        ...
        aliases=["gen_ai.tool.call.arguments","gen_ai.tool.input"],
        changelog=[
            ChangelogEntry(version="next", prs=[498], description="Added ai.toolCall.args attribute"),
        ],
    ),
    "ai.toolCall.result": AttributeMetadata(
        ...
        aliases=["gen_ai.tool.call.result","gen_ai.tool.output","gen_ai.tool.message","mcp.tool.result.content"],
        changelog=[
            ChangelogEntry(version="next", prs=[498], description="Added ai.toolCall.result attribute"),
        ],
    ),
    ...
    "angular.version": AttributeMetadata(
        ...
        example="17.1.0",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[367], description="Added angular.version attribute"),
        ],
    ),
    "app.app_build": AttributeMetadata(
        ...
        aliases=["app.build"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added and deprecated app.app_build in favor of app.build"),
        ],
    ),
    "app.app_identifier": AttributeMetadata(
        ...
        aliases=["app.identifier"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added and deprecated app.app_identifier in favor of app.identifier"),
        ],
    ),
    "app.app_name": AttributeMetadata(
        ...
        aliases=["app.name"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added and deprecated app.app_name in favor of app.name"),
        ],
    ),
    "app.app_start_time": AttributeMetadata(
        ...
        aliases=["app.start_time"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added and deprecated app.app_start_time in favor of app.start_time"),
        ],
    ),
    "app.app_version": AttributeMetadata(
        ...
        aliases=["app.version"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added and deprecated app.app_version in favor of app.version"),
        ],
    ),
    "app.build": AttributeMetadata(
        ...
        aliases=["app.app_build"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added app.build attribute"),
        ],
    ),
    "app.identifier": AttributeMetadata(
        ...
        aliases=["app.app_identifier"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added app.identifier attribute"),
        ],
    ),
    "app.in_foreground": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added app.in_foreground attribute"),
        ],
    ),
    "app.name": AttributeMetadata(
        ...
        aliases=["app.app_name"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added app.name attribute"),
        ],
    ),
    "app.start_time": AttributeMetadata(
        ...
        aliases=["app.app_start_time"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added app.start_time attribute"),
        ],
    ),
    "app.version": AttributeMetadata(
        ...
        aliases=["app.app_version"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[296], description="Added app.version attribute"),
        ],
    ),
    "app.vitals.frames.delay.value": AttributeMetadata(
        ...
        aliases=["frames.delay"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.frames.delay.value to replace frames.delay"),
        ],
    ),
    "app.vitals.frames.frozen.count": AttributeMetadata(
        ...
        aliases=["frames.frozen","sentry.frames.frozen"],
        changelog=[
            ChangelogEntry(version="next", description="Added sentry.frames.frozen as an alias"),
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.frames.frozen.count to replace frames.frozen"),
        ],
    ),
    "app.vitals.frames.frozen.rate": AttributeMetadata(
        ...
        aliases=["frames_frozen_rate"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Added app.vitals.frames.frozen.rate attribute"),
        ],
    ),
    "app.vitals.frames.slow.count": AttributeMetadata(
        ...
        aliases=["frames.slow","sentry.frames.slow"],
        changelog=[
            ChangelogEntry(version="next", description="Added sentry.frames.slow as an alias"),
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.frames.slow.count to replace frames.slow"),
        ],
    ),
    "app.vitals.frames.slow.rate": AttributeMetadata(
        ...
        aliases=["frames_slow_rate"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Added app.vitals.frames.slow.rate attribute"),
        ],
    ),
    "app.vitals.frames.total.count": AttributeMetadata(
        ...
        aliases=["frames.total","sentry.frames.total"],
        changelog=[
            ChangelogEntry(version="next", description="Added sentry.frames.total as an alias"),
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.frames.total.count to replace frames.total"),
        ],
    ),
    "app.vitals.stall.duration": AttributeMetadata(
        ...
        aliases=["stall_total_time"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Added app.vitals.stall.duration attribute"),
        ],
    ),
    "app.vitals.stall.percentage": AttributeMetadata(
        ...
        aliases=["stall_percentage"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Added app.vitals.stall.percentage attribute"),
        ],
    ),
    "app.vitals.start.cold.value": AttributeMetadata(
        ...
        aliases=["app_start_cold"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.start.cold.value attribute"),
        ],
    ),
    "app.vitals.start.prewarmed": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[379], description="Added app.vitals.start.prewarmed attribute"),
        ],
    ),
    "app.vitals.start.reason": AttributeMetadata(
        ...
        example="push",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[353], description="Added app.vitals.start.reason attribute"),
        ],
    ),
    "app.vitals.start.screen": AttributeMetadata(
        ...
        example="MainActivity",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[353], description="Added app.vitals.start.screen attribute"),
        ],
    ),
    "app.vitals.start.type": AttributeMetadata(
        ...
        aliases=["app_start_type"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.start.type attribute"),
        ],
    ),
    "app.vitals.start.warm.value": AttributeMetadata(
        ...
        aliases=["app_start_warm"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.start.warm.value attribute"),
        ],
    ),
    "app.vitals.ttfd.value": AttributeMetadata(
        ...
        aliases=["time_to_full_display"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.ttfd.value attribute"),
        ],
    ),
    "app.vitals.ttid.value": AttributeMetadata(
        ...
        aliases=["time_to_initial_display"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added app.vitals.ttid.value attribute"),
        ],
    ),
    "app_start_cold": AttributeMetadata(
        ...
        aliases=["app.vitals.start.cold.value"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[323], description="Added and deprecated in favor of app.vitals.start.cold.value"),
        ],
    ),
    "app_start_type": AttributeMetadata(
        ...
        aliases=["app.vitals.start.type"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Deprecated in favor of app.vitals.start.type"),
    ...
    "app_start_warm": AttributeMetadata(
        ...
        aliases=["app.vitals.start.warm.value"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[323], description="Added and deprecated in favor of app.vitals.start.warm.value"),
        ],
    ),
    "art.gc.blocking_count": AttributeMetadata(
        ...
        example=1,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.gc.blocking_count attribute"),
        ],
    ),
    "art.gc.blocking_time": AttributeMetadata(
        ...
        example=11.873,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.gc.blocking_time attribute"),
        ],
    ),
    "art.gc.pre_oome_count": AttributeMetadata(
        ...
        example=0,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.gc.pre_oome_count attribute"),
        ],
    ),
    "art.gc.total_count": AttributeMetadata(
        ...
        example=1,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.gc.total_count attribute"),
        ],
    ),
    "art.gc.total_time": AttributeMetadata(
        ...
        example=11.807,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.gc.total_time attribute"),
        ],
    ),
    "art.gc.waiting_time": AttributeMetadata(
        ...
        example=8.054,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.gc.waiting_time attribute"),
        ],
    ),
    "art.memory.free": AttributeMetadata(
        ...
        example=3181568,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.memory.free attribute"),
        ],
    ),
    "art.memory.free_until_gc": AttributeMetadata(
        ...
        example=3181568,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.memory.free_until_gc attribute"),
        ],
    ),
    "art.memory.free_until_oome": AttributeMetadata(
        ...
        example=196083712,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.memory.free_until_oome attribute"),
        ],
    ),
    "art.memory.max": AttributeMetadata(
        ...
        example=201326592,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.memory.max attribute"),
        ],
    ),
    "art.memory.total": AttributeMetadata(
        ...
        example=7774208,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[382], description="Added art.memory.total attribute"),
        ],
    ),
    "aws.cloudwatch.logs.log_group": AttributeMetadata(
        ...
        example="/aws/lambda/my-function",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.cloudwatch.logs.log_group attribute"),
        ],
    ),
    "aws.cloudwatch.logs.log_stream": AttributeMetadata(
        ...
        example="2024/01/01/[$LATEST]abcdef1234567890",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.cloudwatch.logs.log_stream attribute"),
        ],
    ),
    "aws.cloudwatch.logs.url": AttributeMetadata(
        ...
        example="https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#logsV2:log-groups/log-group/my-log-group",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.cloudwatch.logs.url attribute"),
        ],
    ),
    "aws.dynamodb.attribute_definitions": AttributeMetadata(
        ...
        example=["{ \"AttributeName\": \"string\", \"AttributeType\": \"string\" }"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.attribute_definitions attribute"),
        ],
    ),
    "aws.dynamodb.consistent_read": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.consistent_read attribute"),
        ],
    ),
    "aws.dynamodb.consumed_capacity": AttributeMetadata(
        ...
        example=["{ \"CapacityUnits\": number, \"GlobalSecondaryIndexes\": { \"string\" : { \"CapacityUnits\": number, \"ReadCapacityUnits\": number, \"WriteCapacityUnits\": number } }, \"LocalSecondaryIndexes\": { \"string\" : { \"CapacityUnits\": number, \"ReadCapacityUnits\": number, \"WriteCapacityUnits\": number } }, \"ReadCapacityUnits\": number, \"Table\": { \"CapacityUnits\": number, \"ReadCapacityUnits\": number, \"WriteCapacityUnits\": number }, \"TableName\": \"string\", \"WriteCapacityUnits\": number }"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.consumed_capacity attribute"),
        ],
    ),
    "aws.dynamodb.count": AttributeMetadata(
        ...
        example=10,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.count attribute"),
        ],
    ),
    "aws.dynamodb.exclusive_start_table": AttributeMetadata(
        ...
        example="Users",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.exclusive_start_table attribute"),
        ],
    ),
    "aws.dynamodb.global_secondary_index_updates": AttributeMetadata(
        ...
        example=["{ \"Create\": { \"IndexName\": \"string\", \"KeySchema\": [ { \"AttributeName\": \"string\", \"KeyType\": \"string\" } ], \"Projection\": { \"NonKeyAttributes\": [ \"string\" ], \"ProjectionType\": \"string\" }, \"ProvisionedThroughput\": { \"ReadCapacityUnits\": number, \"WriteCapacityUnits\": number } }"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.global_secondary_index_updates attribute"),
        ],
    ),
    "aws.dynamodb.global_secondary_indexes": AttributeMetadata(
        ...
        example=["{ \"IndexName\": \"string\", \"KeySchema\": [ { \"AttributeName\": \"string\", \"KeyType\": \"string\" } ], \"Projection\": { \"NonKeyAttributes\": [ \"string\" ], \"ProjectionType\": \"string\" }, \"ProvisionedThroughput\": { \"ReadCapacityUnits\": number, \"WriteCapacityUnits\": number } }"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.global_secondary_indexes attribute"),
        ],
    ),
    "aws.dynamodb.index_name": AttributeMetadata(
        ...
        example="name_to_group",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.index_name attribute"),
        ],
    ),
    "aws.dynamodb.item_collection_metrics": AttributeMetadata(
        ...
        example="{ \"string\" : [ { \"ItemCollectionKey\": { \"string\" : { \"B\": blob, \"BOOL\": boolean, \"BS\": [ blob ], \"L\": [ \"AttributeValue\" ], \"M\": { \"string\" : \"AttributeValue\" }, \"N\": \"string\", \"NS\": [ \"string\" ], \"NULL\": boolean, \"S\": \"string\", \"SS\": [ \"string\" ] } }, \"SizeEstimateRangeGB\": [ number ] } ] }",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.item_collection_metrics attribute"),
        ],
    ),
    "aws.dynamodb.limit": AttributeMetadata(
        ...
        example=10,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.limit attribute"),
        ],
    ),
    "aws.dynamodb.local_secondary_indexes": AttributeMetadata(
        ...
        example=["{ \"IndexArn\": \"string\", \"IndexName\": \"string\", \"IndexSizeBytes\": number, \"ItemCount\": number, \"KeySchema\": [ { \"AttributeName\": \"string\", \"KeyType\": \"string\" } ], \"Projection\": { \"NonKeyAttributes\": [ \"string\" ], \"ProjectionType\": \"string\" } }"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.local_secondary_indexes attribute"),
        ],
    ),
    "aws.dynamodb.projection": AttributeMetadata(
        ...
        example="Title, Price, Color",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.projection attribute"),
        ],
    ),
    "aws.dynamodb.provisioned_read_capacity": AttributeMetadata(
        ...
        example=1,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.provisioned_read_capacity attribute"),
        ],
    ),
    "aws.dynamodb.provisioned_write_capacity": AttributeMetadata(
        ...
        example=2,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.provisioned_write_capacity attribute"),
        ],
    ),
    "aws.dynamodb.scan_forward": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.scan_forward attribute"),
        ],
    ),
    "aws.dynamodb.scanned_count": AttributeMetadata(
        ...
        example=50,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.scanned_count attribute"),
        ],
    ),
    "aws.dynamodb.segment": AttributeMetadata(
        ...
        example=10,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.segment attribute"),
        ],
    ),
    "aws.dynamodb.select": AttributeMetadata(
        ...
        example="ALL_ATTRIBUTES",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.select attribute"),
        ],
    ),
    "aws.dynamodb.table_count": AttributeMetadata(
        ...
        example=20,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.table_count attribute"),
        ],
    ),
    "aws.dynamodb.table_names": AttributeMetadata(
        ...
        example=["Users", "Cats"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.table_names attribute"),
        ],
    ),
    "aws.dynamodb.total_segments": AttributeMetadata(
        ...
        example=100,
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[479], description="Added aws.dynamodb.total_segments attribute"),
        ],
    ),
    "aws.extended_request_id": AttributeMetadata(
        ...
        aliases=["aws.request.extended_id"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.extended_request_id attribute"),
        ],
    ),
    "aws.kinesis.stream.name": AttributeMetadata(
        ...
        aliases=["aws.kinesis.stream_name"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.kinesis.stream.name attribute, deprecated in favor of aws.kinesis.stream_name"),
        ],
    ),
    "aws.kinesis.stream_name": AttributeMetadata(
        ...
        aliases=["aws.kinesis.stream.name"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.kinesis.stream_name attribute"),
        ],
    ),
    "aws.lambda.aws_request_id": AttributeMetadata(
        ...
        aliases=["faas.invocation_id","faas.execution"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[473], description="Added faas.execution as an alias"),
            ChangelogEntry(version="0.11.1", prs=[414, 424], description="Deprecated aws.lambda.aws_request_id in favor of faas.invocation_id"),
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.lambda.aws_request_id attribute"),
        ],
    ),
    "aws.lambda.execution_duration_in_millis": AttributeMetadata(
        ...
        example=1234.56,
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.lambda.execution_duration_in_millis attribute"),
        ],
    ),
    "aws.lambda.function_name": AttributeMetadata(
        ...
        aliases=["faas.name"],
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[414], description="Deprecated aws.lambda.function_name in favor of faas.name"),
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.lambda.function_name attribute"),
        ],
    ),
    "aws.lambda.function_version": AttributeMetadata(
        ...
        aliases=["faas.version"],
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[414, 424], description="Deprecated aws.lambda.function_version in favor of faas.version"),
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.lambda.function_version attribute"),
        ],
    ),
    ...
    "aws.lambda.invoked_function_arn": AttributeMetadata(
        ...
        aliases=["aws.lambda.invoked_arn"],
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[414], description="Deprecated aws.lambda.invoked_function_arn in favor of aws.lambda.invoked_arn"),
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.lambda.invoked_function_arn attribute"),
        ],
    ),
    "aws.lambda.remaining_time_in_millis": AttributeMetadata(
        ...
        example=5000,
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[369], description="Added aws.lambda.remaining_time_in_millis attribute"),
        ],
    ),
    ...
    "aws.operation_name": AttributeMetadata(
        ...
        aliases=["rpc.method"],
        changelog=[
            ChangelogEntry(version="next", prs=[536], description="Added aws.operation_name attribute"),
        ],
    ),
    "aws.request.extended_id": AttributeMetadata(
        ...
        aliases=["aws.extended_request_id"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.request.extended_id attribute, deprecated in favor of aws.extended_request_id"),
        ],
    ),
    "aws.request.id": AttributeMetadata(
        ...
        aliases=["aws.request_id"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.request.id attribute, deprecated in favor of aws.request_id"),
        ],
    ),
    "aws.request.url": AttributeMetadata(
        ...
        aliases=["url.full","http.url","url"],
        changelog=[
            ChangelogEntry(version="next", description="Added aws.request.url attribute, deprecated in favor of url.full"),
        ],
    ),
    "aws.request_id": AttributeMetadata(
        ...
        aliases=["aws.request.id"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.request_id attribute"),
        ],
    ),
    "aws.s3.bucket": AttributeMetadata(
        ...
        example="ot-demo-test",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.s3.bucket attribute"),
        ],
    ),
    "aws.secretsmanager.secret.arn": AttributeMetadata(
        ...
        example="arn:aws:secretsmanager:us-east-1:123456789012:secret:SecretName-6RandomCharacters",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.secretsmanager.secret.arn attribute"),
        ],
    ),
    "aws.sns.topic.arn": AttributeMetadata(
        ...
        example="arn:aws:sns:us-east-1:123456789012:mystack-mytopic-NZJ5JSMVGFIE",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.sns.topic.arn attribute"),
        ],
    ),
    "aws.step_functions.activity.arn": AttributeMetadata(
        ...
        example="arn:aws:states:us-east-1:123456789012:activity:get-greeting",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.step_functions.activity.arn attribute"),
        ],
    ),
    "aws.step_functions.state_machine.arn": AttributeMetadata(
        ...
        example="arn:aws:states:us-east-1:123456789012:stateMachine:myStateMachine:1",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[480], description="Added aws.step_functions.state_machine.arn attribute"),
        ],
    ),
    "aws_region": AttributeMetadata(
        ...
        aliases=["cloud.region","gcp_region"],
        changelog=[
            ChangelogEntry(version="next", prs=[537], description="Added aws_region attribute"),
        ],
    ),
    ...
    "browser.bfcache.frame": AttributeMetadata(
        ...
        examples=["top", "child"],
        changelog=[
            ChangelogEntry(version="next", prs=[513], description="Added browser.bfcache.frame attribute"),
        ],
    ),
    "browser.bfcache.not_restored_reason_count": AttributeMetadata(
        ...
        examples=[2],
        changelog=[
            ChangelogEntry(version="next", prs=[513], description="Added browser.bfcache.not_restored_reason_count attribute"),
        ],
    ),
    "browser.bfcache.outcome": AttributeMetadata(
        ...
        examples=["hit", "miss"],
        changelog=[
            ChangelogEntry(version="next", prs=[513], description="Added browser.bfcache.outcome attribute"),
        ],
    ),
    "browser.bfcache.reason": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", prs=[513], description="Added browser.bfcache.reason attribute"),
        ],
    ),
    ...
    "browser.performance.navigation.activation_start": AttributeMetadata(
        ...
        aliases=["performance.activationStart"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[321], description="Added browser.performance.navigation.activation_start attribute"),
        ],
    ),
    "browser.performance.time_origin": AttributeMetadata(
        ...
        aliases=["performance.timeOrigin"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[321], description="Added browser.performance.time_origin attribute attribute"),
        ],
    ),
    ...
    "browser.web_vital.cls.report_event": AttributeMetadata(
        ...
        example="navigation",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[319], description="Added browser.web_vital.cls.report_event attribute"),
        ],
    ),
    ...
    "browser.web_vital.cls.value": AttributeMetadata(
        ...
        aliases=["cls"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[229], description="Added browser.web_vital.cls.value attribute"),
        ],
    ),
    ...
    "browser.web_vital.inp.value": AttributeMetadata(
        ...
        aliases=["inp"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[229], description="Added browser.web_vital.inp.value attribute"),
        ],
    ),
    ...
    "browser.web_vital.lcp.report_event": AttributeMetadata(
        ...
        example="pagehide",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[319], description="Added browser.web_vital.lcp.report_event attribute"),
        ],
    ),
    ...
    "browser.web_vital.lcp.value": AttributeMetadata(
        ...
        aliases=["lcp"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[229], description="Added browser.web_vital.lcp.value attribute"),
        ],
    ),
    ...
    "cloud.account.id": AttributeMetadata(
        ...
        example="123456789012",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[364], description="Added cloud.account.id attribute"),
        ],
    ),
    "cloud.availability_zone": AttributeMetadata(
        ...
        example="us-east-1c",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[364], description="Added cloud.availability_zone attribute"),
        ],
    ),
    "cloud.platform": AttributeMetadata(
        ...
        example="aws_lambda",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[364], description="Added cloud.platform attribute"),
        ],
    ),
    "cloud.provider": AttributeMetadata(
        ...
        example="aws",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[364], description="Added cloud.provider attribute"),
        ],
    ),
    "cloud.region": AttributeMetadata(
        ...
        aliases=["aws_region","gcp_region"],
        changelog=[
            ChangelogEntry(version="next", description="Added aws_region and gcp_region as aliases"),
            ChangelogEntry(version="0.7.0", prs=[364], description="Added cloud.region attribute"),
        ],
    ),
    "cloud.resource_id": AttributeMetadata(
        ...
        aliases=["faas.id"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[475], description="Added faas.id as an alias"),
            ChangelogEntry(version="0.11.1", prs=[414]),
        ],
        additional_context=["This can be an identifier for a resource in AWS, GCP, or Azure. There may be some overlap in values found here with other attributes. For instance, an AWS lambda ARN may be found here as well as in `aws.lambda.invoked_arn`. OTEL recommends setting them alongside each other."],
    ),
    ...
    "cloudflare.d1.query_type": AttributeMetadata(
        ...
        aliases=["db.operation.name","db.operation","redis.command"],
        changelog=[
            ChangelogEntry(version="next", description="Added redis.command as an alias"),
            ChangelogEntry(version="0.11.0", prs=[392], description="Added cloudflare.d1.query_type attribute"),
        ],
    ),
    ...
    "cloudflare.durable_object.query.bindings": AttributeMetadata(
        ...
        example=2,
        changelog=[
            ChangelogEntry(version="0.13.0", prs=[435], description="Added cloudflare.durable_object.query.bindings attribute"),
        ],
    ),
    "cloudflare.durable_object.response.rows_read": AttributeMetadata(
        ...
        example=12,
        changelog=[
            ChangelogEntry(version="0.13.0", prs=[435], description="Added cloudflare.durable_object.response.rows_read attribute"),
        ],
    ),
    "cloudflare.durable_object.response.rows_written": AttributeMetadata(
        ...
        example=1,
        changelog=[
            ChangelogEntry(version="0.13.0", prs=[435], description="Added cloudflare.durable_object.response.rows_written attribute"),
        ],
    ),
    "cloudflare.r2.bucket": AttributeMetadata(
        ...
        example="MY_BUCKET",
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[413], description="Added cloudflare.r2.bucket attribute"),
        ],
    ),
    "cloudflare.r2.operation": AttributeMetadata(
        ...
        example="GetObject",
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[413], description="Added cloudflare.r2.operation attribute"),
        ],
    ),
    "cloudflare.r2.request.delimiter": AttributeMetadata(
        ...
        example="/",
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[413], description="Added cloudflare.r2.request.delimiter attribute"),
        ],
    ),
    "cloudflare.r2.request.key": AttributeMetadata(
        ...
        example="my-file.txt",
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[413], description="Added cloudflare.r2.request.key attribute"),
        ],
    ),
    "cloudflare.r2.request.part_number": AttributeMetadata(
        ...
        example=1,
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[413], description="Added cloudflare.r2.request.part_number attribute"),
        ],
    ),
    "cloudflare.r2.request.prefix": AttributeMetadata(
        ...
        example="images/",
        changelog=[
            ChangelogEntry(version="0.11.1", prs=[413], description="Added cloudflare.r2.request.prefix attribute"),
        ],
    ),
    "cloudflare.workflow.attempt": AttributeMetadata(
        ...
        example=1,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[392], description="Added cloudflare.workflow.attempt attribute"),
        ],
    ),
    "cloudflare.workflow.retries.backoff": AttributeMetadata(
        ...
        example="exponential",
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[392], description="Added cloudflare.workflow.retries.backoff attribute"),
        ],
    ),
    "cloudflare.workflow.retries.delay": AttributeMetadata(
        ...
        example="5 seconds",
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[392], description="Added cloudflare.workflow.retries.delay attribute"),
        ],
    ),
    "cloudflare.workflow.retries.limit": AttributeMetadata(
        ...
        example=3,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[392], description="Added cloudflare.workflow.retries.limit attribute"),
        ],
    ),
    "cloudflare.workflow.timeout": AttributeMetadata(
        ...
        example="1 minute",
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[392], description="Added cloudflare.workflow.timeout attribute"),
        ],
    ),
    ...
    "cls": AttributeMetadata(
        ...
        aliases=["browser.web_vital.cls.value"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[229], description="Added and deprecated attribute to document JS SDK's current behaviour"),
        ],
    ),
    ...
    "code.function": AttributeMetadata(
        ...
        aliases=["code.function.name","django.function_name"],
        changelog=[
            ChangelogEntry(version="next", description="Added django.function_name as an alias"),
    ...
    "code": AttributeMetadata(
        ...
        aliases=["rpc.grpc.status_code","rpc.response.status_code"],
        changelog=[
            ChangelogEntry(version="next", prs=[533], description="Added code attribute"),
        ],
    ),
    "connection.rtt": AttributeMetadata(
        ...
        aliases=["network.connection.rtt"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[279], description="Added and deprecated attribute to document JS SDK's current behaviour"),
        ],
    ),
    ...
    "db.collection.name": AttributeMetadata(
        ...
        aliases=["db.mongodb.collection"],
        changelog=[
            ChangelogEntry(version="next", description="Added db.mongodb.collection as an alias"),
            ChangelogEntry(version="0.1.0", prs=[106, 127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    "db.driver.name": AttributeMetadata(
        ...
        example="psycopg2",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[297], description="Added db.driver.name attribute"),
        ],
    ),
    "db.mongodb.collection": AttributeMetadata(
        ...
        aliases=["db.collection.name"],
        changelog=[
            ChangelogEntry(version="next", description="Added db.mongodb.collection attribute, deprecated in favor of db.collection.name"),
        ],
    ),
    ...
    "db.operation.batch.size": AttributeMetadata(
        ...
        example=3,
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[407], description="Added db.operation.batch.size attribute"),
        ],
    ),
    ...
    "db.params": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", prs=[529], description="Added db.params attribute"),
        ],
    ),
    ...
    "db.query.summary": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", prs=[505], description="Added multiple examples"),
    ...
    "db.redis.key": AttributeMetadata(
        ...
        changelog=[
            ...
            ChangelogEntry(version="0.6.0", prs=[326], description="Added db.redis.key attribute"),
        ],
    ),
    ...
    "db.response.status_code": AttributeMetadata(
        ...
        example="ORA-17002",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[462], description="Added db.response.status_code attribute"),
        ],
    ),
    ...
    "db.statement": AttributeMetadata(
        ...
        aliases=["db.query.text","query"],
        changelog=[
            ChangelogEntry(version="next", prs=[501], description="Improved example, added deprecation reason, and added query as an alias"),
            ChangelogEntry(version="0.4.0", prs=[199]),
            ChangelogEntry(version="0.1.0", prs=[61, 127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ...
    "device.archs": AttributeMetadata(
        ...
        example=["arm64-v8a", "armeabi-v7a", "armeabi"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.archs attribute"),
        ],
    ),
    "device.battery_level": AttributeMetadata(
        ...
        example=100,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.battery_level attribute"),
        ],
    ),
    "device.battery_temperature": AttributeMetadata(
        ...
        example=25,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.battery_temperature attribute"),
        ],
    ),
    "device.boot_time": AttributeMetadata(
        ...
        example="2018-02-08T12:52:12Z",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.boot_time attribute"),
        ],
    ),
    ...
    "device.charging": AttributeMetadata(
        ...
        example=False,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.charging attribute"),
        ],
    ),
    "device.chipset": AttributeMetadata(
        ...
        example="Qualcomm SM8550",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.chipset attribute"),
        ],
    ),
    "device.class": AttributeMetadata(
        ...
        example="medium",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[300], description="Added device.class attribute"),
        ],
    ),
    "device.connection_type": AttributeMetadata(
        ...
        aliases=["network.connection.type","connectionType"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added and deprecated device.connection_type in favor of network.connection.type"),
        ],
    ),
    "device.cpu_description": AttributeMetadata(
        ...
        example="Intel(R) Core(TM)2 Quad CPU Q6600 @ 2.40GHz",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.cpu_description attribute"),
        ],
    ),
    "device.external_free_storage": AttributeMetadata(
        ...
        example=67108864000,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.external_free_storage attribute"),
        ],
    ),
    "device.external_storage_size": AttributeMetadata(
        ...
        example=134217728000,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.external_storage_size attribute"),
        ],
    ),
    ...
    "device.free_memory": AttributeMetadata(
        ...
        example=2147483648,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[300], description="Added device.free_memory attribute"),
        ],
    ),
    "device.free_storage": AttributeMetadata(
        ...
        example=107374182400,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.free_storage attribute"),
        ],
    ),
    "device.id": AttributeMetadata(
        ...
        example="a1b2c3d4-e5f6-7890-abcd-ef1234567890",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.id attribute"),
        ],
    ),
    "device.locale": AttributeMetadata(
        ...
        example="en-US",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.locale attribute"),
        ],
    ),
    "device.low_memory": AttributeMetadata(
        ...
        example=False,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.low_memory attribute"),
        ],
    ),
    "device.low_power_mode": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[314], description="Added device.low_power_mode attribute"),
        ],
    ),
    "device.manufacturer": AttributeMetadata(
        ...
        example="Google",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.manufacturer attribute"),
        ],
    ),
    "device.memory.estimated_capacity": AttributeMetadata(
        ...
        aliases=["deviceMemory"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[281], description="Added attribute device.memory.estimated_capacity to be used instead of deviceMemory"),
        ],
    ),
    "device.memory_size": AttributeMetadata(
        ...
        example=17179869184,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[300], description="Added device.memory_size attribute"),
        ],
    ),
    ...
    "device.model_id": AttributeMetadata(
        ...
        example="N861AP",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[300], description="Added device.model_id attribute"),
        ],
    ),
    "device.name": AttributeMetadata(
        ...
        example="localhost",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.name attribute"),
        ],
    ),
    "device.online": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.online attribute"),
        ],
    ),
    "device.orientation": AttributeMetadata(
        ...
        example="portrait",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.orientation attribute"),
        ],
    ),
    "device.processor_count": AttributeMetadata(
        ...
        aliases=["hardwareConcurrency"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[300], description="Added and deprecated attribute device.processor_count in favor of device.cpu.logical_core_count"),
        ],
    ),
    "device.processor_frequency": AttributeMetadata(
        ...
        example=2400,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.processor_frequency attribute"),
        ],
    ),
    "device.screen_density": AttributeMetadata(
        ...
        example=2.625,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.screen_density attribute"),
        ],
    ),
    "device.screen_dpi": AttributeMetadata(
        ...
        example=420,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.screen_dpi attribute"),
        ],
    ),
    "device.screen_height_pixels": AttributeMetadata(
        ...
        example=2400,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.screen_height_pixels attribute"),
        ],
    ),
    "device.screen_width_pixels": AttributeMetadata(
        ...
        example=1080,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.screen_width_pixels attribute"),
        ],
    ),
    "device.simulator": AttributeMetadata(
        ...
        example=False,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[300], description="Added device.simulator attribute"),
        ],
    ),
    "device.storage_size": AttributeMetadata(
        ...
        example=274877906944,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.storage_size attribute"),
        ],
    ),
    "device.thermal_state": AttributeMetadata(
        ...
        example="nominal",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.thermal_state attribute"),
        ],
    ),
    "device.timezone": AttributeMetadata(
        ...
        example="Europe/Vienna",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.timezone attribute"),
        ],
    ),
    "device.usable_memory": AttributeMetadata(
        ...
        example=2147483648,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[303], description="Added device.usable_memory attribute"),
        ],
    ),
    "deviceMemory": AttributeMetadata(
        ...
        aliases=["device.memory.estimated_capacity"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[281], description="Added and deprecated attribute to document JS SDK's current behaviour"),
        ],
    ),
    "dist": AttributeMetadata(
        ...
        aliases=["sentry.dist"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[489], description="Added dist attribute"),
        ],
    ),
    "django.function_name": AttributeMetadata(
        ...
        aliases=["code.function.name","code.function"],
        changelog=[
            ChangelogEntry(version="next", prs=[538], description="Added django.function_name attribute"),
        ],
    ),
    "django.middleware_name": AttributeMetadata(
        ...
        aliases=["middleware.name"],
        changelog=[
            ChangelogEntry(version="next", prs=[520], description="Added django.middleware_name attribute"),
        ],
    ),
    ...
    "environment": AttributeMetadata(
        ...
        aliases=["sentry.environment"],
        changelog=[
            ChangelogEntry(version="next", prs=[427], description="Configured normalization"),
            ChangelogEntry(version="0.1.0", prs=[61, 127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    ...
    "faas.execution": AttributeMetadata(
        ...
        aliases=["faas.invocation_id","aws.lambda.aws_request_id"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[473], description="Added faas.execution attribute, deprecated in favor of faas.invocation_id"),
        ],
    ),
    "faas.id": AttributeMetadata(
        ...
        aliases=["cloud.resource_id"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[475], description="Added faas.id attribute, deprecated in favor of cloud.resource_id"),
        ],
    ),
    ...
    "faas.invoked_name": AttributeMetadata(
        ...
        example="my-function",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[481], description="Added faas.invoked_name attribute"),
        ],
    ),
    "faas.invoked_provider": AttributeMetadata(
        ...
        example="aws",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[481], description="Added faas.invoked_provider attribute"),
        ],
    ),
    "faas.invoked_region": AttributeMetadata(
        ...
        example="eu-central-1",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[481], description="Added faas.invoked_region attribute"),
        ],
    ),
    ...
    "file.path": AttributeMetadata(
        ...
        example="/home/user/example.txt",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[458], description="Added file.path attribute"),
        ],
    ),
    "file.size": AttributeMetadata(
        ...
        example=1024,
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[458], description="Added file.size attribute"),
        ],
    ),
    ...
    "frames.delay": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.delay.value"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Deprecated in favor of app.vitals.frames.delay.value"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.0.0"),
        ],
        search_alias=SearchAlias(
    ...
    "frames.frozen": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.frozen.count","sentry.frames.frozen"],
        changelog=[
            ChangelogEntry(version="next", prs=[500], description="Added sentry.frames.frozen as an alias"),
            ChangelogEntry(version="0.5.0", prs=[313], description="Deprecated in favor of app.vitals.frames.frozen.count"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.0.0"),
        ],
        search_alias=SearchAlias(
    ...
    "frames.slow": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.slow.count","sentry.frames.slow"],
        changelog=[
            ChangelogEntry(version="next", prs=[500], description="Added sentry.frames.slow as an alias"),
            ChangelogEntry(version="0.5.0", prs=[313], description="Deprecated in favor of app.vitals.frames.slow.count"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.0.0"),
        ],
        search_alias=SearchAlias(
    ...
    "frames.total": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.total.count","sentry.frames.total"],
        changelog=[
            ChangelogEntry(version="next", prs=[500], description="Added sentry.frames.total as an alias"),
            ChangelogEntry(version="0.5.0", prs=[313], description="Deprecated in favor of app.vitals.frames.total.count"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.0.0"),
        ],
        search_alias=SearchAlias(
    ...
    "frames_frozen_rate": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.frozen.rate"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Deprecated in favor of app.vitals.frames.frozen.rate"),
            ChangelogEntry(version="0.7.0", prs=[362], description="Added frames_frozen_rate attribute"),
        ],
    ),
    "frames_slow_rate": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.slow.rate"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Deprecated in favor of app.vitals.frames.slow.rate"),
            ChangelogEntry(version="0.7.0", prs=[362], description="Added frames_slow_rate attribute"),
        ],
    ),
    ...
    "gcp.function.context.event_id": AttributeMetadata(
        ...
        example="1234567890",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.event_id attribute"),
        ],
    ),
    "gcp.function.context.event_type": AttributeMetadata(
        ...
        example="google.pubsub.topic.publish",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.event_type attribute"),
        ],
    ),
    "gcp.function.context.id": AttributeMetadata(
        ...
        example="1234567890",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.id attribute"),
        ],
    ),
    "gcp.function.context.resource": AttributeMetadata(
        ...
        example="projects/my-project/topics/my-topic",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.resource attribute"),
        ],
    ),
    "gcp.function.context.source": AttributeMetadata(
        ...
        example="//pubsub.googleapis.com/projects/my-project/topics/my-topic",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.source attribute"),
        ],
    ),
    "gcp.function.context.specversion": AttributeMetadata(
        ...
        example="1.0",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.specversion attribute"),
        ],
    ),
    "gcp.function.context.time": AttributeMetadata(
        ...
        example="2024-01-01T00:00:00.000Z",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.time attribute"),
        ],
    ),
    "gcp.function.context.timestamp": AttributeMetadata(
        ...
        example="2024-01-01T00:00:00.000Z",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.timestamp attribute"),
        ],
    ),
    "gcp.function.context.type": AttributeMetadata(
        ...
        example="cloud_functions.context",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[371], description="Added gcp.function.context.type attribute"),
        ],
    ),
    ...
    "gcp_region": AttributeMetadata(
        ...
        aliases=["cloud.region","aws_region"],
        changelog=[
            ChangelogEntry(version="next", prs=[535], description="Added gcp_region attribute"),
        ],
    ),
    ...
    "gen_ai.context.utilization": AttributeMetadata(
        ...
        example=0.75,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[315], description="Added gen_ai.context.utilization attribute"),
        ],
    ),
    "gen_ai.context.window_size": AttributeMetadata(
        ...
        example=128000,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[315], description="Added gen_ai.context.window_size attribute"),
        ],
    ),
    ...
    "gen_ai.cost.cache_creation.input_tokens": AttributeMetadata(
        ...
        example=12.34,
        changelog=[
            ChangelogEntry(version="0.16.0", description="Added gen_ai.cost.cache_creation.input_tokens attribute"),
        ],
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to calculate total cost, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","Despite the name 'cost.cache_creation.input_tokens', this value is cost in USD, not a token count. For token counts, use gen_ai.usage.cache_creation.input_tokens.","This is a subset of gen_ai.cost.input_tokens, not an independent cost. Do not sum this with gen_ai.cost.input_tokens — it is already included."],
    ),
    "gen_ai.cost.cache_read.input_tokens": AttributeMetadata(
        ...
        example=12.34,
        changelog=[
            ChangelogEntry(version="0.16.0", description="Added gen_ai.cost.cache_read.input_tokens attribute"),
        ],
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to calculate total cost, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","Despite the name 'cost.cache_read.input_tokens', this value is cost in USD, not a token count. For token counts, use gen_ai.usage.cache_read.input_tokens.","This is a subset of gen_ai.cost.input_tokens, not an independent cost. Do not sum this with gen_ai.cost.input_tokens — it is already included."],
    ),
    "gen_ai.cost.input_tokens": AttributeMetadata(
        ...
        example=123.45,
        changelog=[
            ChangelogEntry(version="0.9.0", prs=[397], description="Add additional_context"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.1.0", prs=[112]),
        ],
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to calculate total cost, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","Despite the name 'cost.input_tokens', this value is cost in USD, not a token count. For token counts, use gen_ai.usage.input_tokens.","This is the total cost of all input tokens, including cached and cache creation tokens at their respective rates. For the cached portion, see gen_ai.cost.cache_read.input_tokens. For the cache creation portion, see gen_ai.cost.cache_creation.input_tokens."],
    ),
    "gen_ai.cost.output_tokens": AttributeMetadata(
        ...
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to calculate total cost, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","Despite the name 'cost.output_tokens', this value is cost in USD, not a token count. For token counts, use gen_ai.usage.output_tokens.","This is the total cost of all output tokens, including reasoning tokens at their respective rate. For the reasoning portion, see gen_ai.cost.reasoning.output_tokens."],
    ),
    "gen_ai.cost.reasoning.output_tokens": AttributeMetadata(
        ...
        example=12.34,
        changelog=[
            ChangelogEntry(version="0.16.0", description="Added gen_ai.cost.reasoning.output_tokens attribute"),
        ],
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to calculate total cost, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","Despite the name 'cost.reasoning.output_tokens', this value is cost in USD, not a token count. For token counts, use gen_ai.usage.reasoning.output_tokens.","This is a subset of gen_ai.cost.output_tokens, not an independent cost. Do not sum this with gen_ai.cost.output_tokens — it is already included."],
    ),
    "gen_ai.cost.total_tokens": AttributeMetadata(
        ...
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to calculate total cost, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","Despite the name 'cost.total_tokens', this value is cost in USD, not a token count. For token counts, use gen_ai.usage.total_tokens."],
    ),
    ...
    "gen_ai.function_id": AttributeMetadata(
        ...
        example="my-awesome-function",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[308], description="Added gen_ai.function_id attribute"),
        ],
    ),
    ...
    "gen_ai.prompt.name": AttributeMetadata(
        ...
        aliases=["mcp.prompt.name"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Added gen_ai.prompt.name attribute"),
        ],
    ),
    ...
    "gen_ai.request.reasoning.level": AttributeMetadata(
        ...
        example="high",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[502], description="Added gen_ai.request.reasoning.level attribute"),
        ],
    ),
    ...
    "gen_ai.request.stop_sequences": AttributeMetadata(
        ...
        example=["forest", "lived"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[482], description="Added gen_ai.request.stop_sequences attribute"),
        ],
    ),
    ...
    "gen_ai.response.finish_reason": AttributeMetadata(
        ...
        aliases=["gen_ai.response.finish_reasons"],
        changelog=[
            ChangelogEntry(version="next", prs=[498], description="Added gen_ai.response.finish_reason attribute"),
        ],
    ),
    ...
    "gen_ai.response.time_to_first_chunk": AttributeMetadata(
        ...
        aliases=["gen_ai.response.time_to_first_token"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Added gen_ai.response.time_to_first_chunk attribute"),
        ],
    ),
    "gen_ai.response.time_to_first_token": AttributeMetadata(
        ...
        aliases=["gen_ai.response.time_to_first_chunk"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Deprecate in favor of gen_ai.response.time_to_first_chunk"),
    ...
    "gen_ai.usage.cache_creation.input_tokens": AttributeMetadata(
        ...
        aliases=["gen_ai.usage.input_tokens.cache_write"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Added gen_ai.usage.cache_creation.input_tokens attribute"),
        ],
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to count tokens, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans."],
    ),
    "gen_ai.usage.cache_read.input_tokens": AttributeMetadata(
        ...
        aliases=["gen_ai.usage.input_tokens.cached"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Added gen_ai.usage.cache_read.input_tokens attribute"),
        ],
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to count tokens, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","This is a subset of gen_ai.usage.input_tokens, not an independent count. Do not sum this with gen_ai.usage.input_tokens — it is already included."],
    ),
    ...
    "gen_ai.usage.input_tokens": AttributeMetadata(
        ...
        aliases=["ai.prompt_tokens.used","gen_ai.usage.prompt_tokens"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Update additional_context to reference gen_ai.usage.cache_read.input_tokens"),
            ChangelogEntry(version="0.9.0", prs=[397], description="Add additional_context"),
    ...
    "gen_ai.usage.input_tokens.cache_write": AttributeMetadata(
        ...
        aliases=["gen_ai.usage.cache_creation.input_tokens"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Deprecate in favor of gen_ai.usage.cache_creation.input_tokens"),
            ChangelogEntry(version="0.9.0", prs=[397], description="Add additional_context"),
    ...
    "gen_ai.usage.input_tokens.cached": AttributeMetadata(
        ...
        aliases=["gen_ai.usage.cache_read.input_tokens"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Deprecate in favor of gen_ai.usage.cache_read.input_tokens"),
            ChangelogEntry(version="0.9.0", prs=[397], description="Add additional_context"),
            ChangelogEntry(version="0.4.0", prs=[228]),
    ...
    "gen_ai.usage.output_tokens": AttributeMetadata(
        ...
        aliases=["ai.completion_tokens.used","gen_ai.usage.completion_tokens"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Update additional_context to reference gen_ai.usage.reasoning.output_tokens"),
            ChangelogEntry(version="0.9.0", prs=[397], description="Add additional_context"),
            ChangelogEntry(version="0.5.0", prs=[261]),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.1.0", prs=[112]),
    ...
    "gen_ai.usage.output_tokens.reasoning": AttributeMetadata(
        ...
        aliases=["gen_ai.usage.reasoning.output_tokens"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Deprecate in favor of gen_ai.usage.reasoning.output_tokens"),
            ChangelogEntry(version="0.9.0", prs=[397], description="Add additional_context"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.1.0", prs=[62, 112]),
        ],
    ...
    "gen_ai.usage.reasoning.output_tokens": AttributeMetadata(
        ...
        aliases=["gen_ai.usage.output_tokens.reasoning"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[418], description="Added gen_ai.usage.reasoning.output_tokens attribute"),
        ],
        additional_context=["This attribute appears on both agent parent spans (aggregated totals) and LLM child spans (per-call values). When using sum() to count tokens, filter to gen_ai.operation.type:ai_client to avoid double-counting hierarchical spans.","This is a subset of gen_ai.usage.output_tokens, not an independent count. Do not sum this with gen_ai.usage.output_tokens — it is already included."],
    ),
    ...
    "graphql.document": AttributeMetadata(
        ...
        example="query findBookById { bookById(id: ?) { name } }",
        changelog=[
            ChangelogEntry(version="0.7.0", description="Adds the `graphql.document` attribute to track the GraphQL document being executed."),
        ],
    ),
    ...
    "grpc.error.bad_request.field_violations": AttributeMetadata(
        ...
        example=["{\"field\":\"email\",\"description\":\"must be a valid email address\",\"reason\":\"FIELD_INVALID\",\"localized_message\":{\"locale\":\"en-US\",\"message\":\"Must be a valid email address\"}}"],
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.bad_request.field_violations attribute"),
        ],
    ),
    "grpc.error.debug_info.detail": AttributeMetadata(
        ...
        example="at com.example.Service.method(Service.java:42)",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.debug_info.detail attribute"),
        ],
    ),
    "grpc.error.debug_info.stack_entries": AttributeMetadata(
        ...
        example=["com.example.Service.method(Service.java:42)", "com.example.Server.handle(Server.java:100)"],
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.debug_info.stack_entries attribute"),
        ],
    ),
    "grpc.error.error_info.domain": AttributeMetadata(
        ...
        example="example.sentry.io",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.error_info.domain attribute"),
        ],
    ),
    "grpc.error.error_info.metadata.<key>": AttributeMetadata(
        ...
        example="grpc.error.error_info.metadata.user_id='123'",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.error_info.metadata.<key> attribute"),
        ],
    ),
    "grpc.error.error_info.reason": AttributeMetadata(
        ...
        example="FIELD_INVALID",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.error_info.reason attribute"),
        ],
    ),
    "grpc.error.precondition_failure.violations": AttributeMetadata(
        ...
        example=["{\"type\":\"TOS\",\"subject\":\"example.com/user/123\",\"description\":\"User must accept the terms of service\"}"],
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.precondition_failure.violations attribute"),
        ],
    ),
    "grpc.error.quota_failure.violations": AttributeMetadata(
        ...
        example=["{\"subject\":\"clientip:127.0.0.1\",\"description\":\"Limit checks failed.\",\"api_service\":\"example.googleapis.com\",\"quota_metric\":\"example.googleapis.com/read_requests\",\"quota_id\":\"ReadRequestsPerMinutePerProject\",\"quota_dimensions\":{\"region\":\"us-central1\"},\"quota_value\":1000}"],
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.quota_failure.violations attribute"),
        ],
    ),
    "grpc.error.resource_info.description": AttributeMetadata(
        ...
        example="Instance is not ready for the request.",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.resource_info.description attribute"),
        ],
    ),
    "grpc.error.resource_info.owner": AttributeMetadata(
        ...
        example="user@example.com",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.resource_info.owner attribute"),
        ],
    ),
    "grpc.error.resource_info.resource_name": AttributeMetadata(
        ...
        example="projects/example/instances/example-instance",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.resource_info.resource_name attribute"),
        ],
    ),
    "grpc.error.resource_info.resource_type": AttributeMetadata(
        ...
        example="database",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.resource_info.resource_type attribute"),
        ],
    ),
    "grpc.error.retry_info.retry_delay_ms": AttributeMetadata(
        ...
        example=5000,
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[460], description="Added grpc.error.retry_info.retry_delay_ms attribute"),
        ],
    ),
    "hardwareConcurrency": AttributeMetadata(
        ...
        aliases=["device.processor_count"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[281, 300], description="Added and deprecated attribute to document JS SDK's current behaviour"),
        ],
    ),
    ...
    "http.request.body.data": AttributeMetadata(
        ...
        example="[{\"role\": \"user\", \"message\": \"hello\"}]",
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[336], description="Added http.request.body.data attribute"),
        ],
    ),
    ...
    "http.request.same_origin": AttributeMetadata(
        ...
        aliases=["url.same_origin"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[456], description="Added http.request.same_origin attribute"),
        ],
    ),
    ...
    "http.request_method": AttributeMetadata(
        ...
        aliases=["method","http.method","http.request.method"],
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[343], description="Added http.request_method attribute"),
        ],
    ),
    ...
    "http.route": AttributeMetadata(
        ...
        aliases=["route"],
        changelog=[
            ChangelogEntry(version="next", prs=[505, 521], description="Added multiple examples, removed alias to `url.template`, added additional context"),
            ChangelogEntry(version="0.1.0", prs=[127]),
            ChangelogEntry(version="0.0.0"),
        ],
        additional_context=["This attribute should primarily be set by server-side instrumentation that captures the framework route of an incoming request.","For `http.client` spans and client-side routing, use `url.template` instead."],
    ),
    ...
    "jsonrpc.protocol.version": AttributeMetadata(
        ...
        example="2.0",
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Added jsonrpc.protocol.version attribute"),
        ],
    ),
    "jsonrpc.request.id": AttributeMetadata(
        ...
        aliases=["mcp.request.id"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Added jsonrpc.request.id attribute"),
        ],
    ),
    ...
    "koa.name": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[490], description="Added koa.name attribute as deprecated"),
        ],
    ),
    "koa.type": AttributeMetadata(
        ...
        example="router",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[471], description="Added koa.type attribute"),
        ],
    ),
    ...
    "litestar.middleware_name": AttributeMetadata(
        ...
        aliases=["middleware.name"],
        changelog=[
            ChangelogEntry(version="next", description="Added litestar.middleware_name attribute, deprecated in favor of middleware.name"),
        ],
    ),
    ...
    "mcp.method.name": AttributeMetadata(
        ...
        example="tools/call",
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Set is_in_otel=true, attribute exists in OTel MCP registry"),
            ChangelogEntry(version="0.3.0", prs=[171]),
        ],
    ),
    ...
    "mcp.prompt.name": AttributeMetadata(
        ...
        aliases=["gen_ai.prompt.name"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Deprecated in favor of gen_ai.prompt.name"),
            ChangelogEntry(version="0.3.0", prs=[171]),
        ],
    ),
    ...
    "mcp.request.id": AttributeMetadata(
        ...
        aliases=["jsonrpc.request.id"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Deprecated in favor of jsonrpc.request.id"),
            ChangelogEntry(version="0.3.0", prs=[171]),
        ],
    ),
    "mcp.resource.protocol": AttributeMetadata(
        ...
        aliases=["network.protocol.name","net.protocol.name"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Deprecated in favor of network.protocol.name"),
            ChangelogEntry(version="0.3.0", prs=[171]),
        ],
    ),
    ...
    "mcp.tool.name": AttributeMetadata(
        ...
        aliases=["gen_ai.tool.name","ai.function_call"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Deprecated in favor of gen_ai.tool.name"),
            ChangelogEntry(version="0.3.0", prs=[171]),
        ],
    ),
    "mcp.tool.result.content": AttributeMetadata(
        ...
        aliases=["gen_ai.tool.call.result","gen_ai.tool.message","gen_ai.tool.output","ai.toolCall.result"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Deprecated in favor of gen_ai.tool.call.result"),
            ChangelogEntry(version="0.3.0", prs=[171]),
    ...
    "mcp.tool.result.is_error": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Deprecated in favor of error.type"),
            ChangelogEntry(version="0.3.0", prs=[171]),
        ],
    ),
    "mcp.transport": AttributeMetadata(
        ...
        aliases=["network.transport","net.transport"],
        changelog=[
            ChangelogEntry(version="0.12.0", prs=[420], description="Deprecated in favor of network.transport"),
            ChangelogEntry(version="0.3.0", prs=[171]),
        ],
    ),
    ...
    "messaging.batch.message_count": AttributeMetadata(
        ...
        example=10,
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[341], description="Added messaging.batch.message_count attribute"),
        ],
    ),
    "messaging.destination": AttributeMetadata(
        ...
        aliases=["messaging.destination.name"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[482], description="Added messaging.destination attribute, deprecated in favor of messaging.destination.name"),
        ],
    ),
    ...
    "messaging.destination.name": AttributeMetadata(
        ...
        aliases=["messaging.destination"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[482], description="Added messaging.destination as an alias"),
            ChangelogEntry(version="0.1.0", prs=[127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    "messaging.destination.partition.id": AttributeMetadata(
        ...
        example="1",
        changelog=[
            ChangelogEntry(version="next", prs=[474], description="Added messaging.destination.partition.id attribute"),
        ],
    ),
    "messaging.destination_kind": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", description="Added deprecated messaging.destination_kind attribute for parity with legacy OTel instrumentations."),
        ],
    ),
    "messaging.kafka.message.key": AttributeMetadata(
        ...
        example="myKey",
        changelog=[
            ChangelogEntry(version="next", prs=[474], description="Added messaging.kafka.message.key attribute"),
        ],
    ),
    "messaging.kafka.message.tombstone": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="next", prs=[474], description="Added messaging.kafka.message.tombstone attribute"),
        ],
    ),
    "messaging.kafka.offset": AttributeMetadata(
        ...
        example=42,
        changelog=[
            ChangelogEntry(version="next", prs=[474], description="Added messaging.kafka.offset attribute"),
        ],
    ),
    ...
    "messaging.message.conversation_id": AttributeMetadata(
        ...
        example="MyConversationId",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[468], description="Added messaging.message.conversation_id attribute"),
        ],
    ),
    ...
    "messaging.operation.name": AttributeMetadata(
        ...
        example="send",
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[392], description="Added messaging.operation.name attribute"),
        ],
    ),
    ...
    "messaging.rabbitmq.destination.routing_key": AttributeMetadata(
        ...
        example="myKey",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[468], description="Added messaging.rabbitmq.destination.routing_key attribute"),
        ],
    ),
    ...
    "method": AttributeMetadata(
        ...
        aliases=["http.request.method","http.request_method","http.method"],
        changelog=[
            ChangelogEntry(version="next", prs=[497], description="Configured normalization"),
            ChangelogEntry(version="0.1.0", prs=[61, 127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    "middleware.name": AttributeMetadata(
        ...
        aliases=["django.middleware_name","starlite.middleware_name","litestar.middleware_name","starlette.middleware_name"],
        changelog=[
            ChangelogEntry(version="next", description="Added django.middleware_name, starlite.middleware_name, litestar.middleware_name and starlette.middleware_name as aliases"),
            ChangelogEntry(version="0.6.0", prs=[336], description="Added middleware.name attribute"),
        ],
    ),
    "navigation.origin": AttributeMetadata(
        ...
        aliases=["sentry.sveltekit.navigation.from"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[467], description="Added navigation.origin attribute"),
        ],
    ),
    "navigation.route.id": AttributeMetadata(
        ...
        example="AboutView",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[468], description="Added navigation.route.id attribute"),
        ],
    ),
    "navigation.type": AttributeMetadata(
        ...
        aliases=["sentry.sveltekit.navigation.type"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[467], description="Added new deprecated alias"),
            ChangelogEntry(version="0.1.0", prs=[127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    ...
    "network.connection.effective_type": AttributeMetadata(
        ...
        aliases=["effectiveConnectionType"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[279], description="Added attribute network.connection.effective_type to be used instead of effectiveConnectionType"),
        ],
    ),
    "network.connection.rtt": AttributeMetadata(
        ...
        aliases=["connection.rtt"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[279], description="Added attribute network.connection.rtt to be used instead of connection.rtt"),
        ],
    ),
    "network.connection.type": AttributeMetadata(
        ...
        aliases=["device.connection_type","connectionType"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[279], description="Added attribute network.connection.type to be used instead of connectionType"),
        ],
    ),
    ...
    "os.build": AttributeMetadata(
        ...
        aliases=["os.build_id"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[301], description="Added os.build attribute, deprecated in favor of os.build_id"),
        ],
    ),
    "os.build_id": AttributeMetadata(
        ...
        aliases=["os.build"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[301], description="Added os.build as alias"),
            ChangelogEntry(version="0.1.0", prs=[127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    ...
    "os.kernel_version": AttributeMetadata(
        ...
        example="20.2.0",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[301], description="Added os.kernel_version attribute"),
        ],
    ),
    ...
    "os.raw_description": AttributeMetadata(
        ...
        example="Ubuntu 22.04.4 LTS (Jammy Jellyfish)",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[301], description="Added os.raw_description attribute"),
        ],
    ),
    "os.rooted": AttributeMetadata(
        ...
        example=True,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[301], description="Added os.rooted attribute"),
        ],
    ),
    "os.theme": AttributeMetadata(
        ...
        example="dark",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[301], description="Added os.theme attribute"),
        ],
    ),
    ...
    "otel.kind": AttributeMetadata(
        ...
        aliases=["sentry.kind"],
        changelog=[
            ChangelogEntry(version="0.13.0", prs=[440], description="Added otel.kind attribute"),
        ],
    ),
    ...
    "performance.activationStart": AttributeMetadata(
        ...
        aliases=["browser.performance.navigation.activation_start"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[321], description="Added performance.activationStart attribute"),
        ],
    ),
    "performance.timeOrigin": AttributeMetadata(
        ...
        aliases=["browser.performance.time_origin"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[321], description="Added performance.timeOrigin attribute"),
        ],
    ),
    "port": AttributeMetadata(
        ...
        aliases=["server.port","net.host.port"],
        changelog=[
            ChangelogEntry(version="next", prs=[532], description="Added port attribute"),
        ],
    ),
    ...
    "process.command_args": AttributeMetadata(
        ...
        example=["cmd/otecol", "--config=config.yaml"],
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[327], description="Added process.command_args attribute"),
        ],
    ),
    ...
    "process.pid": AttributeMetadata(
        ...
        aliases=["subprocess.pid"],
        changelog=[
            ChangelogEntry(version="next", description="Added subprocess.pid as an alias"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    ...
    "profile_id": AttributeMetadata(
        ...
        aliases=["sentry.profile_id"],
        changelog=[
            ChangelogEntry(version="next", prs=[497], description="Added profile_id attribute"),
        ],
    ),
    ...
    "query": AttributeMetadata(
        ...
        aliases=["db.query.text","db.statement"],
        changelog=[
            ChangelogEntry(version="next", prs=[530], description="Added query attribute"),
        ],
    ),
    "react.version": AttributeMetadata(
        ...
        example="18.2.0",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[368], description="Added react.version attribute"),
        ],
    ),
    "redis.command": AttributeMetadata(
        ...
        aliases=["cloudflare.d1.query_type","db.operation.name","db.operation"],
        changelog=[
            ChangelogEntry(version="next", prs=[531], description="Added redis.command attribute"),
        ],
    ),
    "redis.key": AttributeMetadata(
        ...
        aliases=["db.redis.key"],
        changelog=[
            ChangelogEntry(version="next", description="Added redis.key attribute, deprecated in favor of db.redis.key"),
        ],
    ),
    ...
    "rpc.grpc.status_code": AttributeMetadata(
        ...
        aliases=["code","rpc.response.status_code"],
        changelog=[
            ChangelogEntry(version="next", description="Deprecated rpc.grpc.status_code in favor of rpc.response.status_code"),
            ChangelogEntry(version="0.4.0", prs=[228]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    "rpc.method": AttributeMetadata(
        ...
        aliases=["aws.operation_name"],
        changelog=[
            ChangelogEntry(version="next", description="Added aws.operation_name as an alias"),
            ChangelogEntry(version="0.7.0", prs=[351], description="Added rpc.method attribute"),
        ],
    ),
    "rpc.response.status_code": AttributeMetadata(
        ...
        aliases=["code","rpc.grpc.status_code"],
        changelog=[
            ChangelogEntry(version="next", description="Added code and rpc.grpc.status_code as aliases"),
            ChangelogEntry(version="0.7.0", prs=[352], description="Added rpc.response.status_code attribute"),
        ],
    ),
    ...
    "rpc.system": AttributeMetadata(
        ...
        aliases=["rpc.system.name"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[482], description="Added rpc.system attribute, deprecated in favor of rpc.system.name"),
        ],
    ),
    "rpc.system.name": AttributeMetadata(
        ...
        aliases=["rpc.system"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[482], description="Added rpc.system.name attribute"),
        ],
    ),
    "runtime.build": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[383], description="Added and deprecated runtime.build attribute"),
        ],
    ),
    "runtime.name": AttributeMetadata(
        ...
        aliases=["process.runtime.name"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[383], description="Added and deprecated runtime.name attribute in favor of process.runtime.name"),
        ],
    ),
    "runtime.raw_description": AttributeMetadata(
        ...
        aliases=["process.runtime.description"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[383], description="Added and deprecated runtime.raw_description attribute in favor of process.runtime.description"),
        ],
    ),
    "runtime.version": AttributeMetadata(
        ...
        aliases=["process.runtime.version"],
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[383], description="Added and deprecated runtime.version attribute in favor of process.runtime.version"),
        ],
    ),
    "score.<key>": AttributeMetadata(
        ...
        example="score.cls=0.1723",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[355], description="Added score.<key> attribute"),
        ],
    ),
    "score.ratio.<key>": AttributeMetadata(
        ...
        example="score.ratio.inp=0.7748",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[355], description="Added score.ratio.<key> attribute"),
        ],
    ),
    "score.total": AttributeMetadata(
        ...
        visibility=Visibility.PUBLIC,
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[355], description="Added score.total attribute"),
        ],
    ),
    "score.weight.<key>": AttributeMetadata(
        ...
        example="score.weight.fcp=0.25",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[355], description="Added score.weight.<key> attribute"),
        ],
    ),
    ...
    "sentry.dist": AttributeMetadata(
        ...
        aliases=["dist"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[489], description="Added dist as an alias"),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    ...
    "sentry.dsc.project_id": AttributeMetadata(
        ...
        example="12345",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[358], description="Add sentry.dsc.project_id as an attribute"),
        ],
    ),
    ...
    "sentry.frames.frozen": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.frozen.count","frames.frozen"],
        changelog=[
            ChangelogEntry(version="next", prs=[500], description="Added sentry.frames.frozen attribute"),
        ],
    ),
    "sentry.frames.slow": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.slow.count","frames.slow"],
        changelog=[
            ChangelogEntry(version="next", prs=[500], description="Added sentry.frames.slow attribute"),
        ],
    ),
    "sentry.frames.total": AttributeMetadata(
        ...
        aliases=["app.vitals.frames.total.count","frames.total"],
        changelog=[
            ChangelogEntry(version="next", prs=[500], description="Added sentry.frames.total attribute"),
        ],
    ),
    ...
    "sentry.kind": AttributeMetadata(
        ...
        aliases=["otel.kind"],
        changelog=[
            ChangelogEntry(version="next", prs=[517], description="Added more examples and additional_context to the attribute"),
            ChangelogEntry(version="0.3.1", prs=[190]),
        ],
        additional_context=["Valid attribute values are: \"client\", \"server\", \"producer\", \"consumer\" and \"internal\""],
        search_alias=SearchAlias(
            name="span.kind"
        ),
    ),
    ...
    "sentry.metric.source": AttributeMetadata(
        ...
        example="span",
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[476], description="Added sentry.metric.source attribute"),
        ],
    ),
    ...
    "sentry.pageload.span_id": AttributeMetadata(
        ...
        example="bf2c8d3df84524de",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[495], description="Added sentry.pageload.span_id attribute"),
        ],
    ),
    ...
    "sentry.profile_id": AttributeMetadata(
        ...
        aliases=["profile_id"],
        changelog=[
            ChangelogEntry(version="next", prs=[497], description="Added profile_id as an alias"),
            ChangelogEntry(version="0.6.0", prs=[344], description="Added sentry.profile_id attribute"),
        ],
        search_alias=SearchAlias(
            name="profile.id"
        ),
    ...
    "sentry.relay.ingress": AttributeMetadata(
        ...
        example="OTEL",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[491], description="Added sentry.relay.ingress attribute"),
        ],
    ),
    "sentry.relay.pipeline": AttributeMetadata(
        ...
        example="span v2",
        changelog=[
            ChangelogEntry(version="0.17.0", prs=[491], description="Added sentry.relay.pipeline attribute"),
        ],
    ),
    ...
    "sentry.report_event": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[320], description="Added sentry.report_event attribute"),
        ],
    ),
    ...
    "sentry.segment.name": AttributeMetadata(
        ...
        aliases=["sentry.transaction","transaction"],
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[345], description="Added sentry.transaction and transaction aliases"),
    ...
    "sentry.segment.name.source": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", prs=[466], description="Added sentry.segment.name.source"),
        ],
        additional_context=["This attribute is the replacement for `transaction_info.source` on transactions.","Should we bring back clustering for segment names (like we do for transaction names), this attribute will be used to determine if a segment name should be clustered."],
    ),
    ...
    "sentry.source": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", description="Removed the sentry.span.source replacement"),
            ChangelogEntry(version="0.5.0"),
        ],
    ),
    "sentry.span.source": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", description="Deprecated; superseded by sentry.segment.name.source on segment spans"),
    ...
    "sentry.sveltekit.navigation.from": AttributeMetadata(
        ...
        aliases=["navigation.origin"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[467], description="Added sentry.sveltekit.navigation.from attribute"),
        ],
    ),
    "sentry.sveltekit.navigation.to": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[467], description="Added sentry.sveltekit.navigation.to attribute"),
        ],
    ),
    "sentry.sveltekit.navigation.type": AttributeMetadata(
        ...
        aliases=["navigation.type"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[467], description="Added sentry.sveltekit.navigation.type attribute"),
        ],
    ),
    ...
    "sentry.trace.parent_span_id": AttributeMetadata(
        ...
        deprecation=DeprecationInfo(),
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[287], description="Deprecate `sentry.trace.parent_span_id`"),
            ChangelogEntry(version="0.1.0", prs=[116]),
        ],
    ),
    ...
    "sentry.trace_lifecycle": AttributeMetadata(
        ...
        example="stream",
        changelog=[
            ChangelogEntry(version="0.13.0", prs=[442], description="Added sentry.trace_lifecycle attribute"),
        ],
        search_alias=SearchAlias(
    ...
    "sentry.transaction": AttributeMetadata(
        ...
        aliases=["sentry.segment.name","transaction"],
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[345], description="Deprecated sentry.transaction in favor of sentry.segment.name"),
            ChangelogEntry(version="0.0.0"),
        ],
        search_alias=SearchAlias(
            name="transaction"
    ...
    "server_name": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", description="Added address as an alias"),
            ChangelogEntry(version="0.16.0", prs=[477], description="Added server_name attribute, deprecated in favor of server.address"),
        ],
    ),
    ...
    "session.id": AttributeMetadata(
        ...
        example="00112233-4455-6677-8899-aabbccddeeff",
        changelog=[
            ChangelogEntry(version="0.11.0", prs=[412], description="Added session.id attribute"),
        ],
    ),
    "stall_percentage": AttributeMetadata(
        ...
        aliases=["app.vitals.stall.percentage"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Deprecated in favor of app.vitals.stall.percentage"),
            ChangelogEntry(version="0.7.0", prs=[362], description="Added stall_percentage attribute"),
        ],
    ),
    "stall_total_time": AttributeMetadata(
        ...
        aliases=["app.vitals.stall.duration"],
        changelog=[
            ChangelogEntry(version="next", prs=[493], description="Deprecated in favor of app.vitals.stall.duration"),
            ChangelogEntry(version="0.7.0", prs=[362], description="Added stall_total_time attribute"),
        ],
    ),
    "starlette.middleware_name": AttributeMetadata(
        ...
        aliases=["middleware.name"],
        changelog=[
            ChangelogEntry(version="next", description="Added starlette.middleware_name attribute, deprecated in favor of middleware.name"),
        ],
    ),
    "starlite.middleware_name": AttributeMetadata(
        ...
        aliases=["middleware.name"],
        changelog=[
            ChangelogEntry(version="next", prs=[519], description="Added starlite.middleware_name attribute"),
        ],
    ),
    "state.type": AttributeMetadata(
        ...
        example="redux",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[365], description="Added state.type attribute"),
        ],
    ),
    "subprocess.pid": AttributeMetadata(
        ...
        aliases=["process.pid"],
        changelog=[
            ChangelogEntry(version="next", description="Added subprocess.pid attribute, deprecated in favor of process.pid"),
        ],
    ),
    ...
    "time_to_full_display": AttributeMetadata(
        ...
        aliases=["app.vitals.ttfd.value"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added and deprecated in favor of app.vitals.ttfd.value"),
        ],
    ),
    "time_to_initial_display": AttributeMetadata(
        ...
        aliases=["app.vitals.ttid.value"],
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[313], description="Added and deprecated in favor of app.vitals.ttid.value"),
        ],
    ),
    "transaction": AttributeMetadata(
        ...
        aliases=["sentry.segment.name","sentry.transaction"],
        changelog=[
            ChangelogEntry(version="next", prs=[497], description="Change deprecation from backfill to normalize"),
            ChangelogEntry(version="0.6.0", prs=[345], description="Updated transaction deprecation replacement to sentry.segment.name"),
            ChangelogEntry(version="0.1.0", prs=[61, 127]),
            ChangelogEntry(version="0.0.0"),
        ],
    ),
    "trpc.procedure_path": AttributeMetadata(
        ...
        example="user.getById",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[370], description="Added trpc.procedure_path attribute"),
        ],
    ),
    "trpc.procedure_type": AttributeMetadata(
        ...
        example="query",
        changelog=[
            ChangelogEntry(version="0.7.0", prs=[370], description="Added trpc.procedure_type attribute"),
        ],
    ),
    ...
    "ui.element.height": AttributeMetadata(
        ...
        example=256,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.height attribute"),
        ],
    ),
    "ui.element.id": AttributeMetadata(
        ...
        example="btn-login",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.id attribute"),
        ],
    ),
    "ui.element.identifier": AttributeMetadata(
        ...
        example="heroImage",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.identifier attribute"),
        ],
    ),
    "ui.element.load_time": AttributeMetadata(
        ...
        example=998.2234,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.load_time attribute"),
        ],
    ),
    "ui.element.paint_type": AttributeMetadata(
        ...
        example="image-paint",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.paint_type attribute"),
        ],
    ),
    "ui.element.render_time": AttributeMetadata(
        ...
        example=1023.1124,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.render_time attribute"),
        ],
    ),
    "ui.element.type": AttributeMetadata(
        ...
        example="img",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.type attribute"),
        ],
    ),
    "ui.element.url": AttributeMetadata(
        ...
        example="https://assets.myapp.com/hero.png",
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.url attribute"),
        ],
    ),
    "ui.element.width": AttributeMetadata(
        ...
        example=512,
        changelog=[
            ChangelogEntry(version="0.5.0", prs=[284], description="Added ui.element.width attribute"),
        ],
    ),
    ...
    "url.full": AttributeMetadata(
        ...
        aliases=["http.url","url","aws.request.url"],
        changelog=[
            ChangelogEntry(version="next", description="Added aws.request.url as an alias"),
    ...
    "url.same_origin": AttributeMetadata(
        ...
        aliases=["http.request.same_origin"],
        changelog=[
            ChangelogEntry(version="0.16.0", prs=[456], description="Added url.same_origin attribute, deprecated in favor of http.request.same_origin"),
        ],
    ),
    ...
    "url.template": AttributeMetadata(
        ...
        changelog=[
            ChangelogEntry(version="next", prs=[505, 521], description="Added multiple examples, removed alias to `http.route`, added additional context"),
            ChangelogEntry(version="0.1.0", prs=[127]),
            ChangelogEntry(version="0.0.0"),
        ],
        additional_context=["This attribute should primarily be set by client-side routing instrumentation, or `http.client` spans (if applicable).","Use `http.route` for server-side instrumentation that captures the framework route of an incoming request."],
    ),
    ...
    "vercel.path": AttributeMetadata(
        ...
        example="/dynamic/[route].json",
        changelog=[
            ChangelogEntry(version="0.6.0", prs=[349], description="Added vercel.path attribute"),
        ],
    ),
...
Attributes = TypedDict("Attributes", {
    ...
    "gen_ai.cost.cache_creation.input_tokens": float,
    "gen_ai.cost.cache_read.input_tokens": float,
    "gen_ai.cost.input_tokens": float,
    "gen_ai.cost.output_tokens": float,
    "gen_ai.cost.reasoning.output_tokens": float,

...
// Path: model/attributes/runtime/runtime__art__gc__blocking_count.json

/**
 * Total number of blocking (stop-the-world) garbage collections performed by the Android Runtime `runtime.art.gc.blocking_count`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_GC_BLOCKING_COUNT_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 1
 */
export const RUNTIME_ART_GC_BLOCKING_COUNT = 'runtime.art.gc.blocking_count';

/**
 * Type for {@link RUNTIME_ART_GC_BLOCKING_COUNT} runtime.art.gc.blocking_count
 */
export type RUNTIME_ART_GC_BLOCKING_COUNT_TYPE = number;

// Path: model/attributes/runtime/runtime__art__gc__blocking_time.json

/**
 * Total time spent in blocking (stop-the-world) garbage collections by the Android Runtime, in milliseconds `runtime.art.gc.blocking_time`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_GC_BLOCKING_TIME_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 11.873
 */
export const RUNTIME_ART_GC_BLOCKING_TIME = 'runtime.art.gc.blocking_time';

/**
 * Type for {@link RUNTIME_ART_GC_BLOCKING_TIME} runtime.art.gc.blocking_time
 */
export type RUNTIME_ART_GC_BLOCKING_TIME_TYPE = number;

// Path: model/attributes/runtime/runtime__art__gc__pre_oome_count.json

/**
 * Total number of garbage collections triggered as a last resort before an OutOfMemoryError by the Android Runtime `runtime.art.gc.pre_oome_count`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_GC_PRE_OOME_COUNT_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 0
 */
export const RUNTIME_ART_GC_PRE_OOME_COUNT = 'runtime.art.gc.pre_oome_count';

/**
 * Type for {@link RUNTIME_ART_GC_PRE_OOME_COUNT} runtime.art.gc.pre_oome_count
 */
export type RUNTIME_ART_GC_PRE_OOME_COUNT_TYPE = number;

// Path: model/attributes/runtime/runtime__art__gc__total_count.json

/**
 * Total number of garbage collections performed by the Android Runtime `runtime.art.gc.total_count`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_GC_TOTAL_COUNT_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 1
 */
export const RUNTIME_ART_GC_TOTAL_COUNT = 'runtime.art.gc.total_count';

/**
 * Type for {@link RUNTIME_ART_GC_TOTAL_COUNT} runtime.art.gc.total_count
 */
export type RUNTIME_ART_GC_TOTAL_COUNT_TYPE = number;

// Path: model/attributes/runtime/runtime__art__gc__total_time.json

/**
 * Total time spent in garbage collection by the Android Runtime, in milliseconds `runtime.art.gc.total_time`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_GC_TOTAL_TIME_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 11.807
 */
export const RUNTIME_ART_GC_TOTAL_TIME = 'runtime.art.gc.total_time';

/**
 * Type for {@link RUNTIME_ART_GC_TOTAL_TIME} runtime.art.gc.total_time
 */
export type RUNTIME_ART_GC_TOTAL_TIME_TYPE = number;

// Path: model/attributes/runtime/runtime__art__gc__waiting_time.json

/**
 * Total time threads spent waiting for garbage collection to complete in the Android Runtime, in milliseconds `runtime.art.gc.waiting_time`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_GC_WAITING_TIME_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 8.054
 */
export const RUNTIME_ART_GC_WAITING_TIME = 'runtime.art.gc.waiting_time';

/**
 * Type for {@link RUNTIME_ART_GC_WAITING_TIME} runtime.art.gc.waiting_time
 */
export type RUNTIME_ART_GC_WAITING_TIME_TYPE = number;

// Path: model/attributes/runtime/runtime__art__memory__free.json

/**
 * Free memory available to the process as reported by the Android Runtime, in bytes `runtime.art.memory.free`
 *
 ...
 * @example 3181568
 */
export const RUNTIME_ART_MEMORY_FREE = 'runtime.art.memory.free';

/**
 * Type for {@link RUNTIME_ART_MEMORY_FREE} runtime.art.memory.free
 */
export type RUNTIME_ART_MEMORY_FREE_TYPE = number;

// Path: model/attributes/runtime/runtime__art__memory__free_until_gc.json

/**
 * Free memory available before a garbage collection would be triggered by the Android Runtime, in bytes `runtime.art.memory.free_until_gc`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_MEMORY_FREE_UNTIL_GC_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 3181568
 */
export const RUNTIME_ART_MEMORY_FREE_UNTIL_GC = 'runtime.art.memory.free_until_gc';

/**
 * Type for {@link RUNTIME_ART_MEMORY_FREE_UNTIL_GC} runtime.art.memory.free_until_gc
 */
export type RUNTIME_ART_MEMORY_FREE_UNTIL_GC_TYPE = number;

// Path: model/attributes/runtime/runtime__art__memory__free_until_oome.json

/**
 * Free memory available before an OutOfMemoryError would be thrown by the Android Runtime, in bytes `runtime.art.memory.free_until_oome`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_MEMORY_FREE_UNTIL_OOME_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 196083712
 */
export const RUNTIME_ART_MEMORY_FREE_UNTIL_OOME = 'runtime.art.memory.free_until_oome';

/**
 * Type for {@link RUNTIME_ART_MEMORY_FREE_UNTIL_OOME} runtime.art.memory.free_until_oome
 */
export type RUNTIME_ART_MEMORY_FREE_UNTIL_OOME_TYPE = number;

// Path: model/attributes/runtime/runtime__art__memory__max.json

/**
 * Maximum memory the process is allowed to use as reported by the Android Runtime, in bytes `runtime.art.memory.max`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_MEMORY_MAX_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 201326592
 */
export const RUNTIME_ART_MEMORY_MAX = 'runtime.art.memory.max';

/**
 * Type for {@link RUNTIME_ART_MEMORY_MAX} runtime.art.memory.max
 */
export type RUNTIME_ART_MEMORY_MAX_TYPE = number;

// Path: model/attributes/runtime/runtime__art__memory__total.json

/**
 * Total memory currently allocated to the process by the Android Runtime, in bytes `runtime.art.memory.total`
 *
 * Attribute Value Type: `number` {@link RUNTIME_ART_MEMORY_TOTAL_TYPE}
 *
 * Contains PII: false
 *
 * Attribute defined in OTEL: No
 ...
 * @example 7774208
 */
export const RUNTIME_ART_MEMORY_TOTAL = 'runtime.art.memory.total';

/**
 * Type for {@link RUNTIME_ART_MEMORY_TOTAL} runtime.art.memory.total
 */
export type RUNTIME_ART_MEMORY_TOTAL_TYPE = number;
...
export const ATTRIBUTE_TYPE: Record<string, AttributeType> = {
  ...
  [RPC_SERVICE]: 'string',
  [RUNTIME_ART_GC_BLOCKING_COUNT]: 'integer',
  [RUNTIME_ART_GC_BLOCKING_TIME]: 'double',
  [RUNTIME_ART_GC_PRE_OOME_COUNT]: 'integer',
  [RUNTIME_ART_GC_TOTAL_COUNT]: 'integer',
  [RUNTIME_ART_GC_TOTAL_TIME]: 'double',
  [RUNTIME_ART_GC_WAITING_TIME]: 'double',
  [RUNTIME_ART_MEMORY_FREE]: 'integer',
  [RUNTIME_ART_MEMORY_FREE_UNTIL_GC]: 'integer',
  [RUNTIME_ART_MEMORY_FREE_UNTIL_OOME]: 'integer',
  [RUNTIME_ART_MEMORY_MAX]: 'integer',
  [RUNTIME_ART_MEMORY_TOTAL]: 'integer',
...
export type AttributeName =
  ...
  | typeof RUNTIME_ART_GC_PRE_OOME_COUNT
  | typeof RUNTIME_ART_GC_TOTAL_COUNT
  | typeof RUNTIME_ART_GC_TOTAL_TIME
  | typeof RUNTIME_ART_GC_WAITING_TIME
  | typeof RUNTIME_ART_MEMORY_FREE
  | typeof RUNTIME_ART_MEMORY_FREE_UNTIL_GC
  | typeof RUNTIME_ART_MEMORY_FREE_UNTIL_OOME
  | typeof RUNTIME_ART_MEMORY_MAX
  | typeof RUNTIME_ART_MEMORY_TOTAL
...
export const ATTRIBUTE_METADATA: Record<AttributeName, AttributeMetadata> = {
  ...
  [RUNTIME_ART_GC_BLOCKING_COUNT]: {
    ...
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.gc.blocking_count attribute' }],
  },
  [RUNTIME_ART_GC_BLOCKING_TIME]: {
    ...
    example: 11.873,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.gc.blocking_time attribute' }],
  },
  [RUNTIME_ART_GC_PRE_OOME_COUNT]: {
    brief:
    ...
    example: 0,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.gc.pre_oome_count attribute' }],
  },
  [RUNTIME_ART_GC_TOTAL_COUNT]: {
    ...
    example: 1,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.gc.total_count attribute' }],
  },
  [RUNTIME_ART_GC_TOTAL_TIME]: {
    ...
    example: 11.807,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.gc.total_time attribute' }],
  },
  [RUNTIME_ART_GC_WAITING_TIME]: {
    brief:
    ...
    example: 8.054,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.gc.waiting_time attribute' }],
  },
  [RUNTIME_ART_MEMORY_FREE]: {
    ...
    example: 3181568,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.memory.free attribute' }],
  },
  [RUNTIME_ART_MEMORY_FREE_UNTIL_GC]: {
    ...
    example: 3181568,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.memory.free_until_gc attribute' }],
  },
  [RUNTIME_ART_MEMORY_FREE_UNTIL_OOME]: {
    ...
    example: 196083712,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.memory.free_until_oome attribute' }],
  },
  [RUNTIME_ART_MEMORY_MAX]: {
    ...
    example: 201326592,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.memory.max attribute' }],
  },
  [RUNTIME_ART_MEMORY_TOTAL]: {
    ...
    example: 7774208,
    sdks: ['sentry.java.android'],
    changelog: [{ version: 'next', prs: [384], description: 'Added runtime.art.memory.total attribute' }],
  },
  [RUNTIME_BUILD]: {
...
export type Attributes = {
  ...
  [RUNTIME_ART_GC_BLOCKING_COUNT]?: RUNTIME_ART_GC_BLOCKING_COUNT_TYPE;
  [RUNTIME_ART_GC_BLOCKING_TIME]?: RUNTIME_ART_GC_BLOCKING_TIME_TYPE;
  [RUNTIME_ART_GC_PRE_OOME_COUNT]?: RUNTIME_ART_GC_PRE_OOME_COUNT_TYPE;
  [RUNTIME_ART_GC_TOTAL_COUNT]?: RUNTIME_ART_GC_TOTAL_COUNT_TYPE;
  [RUNTIME_ART_GC_TOTAL_TIME]?: RUNTIME_ART_GC_TOTAL_TIME_TYPE;
  [RUNTIME_ART_GC_WAITING_TIME]?: RUNTIME_ART_GC_WAITING_TIME_TYPE;
  [RUNTIME_ART_MEMORY_FREE]?: RUNTIME_ART_MEMORY_FREE_TYPE;
  [RUNTIME_ART_MEMORY_FREE_UNTIL_GC]?: RUNTIME_ART_MEMORY_FREE_UNTIL_GC_TYPE;
  [RUNTIME_ART_MEMORY_FREE_UNTIL_OOME]?: RUNTIME_ART_MEMORY_FREE_UNTIL_OOME_TYPE;
  [RUNTIME_ART_MEMORY_MAX]?: RUNTIME_ART_MEMORY_MAX_TYPE;
  [RUNTIME_ART_MEMORY_TOTAL]?: RUNTIME_ART_MEMORY_TOTAL_TYPE;
